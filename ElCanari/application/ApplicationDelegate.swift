...
@objc (ApplicationDelegate) final class ApplicationDelegate : NSObject, NSApplicationDelegate, NSMenuItemValidation {
  ...
  //--- First Column
    ...
    firstColumn.appendView (AutoLayoutStaticLabel (title: "Open All…", bold: true, size: .regular, alignment: .left))
...
//    firstColumn.appendView (openAllProjectsInDirectory)
    ...
    firstColumn.appendView (AutoLayoutStaticLabel (title: "Update All…", bold: true, size: .regular, alignment: .left))
    ...
    firstColumn.appendView (AutoLayoutStaticLabel (title: "Convert to Textual Format…", bold: true, size: .regular, alignment: .left))
    ...
    firstColumn.appendView (AutoLayoutStaticLabel (title: "Convert to Binary Format…", bold: true, size: .regular, alignment: .left))
