...
class TransientArrayOf_CanariLibraryEntry : ReadOnlyArrayOf_CanariLibraryEntry {
  ...
  func setSortCallback (_ inCallBack : Optional < (_ left : CanariLibraryEntry, _ right : CanariLibraryEntry) -> Bool >) {
...
class TransientArrayOfSuperOf_CanariLibraryEntry <SUPER : EBManagedObject> : ReadOnlyArrayOf_CanariLibraryEntry {
