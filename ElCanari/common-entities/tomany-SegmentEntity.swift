...
class ReadOnlyArrayOf_SegmentEntity : EBReadOnlyAbstractArrayProperty <SegmentEntity> {
  ...
  final func toMany_endStyle_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_endStyle_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: SegmentEntity
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_SegmentEntity : ReadWriteArrayOf_SegmentEntity { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
...
class StoredArrayOf_SegmentEntity : StandAloneArrayOf_SegmentEntity, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
