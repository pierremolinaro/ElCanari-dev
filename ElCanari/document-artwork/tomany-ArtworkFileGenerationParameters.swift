...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: ArtworkFileGenerationParameters
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_ArtworkFileGenerationParameters : ReadWriteArrayOf_ArtworkFileGenerationParameters { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
...
class StoredArrayOf_ArtworkFileGenerationParameters : StandAloneArrayOf_ArtworkFileGenerationParameters, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
