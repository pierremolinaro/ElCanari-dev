...
@objc(DeviceDocument) class DeviceDocument : EBManagedXibDocument {
  ...
  //--------------------------- Install regular bindings
    ...
    self.mPackagesColorWell?.bind_color (prefs_packageColor_property, file: #file, line: #line, sendContinously:false)
    self.mShowPackagePadNumbersSwitch?.bind_value (self.rootObject.mShowPackagePadNumbers_property, file: #file, line: #line)
    self.mPackageNumbersColorWell?.bind_color (prefs_padNumberColor_property, file: #file, line: #line, sendContinously:false)
    self.mShowPackageFrontPadsSwitch?.bind_value (self.rootObject.mShowPackageFrontPads_property, file: #file, line: #line)
    self.mPackageFrontPadsColorWell?.bind_color (prefs_frontSidePadColor_property, file: #file, line: #line, sendContinously:false)
    self.mShowPackageBackPadsSwitch?.bind_value (self.rootObject.mShowPackageBackPads_property, file: #file, line: #line)
    self.mPackageBackPadsColorWell?.bind_color (prefs_backSidePadColor_property, file: #file, line: #line, sendContinously:false)
