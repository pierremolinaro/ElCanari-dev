...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//    ArrayController_DeviceDocument_mDocumentationController
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

final class ArrayController_DeviceDocument_mDocumentationController : EBObject, EBTableViewDelegate, EBTableViewDataSource {
  ...
  var selectedSet : Set <DeviceDocumentation> { return mSelectedSet.mSet }
    ...
    self.selectedArray_property.readModelFunction = { [weak self] in
      if let me = self {
        ...
        case .multiple :
          return .multiple
        case .single (let v) :
          var result = [DeviceDocumentation] ()
          for object in v {
  ...
  func bind_tableView (_ inTableView : EBTableView?, file : String, line : Int) {
    ...
    //--- Check 'size' column
      if let column : NSTableColumn = tableView.tableColumn (withIdentifier: NSUserInterfaceItemIdentifier (rawValue: "size")) {
        ...
        presentErrorWindow (file: file, line: line, errorMessage:"\"size\" column view unknown")
      }
 ...
 //····················································································································
  ...
  func tableView (_ tableView : NSTableView,
    ...
    case .single (let v) :
      ...
      }else if inTableColumn?.identifier == NSUserInterfaceItemIdentifier ("size") {
