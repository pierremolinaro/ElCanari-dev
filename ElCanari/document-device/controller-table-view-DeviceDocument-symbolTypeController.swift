...
//----------------------------------------------------------------------------------------------------------------------
//    Table View Controller DeviceDocument symbolTypeController
//----------------------------------------------------------------------------------------------------------------------

final class Controller_DeviceDocument_symbolTypeController : ReadOnlyAbstractGenericRelationshipProperty, EBTableViewDelegate, NSTableViewDataSource {
  ...
  var objects : [SymbolTypeInDevice] {
  ...
  func bind_model (_ inModel : ReadWriteArrayOf_SymbolTypeInDevice, _ inUndoManager : EBUndoManager) {
  ...
  override func notifyModelDidChange () {
    ...
    var newSelectedArray = [SymbolTypeInDevice] ()
    ...
    case .single (let v) :
      if let tableColumnIdentifier = inTableColumn?.identifier,
        ...
        if tableColumnIdentifier.rawValue == "symbol", let cell = result as? EBTextObserverField_TableViewCell {
          ...
          cell.mCellOutlet?.bind_valueObserver (object.mTypeName_property)
          cell.update ()
          ...
          cell.mUnbindFunction? ()
          cell.mCellOutlet?.bind_valueObserver (object.instanceCount_property, autoFormatter:true)
          cell.update ()
