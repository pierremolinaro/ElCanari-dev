    ...
    self.documentSizeString_property.mReadModelFunction = { [weak self] in
      if let model = self?.mModel {
        ...
        case .single (let v) :
          ...
          for object in v {
            switch object.documentSizeString_property_selection {
            case .empty :
              return .empty
            case .multiple :
    ...
    self.mFileData_property.mReadModelFunction = { [weak self] in
      if let model = self?.mModel {
        ...
        case .single (let v) :
          ...
          var isMultipleSelection = false
          for object in v {
            switch object.mFileData_property_selection {
            case .empty :
              return .empty
            case .multiple :
              isMultipleSelection = true
    ...
    self.mFilledBezierPath_property.mReadModelFunction = { [weak self] in
      if let model = self?.mModel {
        ...
        case .single (let v) :
          ...
          var isMultipleSelection = false
          for object in v {
            switch object.mFilledBezierPath_property_selection {
            case .empty :
              return .empty
            case .multiple :
              isMultipleSelection = true
    ...
    self.mStrokeBezierPath_property.mReadModelFunction = { [weak self] in
      if let model = self?.mModel {
        ...
        case .single (let v) :
          ...
          var isMultipleSelection = false
          for object in v {
            switch object.mStrokeBezierPath_property_selection {
            case .empty :
              return .empty
            case .multiple :
              isMultipleSelection = true
    ...
    self.mTypeName_property.mReadModelFunction = { [weak self] in
      if let model = self?.mModel {
        ...
        case .single (let v) :
          ...
          var isMultipleSelection = false
          for object in v {
            switch object.mTypeName_property_selection {
            case .empty :
              return .empty
            case .multiple :
              isMultipleSelection = true
    ...
    self.mVersion_property.mReadModelFunction = { [weak self] in
      if let model = self?.mModel {
        ...
        case .single (let v) :
          ...
          var isMultipleSelection = false
          for object in v {
            switch object.mVersion_property_selection {
            case .empty :
              return .empty
            case .multiple :
              isMultipleSelection = true
    ...
    self.pinNameShape_property.mReadModelFunction = { [weak self] in
      if let model = self?.mModel {
        ...
        case .single (let v) :
          ...
          var isMultipleSelection = false
          for object in v {
            switch object.pinNameShape_property_selection {
            case .empty :
              return .empty
            case .multiple :
              isMultipleSelection = true
    ...
    self.versionString_property.mReadModelFunction = { [weak self] in
      if let model = self?.mModel {
        ...
        case .single (let v) :
          ...
          var isMultipleSelection = false
          for object in v {
            switch object.versionString_property_selection {
            case .empty :
              return .empty
            case .multiple :
              isMultipleSelection = true
