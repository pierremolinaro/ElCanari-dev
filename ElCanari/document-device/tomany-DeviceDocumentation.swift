...
class ReadOnlyArrayOf_DeviceDocumentation : EBReadOnlyAbstractArrayProperty <DeviceDocumentation> {
  ...
  final func toMany_mFileName_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mFileName_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_fileSize_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_fileSize_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: DeviceDocumentation
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_DeviceDocumentation : ReadWriteArrayOf_DeviceDocumentation { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
...
class StoredArrayOf_DeviceDocumentation : StandAloneArrayOf_DeviceDocumentation, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
