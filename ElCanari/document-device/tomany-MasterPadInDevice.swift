...
final class TransientArrayOf_MasterPadInDevice : ReadOnlyArrayOf_MasterPadInDevice {
  ...
  private weak var mDataProvider : ReadOnlyArrayOf_MasterPadInDevice? = nil // SHOULD BE WEAK
  ...
  private final func computeModelArray () {
    if self.mModelArrayShouldBeComputed {
      ...
      let newArray : EBReferenceArray <MasterPadInDevice>
  ...
  override var propval : EBReferenceArray <MasterPadInDevice> {
    self.computeModelArray ()
...
final class TransientArrayOfSuperOf_MasterPadInDevice <SUPER : EBManagedObject> : ReadOnlyArrayOf_MasterPadInDevice {
  ...
  private final func computeModelArray () {
    if self.mModelArrayShouldBeComputed {
      ...
      var newArray = EBReferenceArray <MasterPadInDevice> ()
...
final class ProxyArrayOf_MasterPadInDevice : ReadWriteArrayOf_MasterPadInDevice {
  ...
  private weak var mModel : ReadWriteArrayOf_MasterPadInDevice? = nil // SHOULD BE WEAK
  ...
  override func notifyModelDidChange () {
    let newModelArray : EBReferenceArray <MasterPadInDevice>
    if let model = self.mModel {
      switch model.selection {
      case .empty :
        newModelArray = EBReferenceArray ()
      case .single (let v) :
        newModelArray = EBReferenceArray <MasterPadInDevice> (v)
      case .multiple :
        newModelArray = EBReferenceArray ()
      }
    }else{
  ...
  override func setProp (_ inArrayValue : EBReferenceArray <MasterPadInDevice>) {
  ...
  init (prefKey : String) {
    ...
    if let array = UserDefaults.standard.array (forKey: prefKey) as? [NSDictionary] {
      ...
      for dictionary in array {
        let object = newInstanceOfEntityNamed (self.undoManager, "MasterPadInDevice") as! MasterPadInDevice
