...
class ReadOnlyArrayOf_MasterPadInDevice : ReadOnlyAbstractArrayProperty <MasterPadInDevice> {
  ...
  //--- Add observers to added objects
    for managedObject in inAddedSet.values {
      ...
      if let relay = self.mObserversOf_frontSideFilledBezierPathArray { // Transient property
        managedObject.frontSideFilledBezierPathArray_property.startsToBeObserved (by: relay)
      }
      if let relay = self.mObserversOf_backSideFilledBezierPathArray { // Transient property
        managedObject.backSideFilledBezierPathArray_property.startsToBeObserved (by: relay)
      }
    }
  }
  ...
  private final var mObserversOf_frontSideFilledBezierPathArray : EBWeakObserverSetRelay? = nil
  ...
  final func toMany_frontSideFilledBezierPathArray_StopsBeingObserved (by inObserver : EBObserverProtocol) {
    self.mObserversOf_frontSideFilledBezierPathArray?.remove (observer: inObserver)
  }
  ...
  private final var mObserversOf_backSideFilledBezierPathArray : EBWeakObserverSetRelay? = nil
  ...
  final func toMany_backSideFilledBezierPathArray_StopsBeingObserved (by inObserver : EBObserverProtocol) {
    self.mObserversOf_backSideFilledBezierPathArray?.remove (observer: inObserver)
  }
...
class StoredArrayOf_MasterPadInDevice : ReadWriteArrayOf_MasterPadInDevice, EBSignatureObserverProtocol, DocumentStorablePropertyProtocol {
  ...
  final override var propval : EBReferenceArray <MasterPadInDevice> { return self.mInternalArrayValue }
