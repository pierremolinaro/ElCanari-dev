...
class ReadOnlyArrayOf_SlavePadInDevice : ReadOnlyAbstractArrayProperty <SlavePadInDevice> {
  ...
  final func addEBObserverOf_frontSideFilledBezierPath (_ inObserver : EBObserverProtocol) {
    self.addEBObserver (inObserver)
  ...
  final func removeEBObserverOf_frontSideFilledBezierPath (_ inObserver : EBObserverProtocol) {
    self.removeEBObserver (inObserver)
  ...
  final func addEBObserversOf_frontSideFilledBezierPath_toElementsOfSet (_ inSet : EBReferenceSet <SlavePadInDevice>) {
    for managedObject in inSet.values {
      for (_, entry) in self.mObserversOf_frontSideFilledBezierPath.dictionary {
        if let observer = entry.observer {
  ...
  final func addEBObserverOf_backSideFilledBezierPath (_ inObserver : EBObserverProtocol) {
    self.addEBObserver (inObserver)
  ...
  final func removeEBObserverOf_backSideFilledBezierPath (_ inObserver : EBObserverProtocol) {
    self.removeEBObserver (inObserver)
  ...
  final func addEBObserversOf_backSideFilledBezierPath_toElementsOfSet (_ inSet : EBReferenceSet <SlavePadInDevice>) {
    for managedObject in inSet.values {
      for (_, entry) in self.mObserversOf_backSideFilledBezierPath.dictionary {
        if let observer = entry.observer {
...
final class TransientArrayOf_SlavePadInDevice : ReadOnlyArrayOf_SlavePadInDevice {
  ...
  private weak var mDataProvider : ReadOnlyArrayOf_SlavePadInDevice? = nil // SHOULD BE WEAK
  ...
  private final func computeModelArray () {
    if self.mModelArrayShouldBeComputed {
      ...
      let newArray : EBReferenceArray <SlavePadInDevice>
  ...
  override var propval : EBReferenceArray <SlavePadInDevice> {
    self.computeModelArray ()
...
final class TransientArrayOfSuperOf_SlavePadInDevice <SUPER : EBManagedObject> : ReadOnlyArrayOf_SlavePadInDevice {
  ...
  private final func computeModelArray () {
    if self.mModelArrayShouldBeComputed {
      ...
      var newArray = EBReferenceArray <SlavePadInDevice> ()
...
final class ProxyArrayOf_SlavePadInDevice : ReadWriteArrayOf_SlavePadInDevice {
  ...
  private weak var mModel : ReadWriteArrayOf_SlavePadInDevice? = nil // SHOULD BE WEAK
  ...
  override func notifyModelDidChange () {
    let newModelArray : EBReferenceArray <SlavePadInDevice>
    if let model = self.mModel {
      switch model.selection {
      case .empty :
        newModelArray = EBReferenceArray ()
      case .single (let v) :
        newModelArray = EBReferenceArray <SlavePadInDevice> (v)
      case .multiple :
        newModelArray = EBReferenceArray ()
      }
    }else{
  ...
  override func setProp (_ inArrayValue : EBReferenceArray <SlavePadInDevice>) {
