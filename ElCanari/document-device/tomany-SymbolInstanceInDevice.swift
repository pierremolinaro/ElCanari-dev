...
final class TransientArrayOf_SymbolInstanceInDevice : ReadOnlyArrayOf_SymbolInstanceInDevice {
  ...
  private final func computeModelArray () {
    if self.mModelArrayShouldBeComputed {
      ...
      let newArray : EBReferenceArray <SymbolInstanceInDevice>
  ...
  override var propval : EBReferenceArray <SymbolInstanceInDevice> {
    self.computeModelArray ()
...
final class TransientArrayOfSuperOf_SymbolInstanceInDevice <SUPER : EBManagedObject> : ReadOnlyArrayOf_SymbolInstanceInDevice {
  ...
  private final func computeModelArray () {
    if self.mModelArrayShouldBeComputed {
      ...
      var newArray = EBReferenceArray <SymbolInstanceInDevice> ()
...
final class ProxyArrayOf_SymbolInstanceInDevice : ReadWriteArrayOf_SymbolInstanceInDevice {
  ...
  override func notifyModelDidChange () {
    let newModelArray : EBReferenceArray <SymbolInstanceInDevice>
    if let model = self.mModel {
      switch model.selection {
      case .empty :
        newModelArray = EBReferenceArray ()
      case .single (let v) :
        newModelArray = EBReferenceArray <SymbolInstanceInDevice> (v)
      case .multiple :
        newModelArray = EBReferenceArray ()
      }
    }else{
  ...
  override func setProp (_ inArrayValue : EBReferenceArray <SymbolInstanceInDevice>) {
...
class StoredArrayOf_SymbolInstanceInDevice : ReadWriteArrayOf_SymbolInstanceInDevice, EBSignatureObserverProtocol {
...
final class PreferencesArrayOf_SymbolInstanceInDevice : StoredArrayOf_SymbolInstanceInDevice {
  ...
  init (prefKey : String) {
    ...
    if let array = UserDefaults.standard.array (forKey: prefKey) as? [NSDictionary] {
      ...
      for dictionary in array {
        let object = newInstanceOfEntityNamed (self.undoManager, "SymbolInstanceInDevice") as! SymbolInstanceInDevice
