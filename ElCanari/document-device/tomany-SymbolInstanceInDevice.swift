...
class ReadOnlyArrayOf_SymbolInstanceInDevice : EBReadOnlyAbstractArrayProperty <SymbolInstanceInDevice> {
  ...
  final func toMany_mInstanceName_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mInstanceName_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_symbolQualifiedName_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_symbolQualifiedName_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_pinSymbolQualifiedNames_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_pinSymbolQualifiedNames_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_unconnectedPins_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_unconnectedPins_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
