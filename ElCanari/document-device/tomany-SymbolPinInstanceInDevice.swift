...
class ReadOnlyArrayOf_SymbolPinInstanceInDevice : EBReadOnlyAbstractArrayProperty <SymbolPinInstanceInDevice> {
  ...
  final func toMany_pinName_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_pinName_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_pinQualifiedName_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_pinQualifiedName_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_numberShape_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_numberShape_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
