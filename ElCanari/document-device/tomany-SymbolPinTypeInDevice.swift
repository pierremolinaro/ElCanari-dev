...
class ReadOnlyArrayOf_SymbolPinTypeInDevice : EBReadOnlyAbstractArrayProperty <SymbolPinTypeInDevice> {
  ...
  final func toMany_mPinX_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mPinX_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mPinY_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mPinY_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mNameHorizontalAlignment_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mNameHorizontalAlignment_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mPinNameIsDisplayedInSchematics_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mPinNameIsDisplayedInSchematics_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mXNumber_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mXNumber_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mYNumber_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mYNumber_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mNumberHorizontalAlignment_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mNumberHorizontalAlignment_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_nameShape_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_nameShape_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: SymbolPinTypeInDevice
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_SymbolPinTypeInDevice : ReadWriteArrayOf_SymbolPinTypeInDevice { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
  ...
  override final var selection : EBSelection < [SymbolPinTypeInDevice] > {
    return .single (self.mInternalArrayValue.values)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  override func setProp (_ inValue : EBReferenceArray <SymbolPinTypeInDevice>) {
    self.mInternalArrayValue = inValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override var propval : EBReferenceArray <SymbolPinTypeInDevice> {
    return self.mInternalArrayValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final func remove (_ inObject : SymbolPinTypeInDevice) {
  ...
  final func add (_ inObject : SymbolPinTypeInDevice) {
...
class StoredArrayOf_SymbolPinTypeInDevice : StandAloneArrayOf_SymbolPinTypeInDevice, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
