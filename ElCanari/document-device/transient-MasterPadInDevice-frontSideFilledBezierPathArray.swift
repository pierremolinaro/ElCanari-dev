...
@MainActor func transient_MasterPadInDevice_frontSideFilledBezierPathArray (
       _ self_mCenterX : Int,                                               
       _ self_mCenterY : Int,                                               
       _ self_mWidth : Int,                                                 
       _ self_mHeight : Int,                                                
       ...
       _ self_mSlavePads_frontSideFilledBezierPath : [any SlavePadInDevice_frontSideFilledBezierPath]
) -> BezierPathArray {
