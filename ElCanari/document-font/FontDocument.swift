...
@objc(FontDocument) class FontDocument : EBManagedXibDocument {
  ...
  //--------------------------- Install regular bindings
    ...
    self.transparencyTextField?.bind_value (prefs_fontEditionTransparency_property, sendContinously:false, autoFormatter:false)
    self.transparencySlider?.bind_doubleValue (prefs_fontEditionTransparency_property, sendContinously:true)
    ...
    self.mShowGerberDrawingFlowCheckbox?.bind_value (prefs_showGerberDrawingFlow_property)
    self.mShowGerberDrawingIndexesCheckbox?.bind_value (prefs_showGerberDrawingIndexes_property)
    ...
    self.mSampleStringField?.bind_value (prefs_sampleString_property, sendContinously:true)
    self.mFontSampleStringView?.bind_bezierPath (self.rootObject.sampleStringBezierPath_property)
    self.mSampleStringSizeField?.bind_value (prefs_sampleStringSize_property, sendContinously:false, autoFormatter:false)
    ...
    self.currentCharacterView?.bind_transparency (prefs_fontEditionTransparency_property)
    self.currentCharacterView?.bind_displayFlow (prefs_showGerberDrawingFlow_property)
    self.currentCharacterView?.bind_displayDrawingIndexes (prefs_showGerberDrawingIndexes_property)
