...
@objc(FontDocument) class FontDocument : EBManagedDocument {
  ...
  //--------------------------- Install regular bindings
    ...
    self.transparencyTextField?.bind_value (prefs_fontEditionTransparency_property, file: #file, line: #line, sendContinously:false, autoFormatter:false)
    self.transparencySlider?.bind_doubleValue (prefs_fontEditionTransparency_property, file: #file, line: #line, sendContinously:true)
    ...
    self.mShowGerberDrawingFlowCheckbox?.bind_value (prefs_showGerberDrawingFlow_property, file: #file, line: #line)
    self.mShowGerberDrawingIndexesCheckbox?.bind_value (prefs_showGerberDrawingIndexes_property, file: #file, line: #line)
    ...
    self.mSampleStringField?.bind_value (prefs_sampleString_property, file: #file, line: #line, sendContinously:true)
    self.mFontSampleStringView?.bind_bezierPath (self.rootObject.sampleStringBezierPath_property, file: #file, line: #line)
    self.mSampleStringSizeField?.bind_value (prefs_sampleStringSize_property, file: #file, line: #line, sendContinously:false, autoFormatter:false)
    ...
    self.currentCharacterView?.bind_transparency (prefs_fontEditionTransparency_property, file: #file, line: #line)
    self.currentCharacterView?.bind_displayFlow (prefs_showGerberDrawingFlow_property, file: #file, line: #line)
    self.currentCharacterView?.bind_displayDrawingIndexes (prefs_showGerberDrawingIndexes_property, file: #file, line: #line)
