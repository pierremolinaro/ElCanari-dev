...
@objc(AutoLayoutFontDocument) class AutoLayoutFontDocument : EBAutoLayoutManagedDocument {
  ...
  final func SampleStringInspectorView () -> AutoLayoutVerticalStackView {
    ...
    do{
      ...
      let view_3_1 = AutoLayoutGridView2 ()
        .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Size", bold: false, size: .small, alignment: .center)
 ...
 ; return right } ())
        .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Ascenders", bold: false, size: .small, alignment: .center)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .bind_title (self.rootObject.sampleStringBezierPathAscent_property)
 ; return right } ())
        .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Descenders", bold: false, size: .small, alignment: .center)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
