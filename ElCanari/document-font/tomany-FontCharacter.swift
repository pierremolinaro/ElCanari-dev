...
class ReadOnlyArrayOf_FontCharacter : EBReadOnlyAbstractArrayProperty <FontCharacter> {
  ...
  final func toMany_codePoint_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_codePoint_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_advance_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_advance_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mWarnsWhenNoSegment_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mWarnsWhenNoSegment_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mWarnsWhenAdvanceIsZero_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mWarnsWhenAdvanceIsZero_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_segmentArrayForDrawing_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_segmentArrayForDrawing_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_gerberCode_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_gerberCode_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_gerberCodeInstructionCountMessage_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_gerberCodeInstructionCountMessage_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
