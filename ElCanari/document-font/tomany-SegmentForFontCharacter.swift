...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: SegmentForFontCharacter
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_SegmentForFontCharacter : ReadWriteArrayOf_SegmentForFontCharacter { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
  ...
  override final var selection : EBSelection < [SegmentForFontCharacter] > {
    return .single (self.mInternalArrayValue.values)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  override func setProp (_ inValue : EBReferenceArray <SegmentForFontCharacter>) {
    self.mInternalArrayValue = inValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override var propval : EBReferenceArray <SegmentForFontCharacter> {
    return self.mInternalArrayValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final func remove (_ inObject : SegmentForFontCharacter) {
  ...
  final func add (_ inObject : SegmentForFontCharacter) {
...
class StoredArrayOf_SegmentForFontCharacter : StandAloneArrayOf_SegmentForFontCharacter, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
