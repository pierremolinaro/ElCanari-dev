...
final class ToOneRelationship_BoardModelBackLegendTextEntity_myBoard : EBAbstractProperty {
  ...
  weak var owner : BoardModelBackLegendTextEntity? {
    didSet {
      if let unwrappedExplorer = mValueExplorer {
    ...
    didSet {
      ...
      //--- Reset old opposite relation ship
        if let unwrappedOldValue = oldValue {
          unwrappedOldValue.backLegendTexts.remove (unwrappedOwner)
        }
      //--- Set new opposite relation ship
        if let unwrappedValue = mValue {
          unwrappedValue.backLegendTexts.add (unwrappedOwner)
        }
      //--- Notify observers
        postEvent ()
      }
...
class BoardModelBackLegendTextEntity : EBManagedObject, BoardModelBackLegendTextEntity_x1, BoardModelBackLegendTextEntity_y1, BoardModelBackLegendTextEntity_x2, BoardModelBackLegendTextEntity_y2, BoardModelBackLegendTextEntity_width
{
  ...
  var myBoard = ToOneRelationship_BoardModelBackLegendTextEntity_myBoard ()
