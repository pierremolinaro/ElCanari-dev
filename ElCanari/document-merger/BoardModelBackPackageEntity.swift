...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//    ReadOnlyArrayOf_BoardModelBackPackageEntity
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

class ReadOnlyArrayOf_BoardModelBackPackageEntity : ReadOnlyAbstractArrayProperty <BoardModelBackPackageEntity> {
  ...
  final func addEBObserversOf_x1_toElementsOfSet (_ inSet : Set<BoardModelBackPackageEntity>) {
  ...
  final func removeEBObserversOf_x1_fromElementsOfSet (_ inSet : Set<BoardModelBackPackageEntity>) {
    for observer in mObserversOf_x1 {
      observer.postEvent ()
      for managedObject in inSet {
  ...
  final func addEBObserversOf_y1_toElementsOfSet (_ inSet : Set<BoardModelBackPackageEntity>) {
    for managedObject in inSet {
  ...
  final func removeEBObserversOf_y1_fromElementsOfSet (_ inSet : Set<BoardModelBackPackageEntity>) {
    for observer in mObserversOf_y1 {
      observer.postEvent ()
      for managedObject in inSet {
  ...
  final func addEBObserversOf_x2_toElementsOfSet (_ inSet : Set<BoardModelBackPackageEntity>) {
    for managedObject in inSet {
  ...
  final func removeEBObserversOf_x2_fromElementsOfSet (_ inSet : Set<BoardModelBackPackageEntity>) {
    for observer in mObserversOf_x2 {
      observer.postEvent ()
      for managedObject in inSet {
  ...
  final func addEBObserversOf_y2_toElementsOfSet (_ inSet : Set<BoardModelBackPackageEntity>) {
    for managedObject in inSet {
  ...
  final func removeEBObserversOf_y2_fromElementsOfSet (_ inSet : Set<BoardModelBackPackageEntity>) {
    for observer in mObserversOf_y2 {
      observer.postEvent ()
      for managedObject in inSet {
  ...
  final func addEBObserversOf_width_toElementsOfSet (_ inSet : Set<BoardModelBackPackageEntity>) {
    for managedObject in inSet {
  ...
  final func removeEBObserversOf_width_fromElementsOfSet (_ inSet : Set<BoardModelBackPackageEntity>) {
    for observer in mObserversOf_width {
      observer.postEvent ()
      for managedObject in inSet {
...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//    TransientArrayOf_BoardModelBackPackageEntity
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

class TransientArrayOf_BoardModelBackPackageEntity : ReadOnlyArrayOf_BoardModelBackPackageEntity {

  var readModelFunction : Optional<() -> EBProperty < [BoardModelBackPackageEntity] > >

  private var prop_cache : EBProperty < [BoardModelBackPackageEntity] >? 
  ...
  override var prop : EBProperty < [BoardModelBackPackageEntity] > {
    get {
      if let unwrappedComputeFunction = readModelFunction, prop_cache == nil {
        ...
        let newSet : Set <BoardModelBackPackageEntity>
        switch prop_cache! {
        case .multipleSelection, .noSelection :
          newSet = Set <BoardModelBackPackageEntity> ()
...
protocol BoardModelBackPackageEntity_x1 : class {
  var x1 : EBStoredProperty_Int { get }
}

//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

protocol BoardModelBackPackageEntity_y1 : class {
  var y1 : EBStoredProperty_Int { get }
}

//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

protocol BoardModelBackPackageEntity_x2 : class {
  var x2 : EBStoredProperty_Int { get }
}

//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

protocol BoardModelBackPackageEntity_y2 : class {
  var y2 : EBStoredProperty_Int { get }
}

//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

protocol BoardModelBackPackageEntity_width : class {
...
final class ToOneRelationship_BoardModelBackPackageEntity_myModel : EBAbstractProperty {
  ...
  weak var owner : BoardModelBackPackageEntity? {
    didSet {
      if let unwrappedExplorer = mValueExplorer {
    ...
    didSet {
      ...
      //--- Reset old opposite relation ship
        if let unwrappedOldValue = oldValue {
          unwrappedOldValue.backPackages.remove (unwrappedOwner)
        }
      //--- Set new opposite relation ship
        if let unwrappedValue = mValue {
          unwrappedValue.backPackages.add (unwrappedOwner)
        }
      //--- Notify observers
        postEvent ()
      }
...
class BoardModelBackPackageEntity : EBManagedObject, BoardModelBackPackageEntity_x1, BoardModelBackPackageEntity_y1, BoardModelBackPackageEntity_x2, BoardModelBackPackageEntity_y2, BoardModelBackPackageEntity_width
{
  ...
  var myModel = ToOneRelationship_BoardModelBackPackageEntity_myModel ()
