...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//    ReadOnlyArrayOf_BoardModelFrontComponentNameEntity
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

class ReadOnlyArrayOf_BoardModelFrontComponentNameEntity : ReadOnlyAbstractArrayProperty <BoardModelFrontComponentNameEntity> {
  ...
  final func addEBObserversOf_x1_toElementsOfSet (_ inSet : Set<BoardModelFrontComponentNameEntity>) {
  ...
  final func removeEBObserversOf_x1_fromElementsOfSet (_ inSet : Set<BoardModelFrontComponentNameEntity>) {
    for observer in mObserversOf_x1 {
      observer.postEvent ()
      for managedObject in inSet {
  ...
  final func addEBObserversOf_y1_toElementsOfSet (_ inSet : Set<BoardModelFrontComponentNameEntity>) {
    for managedObject in inSet {
  ...
  final func removeEBObserversOf_y1_fromElementsOfSet (_ inSet : Set<BoardModelFrontComponentNameEntity>) {
    for observer in mObserversOf_y1 {
      observer.postEvent ()
      for managedObject in inSet {
  ...
  final func addEBObserversOf_x2_toElementsOfSet (_ inSet : Set<BoardModelFrontComponentNameEntity>) {
    for managedObject in inSet {
  ...
  final func removeEBObserversOf_x2_fromElementsOfSet (_ inSet : Set<BoardModelFrontComponentNameEntity>) {
    for observer in mObserversOf_x2 {
      observer.postEvent ()
      for managedObject in inSet {
  ...
  final func addEBObserversOf_y2_toElementsOfSet (_ inSet : Set<BoardModelFrontComponentNameEntity>) {
    for managedObject in inSet {
  ...
  final func removeEBObserversOf_y2_fromElementsOfSet (_ inSet : Set<BoardModelFrontComponentNameEntity>) {
    for observer in mObserversOf_y2 {
      observer.postEvent ()
      for managedObject in inSet {
  ...
  final func addEBObserversOf_width_toElementsOfSet (_ inSet : Set<BoardModelFrontComponentNameEntity>) {
    for managedObject in inSet {
  ...
  final func removeEBObserversOf_width_fromElementsOfSet (_ inSet : Set<BoardModelFrontComponentNameEntity>) {
    for observer in mObserversOf_width {
      observer.postEvent ()
      for managedObject in inSet {
...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//    TransientArrayOf_BoardModelFrontComponentNameEntity
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

class TransientArrayOf_BoardModelFrontComponentNameEntity : ReadOnlyArrayOf_BoardModelFrontComponentNameEntity {

  var readModelFunction : Optional<() -> EBProperty < [BoardModelFrontComponentNameEntity] > >

  private var prop_cache : EBProperty < [BoardModelFrontComponentNameEntity] >? 
  ...
  override var prop : EBProperty < [BoardModelFrontComponentNameEntity] > {
    get {
      if let unwrappedComputeFunction = readModelFunction, prop_cache == nil {
        ...
        let newSet : Set <BoardModelFrontComponentNameEntity>
        switch prop_cache! {
        case .multipleSelection, .noSelection :
          newSet = Set <BoardModelFrontComponentNameEntity> ()
...
protocol BoardModelFrontComponentNameEntity_x1 : class {
  var x1 : EBStoredProperty_Int { get }
}

//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

protocol BoardModelFrontComponentNameEntity_y1 : class {
  var y1 : EBStoredProperty_Int { get }
}

//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

protocol BoardModelFrontComponentNameEntity_x2 : class {
  var x2 : EBStoredProperty_Int { get }
}

//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

protocol BoardModelFrontComponentNameEntity_y2 : class {
  var y2 : EBStoredProperty_Int { get }
}

//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

protocol BoardModelFrontComponentNameEntity_width : class {
...
final class ToOneRelationship_BoardModelFrontComponentNameEntity_myBoard : EBAbstractProperty {
  ...
  weak var owner : BoardModelFrontComponentNameEntity? {
    didSet {
      if let unwrappedExplorer = mValueExplorer {
    ...
    didSet {
      ...
      //--- Reset old opposite relation ship
        if let unwrappedOldValue = oldValue {
          unwrappedOldValue.frontComponentNames.remove (unwrappedOwner)
        }
      //--- Set new opposite relation ship
        if let unwrappedValue = mValue {
          unwrappedValue.frontComponentNames.add (unwrappedOwner)
        }
      //--- Notify observers
        postEvent ()
      }
...
class BoardModelFrontComponentNameEntity : EBManagedObject, BoardModelFrontComponentNameEntity_x1, BoardModelFrontComponentNameEntity_y1, BoardModelFrontComponentNameEntity_x2, BoardModelFrontComponentNameEntity_y2, BoardModelFrontComponentNameEntity_width
{
  ...
  var myBoard = ToOneRelationship_BoardModelFrontComponentNameEntity_myBoard ()
