...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//    ReadOnlyArrayOf_BoardModelFrontLayoutTextEntity
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

class ReadOnlyArrayOf_BoardModelFrontLayoutTextEntity : ReadOnlyAbstractArrayProperty <BoardModelFrontLayoutTextEntity> {
  ...
  final func addEBObserversOf_x1_toElementsOfSet (_ inSet : Set<BoardModelFrontLayoutTextEntity>) {
  ...
  final func removeEBObserversOf_x1_fromElementsOfSet (_ inSet : Set<BoardModelFrontLayoutTextEntity>) {
    for observer in mObserversOf_x1 {
      observer.postEvent ()
      for managedObject in inSet {
  ...
  final func addEBObserversOf_y1_toElementsOfSet (_ inSet : Set<BoardModelFrontLayoutTextEntity>) {
    for managedObject in inSet {
  ...
  final func removeEBObserversOf_y1_fromElementsOfSet (_ inSet : Set<BoardModelFrontLayoutTextEntity>) {
    for observer in mObserversOf_y1 {
      observer.postEvent ()
      for managedObject in inSet {
  ...
  final func addEBObserversOf_x2_toElementsOfSet (_ inSet : Set<BoardModelFrontLayoutTextEntity>) {
    for managedObject in inSet {
  ...
  final func removeEBObserversOf_x2_fromElementsOfSet (_ inSet : Set<BoardModelFrontLayoutTextEntity>) {
    for observer in mObserversOf_x2 {
      observer.postEvent ()
      for managedObject in inSet {
  ...
  final func addEBObserversOf_y2_toElementsOfSet (_ inSet : Set<BoardModelFrontLayoutTextEntity>) {
    for managedObject in inSet {
  ...
  final func removeEBObserversOf_y2_fromElementsOfSet (_ inSet : Set<BoardModelFrontLayoutTextEntity>) {
    for observer in mObserversOf_y2 {
      observer.postEvent ()
      for managedObject in inSet {
  ...
  final func addEBObserversOf_width_toElementsOfSet (_ inSet : Set<BoardModelFrontLayoutTextEntity>) {
    for managedObject in inSet {
  ...
  final func removeEBObserversOf_width_fromElementsOfSet (_ inSet : Set<BoardModelFrontLayoutTextEntity>) {
    for observer in mObserversOf_width {
      observer.postEvent ()
      for managedObject in inSet {
...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//    TransientArrayOf_BoardModelFrontLayoutTextEntity
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

class TransientArrayOf_BoardModelFrontLayoutTextEntity : ReadOnlyArrayOf_BoardModelFrontLayoutTextEntity {

  var readModelFunction : Optional<() -> EBProperty < [BoardModelFrontLayoutTextEntity] > >

  private var prop_cache : EBProperty < [BoardModelFrontLayoutTextEntity] >? 
  ...
  override var prop : EBProperty < [BoardModelFrontLayoutTextEntity] > {
    get {
      if let unwrappedComputeFunction = readModelFunction, prop_cache == nil {
        ...
        let newSet : Set <BoardModelFrontLayoutTextEntity>
        switch prop_cache! {
        case .multipleSelection, .noSelection :
          newSet = Set <BoardModelFrontLayoutTextEntity> ()
...
protocol BoardModelFrontLayoutTextEntity_x1 : class {
  var x1 : EBStoredProperty_Int { get }
}

//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

protocol BoardModelFrontLayoutTextEntity_y1 : class {
  var y1 : EBStoredProperty_Int { get }
}

//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

protocol BoardModelFrontLayoutTextEntity_x2 : class {
  var x2 : EBStoredProperty_Int { get }
}

//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

protocol BoardModelFrontLayoutTextEntity_y2 : class {
  var y2 : EBStoredProperty_Int { get }
}

//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

protocol BoardModelFrontLayoutTextEntity_width : class {
...
final class ToOneRelationship_BoardModelFrontLayoutTextEntity_myBoard : EBAbstractProperty {
  ...
  weak var owner : BoardModelFrontLayoutTextEntity? {
    didSet {
      if let unwrappedExplorer = mValueExplorer {
    ...
    didSet {
      ...
      //--- Reset old opposite relation ship
        if let unwrappedOldValue = oldValue {
          unwrappedOldValue.frontLayoutTexts.remove (unwrappedOwner)
        }
      //--- Set new opposite relation ship
        if let unwrappedValue = mValue {
          unwrappedValue.frontLayoutTexts.add (unwrappedOwner)
        }
      //--- Notify observers
        postEvent ()
      }
...
class BoardModelFrontLayoutTextEntity : EBManagedObject, BoardModelFrontLayoutTextEntity_x1, BoardModelFrontLayoutTextEntity_y1, BoardModelFrontLayoutTextEntity_x2, BoardModelFrontLayoutTextEntity_y2, BoardModelFrontLayoutTextEntity_width
{
  ...
  var myBoard = ToOneRelationship_BoardModelFrontLayoutTextEntity_myBoard ()
