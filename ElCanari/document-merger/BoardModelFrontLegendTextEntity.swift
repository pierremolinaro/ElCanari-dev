...
final class ToOneRelationship_BoardModelFrontLegendTextEntity_myBoard : EBAbstractProperty {
  ...
  weak var owner : BoardModelFrontLegendTextEntity? {
    didSet {
      if let unwrappedExplorer = mValueExplorer {
    ...
    didSet {
      ...
      //--- Reset old opposite relation ship
        if let unwrappedOldValue = oldValue {
          unwrappedOldValue.frontLegendTexts.remove (unwrappedOwner)
        }
      //--- Set new opposite relation ship
        if let unwrappedValue = mValue {
          unwrappedValue.frontLegendTexts.add (unwrappedOwner)
        }
      //--- Notify observers
        postEvent ()
      }
...
class BoardModelFrontLegendTextEntity : EBManagedObject, BoardModelFrontLegendTextEntity_x1, BoardModelFrontLegendTextEntity_y1, BoardModelFrontLegendTextEntity_x2, BoardModelFrontLegendTextEntity_y2, BoardModelFrontLegendTextEntity_width
{
  ...
  var myBoard = ToOneRelationship_BoardModelFrontLegendTextEntity_myBoard ()
