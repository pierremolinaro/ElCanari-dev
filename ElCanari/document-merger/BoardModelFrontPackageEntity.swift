...
final class ToOneRelationship_BoardModelFrontPackageEntity_myModel : EBAbstractProperty {
  ...
  weak var owner : BoardModelFrontPackageEntity? {
    didSet {
      if let unwrappedExplorer = mValueExplorer {
    ...
    didSet {
      ...
      //--- Reset old opposite relation ship
        if let unwrappedOldValue = oldValue {
          unwrappedOldValue.frontPackages.remove (unwrappedOwner)
        }
      //--- Set new opposite relation ship
        if let unwrappedValue = mValue {
          unwrappedValue.frontPackages.add (unwrappedOwner)
        }
      //--- Notify observers
        postEvent ()
      }
...
class BoardModelFrontPackageEntity : EBManagedObject, BoardModelFrontPackageEntity_x1, BoardModelFrontPackageEntity_y1, BoardModelFrontPackageEntity_x2, BoardModelFrontPackageEntity_y2, BoardModelFrontPackageEntity_width
{
  ...
  var myModel = ToOneRelationship_BoardModelFrontPackageEntity_myModel ()
