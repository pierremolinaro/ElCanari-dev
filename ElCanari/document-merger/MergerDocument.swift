...
@objc(MergerDocument) class MergerDocument : EBManagedXibDocument {
  ...
  //--------------------------- Install regular bindings
    ...
    self.mModelViewHorizontalFlipCheckbox?.bind_value (prefs_mergerModelViewHorizontalFlip_property)
    self.mModelViewVerticalFlipCheckbox?.bind_value (prefs_mergerModelViewVerticalFlip_property)
    self.mModelViewDisplayHolesCheckbox?.bind_value (prefs_mergerModelViewDisplayHoles_property)
    self.mModelViewDisplayViasCheckbox?.bind_value (prefs_mergerModelViewDisplayVias_property)
    self.mModelViewDisplayFrontPadsCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontPads_property)
    self.mModelViewDisplayInternalBoardsLimitsCheckbox?.bind_value (prefs_mergerModelViewDisplayInternalBoardsLimits_property)
    self.mModelViewDisplayBoardLimitsCheckbox?.bind_value (prefs_mergerModelViewDisplayBoardLimits_property)
    self.mModelViewDisplayFrontComponentNamesCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontComponentNames_property)
    self.mModelViewDisplayFrontComponenValuesCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontComponentValues_property)
    self.mModelViewDisplayFrontPackagesCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontPackages_property)
    self.mModelViewDisplayFrontLegendTextsCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontLegendTexts_property)
    self.mModelViewDisplayFrontTracksCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontTracks_property)
    self.mModelViewDisplayFrontLayoutTextsCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontLayoutTexts_property)
    self.mModelViewDisplayBackPadsCheckbox?.bind_value (prefs_mergerModelViewDisplayBackPads_property)
    self.mModelViewDisplayBackComponentNamesCheckbox?.bind_value (prefs_mergerModelViewDisplayBackComponentNames_property)
    self.mModelViewDisplayBackComponenValuesCheckbox?.bind_value (prefs_mergerModelViewDisplayBackComponentValues_property)
    self.mModelViewDisplayBackLegendTextsCheckbox?.bind_value (prefs_mergerModelViewDisplayBackLegendTexts_property)
    self.mModelViewDisplayBackPackagesCheckbox?.bind_value (prefs_mergerModelViewDisplayBackPackages_property)
    self.mModelViewDisplayBackTracksCheckbox?.bind_value (prefs_mergerModelViewDisplayBackTracks_property)
    self.mModelViewDisplayBackLayoutTextsCheckbox?.bind_value (prefs_mergerModelViewDisplayBackLayoutTexts_property)
    self.mModelViewDisplayFrontLegendLinesCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontLegendLines_property)
    self.mModelViewDisplayBackLegendLinesCheckbox?.bind_value (prefs_mergerModelViewDisplayBackLegendLines_property)
    self.mBoardViewHorizontalFlipCheckbox?.bind_value (prefs_mergerBoardViewHorizontalFlip_property)
    self.mBoardViewVerticalFlipCheckbox?.bind_value (prefs_mergerBoardViewVerticalFlip_property)
    self.mBoardViewDisplayHolesCheckbox?.bind_value (prefs_mergerBoardViewDisplayHoles_property)
    self.mBoardViewDisplayViasCheckbox?.bind_value (prefs_mergerBoardViewDisplayVias_property)
    self.mBoardViewDisplayFrontPadsCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontPads_property)
    self.mBoardViewDisplayBoardLimitsCheckbox?.bind_value (prefs_mergerBoardViewDisplayBoardLimits_property)
    self.mBoardViewDisplayInternalBoardsLimitsCheckbox?.bind_value (prefs_mergerBoardViewDisplayInternalBoardsLimits_property)
    self.mBoardViewDisplayFrontComponentNamesCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontComponentNames_property)
    self.mBoardViewDisplayFrontComponenValuesCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontComponentValues_property)
    self.mBoardViewDisplayFrontPackagesCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontPackages_property)
    self.mBoardViewDisplayFrontLegendTextsCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontLegendTexts_property)
    self.mBoardViewDisplayFrontTracksCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontTracks_property)
    self.mBoardViewDisplayFrontLayoutTextsCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontLayoutTexts_property)
    self.mBoardViewDisplayBackPadsCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackPads_property)
    self.mBoardViewDisplayBackComponentNamesCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackComponentNames_property)
    self.mBoardViewDisplayBackComponenValuesCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackComponentValues_property)
    self.mBoardViewDisplayBackLegendTextsCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackLegendTexts_property)
    self.mBoardViewDisplayBackPackagesCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackPackages_property)
    self.mBoardViewDisplayBackTracksCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackTracks_property)
    self.mBoardViewDisplayBackLayoutTextsCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackLayoutTexts_property)
    self.mBoardViewDisplayFrontLegendLinesCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontLegendLines_property)
    self.mBoardViewDisplayBackLegendLinesCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackLegendLines_property)
    self.mergerViewDisplayHolesColorWell?.bind_color (prefs_mergerColorHoles_property, sendContinously:false)
    self.mergerViewDisplayViasColorWell?.bind_color (prefs_mergerColorVias_property, sendContinously:false)
    self.mergerViewDisplayFrontPadsColorWell?.bind_color (prefs_mergerColorFrontPads_property, sendContinously:false)
    self.mergerViewDisplayBoardLimitsColorWell?.bind_color (prefs_mergerColorBoardLimits_property, sendContinously:false)
    self.mergerViewDisplayInternalBoardsLimitsColorWell?.bind_color (prefs_mergerColorInternalBoardsLimits_property, sendContinously:false)
    self.mergerViewDisplayFrontComponentNamesColorWell?.bind_color (prefs_mergerColorFrontComponentNames_property, sendContinously:false)
    self.mergerViewDisplayFrontComponentValuesColorWell?.bind_color (prefs_mergerColorFrontComponentValues_property, sendContinously:false)
    self.mergerViewDisplayFrontPackagesColorWell?.bind_color (prefs_mergerColorFrontPackages_property, sendContinously:false)
    self.mergerViewDisplayFrontLegendTextsColorWell?.bind_color (prefs_mergerColorFrontLegendTexts_property, sendContinously:false)
    self.mergerViewDisplayFrontTracksColorWell?.bind_color (prefs_mergerColorFrontTracks_property, sendContinously:false)
    self.mergerViewDisplayFrontLayoutTextsColorWell?.bind_color (prefs_mergerColorFrontLayoutTexts_property, sendContinously:false)
    self.mergerViewDisplayBackPadsColorWell?.bind_color (prefs_mergerColorBackPads_property, sendContinously:false)
    self.mergerViewDisplayBackComponentNamesColorWell?.bind_color (prefs_mergerColorBackComponentNames_property, sendContinously:false)
    self.mergerViewDisplayBackComponentValuesColorWell?.bind_color (prefs_mergerColorBackComponentValues_property, sendContinously:false)
    self.mergerViewDisplayBackLegendTextsColorWell?.bind_color (prefs_mergerColorBackLegendTexts_property, sendContinously:false)
    self.mergerViewDisplayBackPackagesColorWell?.bind_color (prefs_mergerColorBackPackages_property, sendContinously:false)
    self.mergerViewDisplayBackTracksColorWell?.bind_color (prefs_mergerColorBackTracks_property, sendContinously:false)
    self.mergerViewDisplayBackLayoutTextsColorWell?.bind_color (prefs_mergerColorBackLayoutTexts_property, sendContinously:false)
    self.mergerViewBackgroundColorWell?.bind_color (prefs_mergerColorBackground_property, sendContinously:false)
    self.mergerViewFrontLegendLinesColorWell?.bind_color (prefs_mergerColorFrontLegendLines_property, sendContinously:false)
    self.mergerViewBackLegendLinesColorWell?.bind_color (prefs_mergerColorBackLegendLines_property, sendContinously:false)
    self.mBoardModelView?.bind_zoom (self.mBoardModelSelection.zoom_property)
    self.mBoardModelView?.bind_horizontalFlip (prefs_mergerModelViewHorizontalFlip_property)
    self.mBoardModelView?.bind_verticalFlip (prefs_mergerModelViewVerticalFlip_property)
    ...
    self.mComposedBoardView?.bind_horizontalFlip (prefs_mergerBoardViewHorizontalFlip_property)
    self.mComposedBoardView?.bind_verticalFlip (prefs_mergerBoardViewVerticalFlip_property)
