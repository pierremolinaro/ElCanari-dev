...
@objc(MergerDocument) class MergerDocument : EBManagedDocument {
  ...
  //--------------------------- Install regular bindings
    ...
    self.mBoardModelView?.bind_rect (self.mBoardModelSelection.modelRect_property, file: #file, line: #line)
    ...
    self.mComposedBoardView?.bind_rect (self.rootObject.boardRect_property, file: #file, line: #line)
  ...
  //--------------------------- Unbind regular bindings
    ...
    self.mBoardModelView?.unbind_rect ()
    ...
    self.mComposedBoardView?.unbind_rect ()
