...
@objc(MergerDocument) class MergerDocument : EBManagedDocument {
  ...
  //--------------------------- Install regular bindings
    ...
    self.mModelViewHorizontalFlipCheckbox?.bind_value (prefs_mergerModelViewHorizontalFlip_property, file: #file, line: #line)
    self.mModelViewVerticalFlipCheckbox?.bind_value (prefs_mergerModelViewVerticalFlip_property, file: #file, line: #line)
    self.mModelViewDisplayHolesCheckbox?.bind_value (prefs_mergerModelViewDisplayHoles_property, file: #file, line: #line)
    self.mModelViewDisplayViasCheckbox?.bind_value (prefs_mergerModelViewDisplayVias_property, file: #file, line: #line)
    self.mModelViewDisplayFrontPadsCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontPads_property, file: #file, line: #line)
    self.mModelViewDisplayInternalBoardsLimitsCheckbox?.bind_value (prefs_mergerModelViewDisplayInternalBoardsLimits_property, file: #file, line: #line)
    self.mModelViewDisplayBoardLimitsCheckbox?.bind_value (prefs_mergerModelViewDisplayBoardLimits_property, file: #file, line: #line)
    self.mModelViewDisplayFrontComponentNamesCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontComponentNames_property, file: #file, line: #line)
    self.mModelViewDisplayFrontComponenValuesCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontComponentValues_property, file: #file, line: #line)
    self.mModelViewDisplayFrontPackagesCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontPackages_property, file: #file, line: #line)
    self.mModelViewDisplayFrontLegendTextsCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontLegendTexts_property, file: #file, line: #line)
    self.mModelViewDisplayFrontTracksCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontTracks_property, file: #file, line: #line)
    self.mModelViewDisplayFrontLayoutTextsCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontLayoutTexts_property, file: #file, line: #line)
    self.mModelViewDisplayBackPadsCheckbox?.bind_value (prefs_mergerModelViewDisplayBackPads_property, file: #file, line: #line)
    self.mModelViewDisplayBackComponentNamesCheckbox?.bind_value (prefs_mergerModelViewDisplayBackComponentNames_property, file: #file, line: #line)
    self.mModelViewDisplayBackComponenValuesCheckbox?.bind_value (prefs_mergerModelViewDisplayBackComponentValues_property, file: #file, line: #line)
    self.mModelViewDisplayBackLegendTextsCheckbox?.bind_value (prefs_mergerModelViewDisplayBackLegendTexts_property, file: #file, line: #line)
    self.mModelViewDisplayBackPackagesCheckbox?.bind_value (prefs_mergerModelViewDisplayBackPackages_property, file: #file, line: #line)
    self.mModelViewDisplayBackTracksCheckbox?.bind_value (prefs_mergerModelViewDisplayBackTracks_property, file: #file, line: #line)
    self.mModelViewDisplayBackLayoutTextsCheckbox?.bind_value (prefs_mergerModelViewDisplayBackLayoutTexts_property, file: #file, line: #line)
    self.mModelViewDisplayFrontLegendLinesCheckbox?.bind_value (prefs_mergerModelViewDisplayFrontLegendLines_property, file: #file, line: #line)
    self.mModelViewDisplayBackLegendLinesCheckbox?.bind_value (prefs_mergerModelViewDisplayBackLegendLines_property, file: #file, line: #line)
    self.mBoardViewHorizontalFlipCheckbox?.bind_value (prefs_mergerBoardViewHorizontalFlip_property, file: #file, line: #line)
    self.mBoardViewVerticalFlipCheckbox?.bind_value (prefs_mergerBoardViewVerticalFlip_property, file: #file, line: #line)
    self.mBoardViewDisplayHolesCheckbox?.bind_value (prefs_mergerBoardViewDisplayHoles_property, file: #file, line: #line)
    self.mBoardViewDisplayViasCheckbox?.bind_value (prefs_mergerBoardViewDisplayVias_property, file: #file, line: #line)
    self.mBoardViewDisplayFrontPadsCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontPads_property, file: #file, line: #line)
    self.mBoardViewDisplayBoardLimitsCheckbox?.bind_value (prefs_mergerBoardViewDisplayBoardLimits_property, file: #file, line: #line)
    self.mBoardViewDisplayInternalBoardsLimitsCheckbox?.bind_value (prefs_mergerBoardViewDisplayInternalBoardsLimits_property, file: #file, line: #line)
    self.mBoardViewDisplayFrontComponentNamesCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontComponentNames_property, file: #file, line: #line)
    self.mBoardViewDisplayFrontComponenValuesCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontComponentValues_property, file: #file, line: #line)
    self.mBoardViewDisplayFrontPackagesCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontPackages_property, file: #file, line: #line)
    self.mBoardViewDisplayFrontLegendTextsCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontLegendTexts_property, file: #file, line: #line)
    self.mBoardViewDisplayFrontTracksCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontTracks_property, file: #file, line: #line)
    self.mBoardViewDisplayFrontLayoutTextsCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontLayoutTexts_property, file: #file, line: #line)
    self.mBoardViewDisplayBackPadsCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackPads_property, file: #file, line: #line)
    self.mBoardViewDisplayBackComponentNamesCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackComponentNames_property, file: #file, line: #line)
    self.mBoardViewDisplayBackComponenValuesCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackComponentValues_property, file: #file, line: #line)
    self.mBoardViewDisplayBackLegendTextsCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackLegendTexts_property, file: #file, line: #line)
    self.mBoardViewDisplayBackPackagesCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackPackages_property, file: #file, line: #line)
    self.mBoardViewDisplayBackTracksCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackTracks_property, file: #file, line: #line)
    self.mBoardViewDisplayBackLayoutTextsCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackLayoutTexts_property, file: #file, line: #line)
    self.mBoardViewDisplayFrontLegendLinesCheckbox?.bind_value (prefs_mergerBoardViewDisplayFrontLegendLines_property, file: #file, line: #line)
    self.mBoardViewDisplayBackLegendLinesCheckbox?.bind_value (prefs_mergerBoardViewDisplayBackLegendLines_property, file: #file, line: #line)
    self.mergerViewDisplayHolesColorWell?.bind_color (prefs_mergerColorHoles_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayViasColorWell?.bind_color (prefs_mergerColorVias_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayFrontPadsColorWell?.bind_color (prefs_mergerColorFrontPads_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayBoardLimitsColorWell?.bind_color (prefs_mergerColorBoardLimits_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayInternalBoardsLimitsColorWell?.bind_color (prefs_mergerColorInternalBoardsLimits_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayFrontComponentNamesColorWell?.bind_color (prefs_mergerColorFrontComponentNames_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayFrontComponentValuesColorWell?.bind_color (prefs_mergerColorFrontComponentValues_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayFrontPackagesColorWell?.bind_color (prefs_mergerColorFrontPackages_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayFrontLegendTextsColorWell?.bind_color (prefs_mergerColorFrontLegendTexts_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayFrontTracksColorWell?.bind_color (prefs_mergerColorFrontTracks_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayFrontLayoutTextsColorWell?.bind_color (prefs_mergerColorFrontLayoutTexts_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayBackPadsColorWell?.bind_color (prefs_mergerColorBackPads_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayBackComponentNamesColorWell?.bind_color (prefs_mergerColorBackComponentNames_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayBackComponentValuesColorWell?.bind_color (prefs_mergerColorBackComponentValues_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayBackLegendTextsColorWell?.bind_color (prefs_mergerColorBackLegendTexts_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayBackPackagesColorWell?.bind_color (prefs_mergerColorBackPackages_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayBackTracksColorWell?.bind_color (prefs_mergerColorBackTracks_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewDisplayBackLayoutTextsColorWell?.bind_color (prefs_mergerColorBackLayoutTexts_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewBackgroundColorWell?.bind_color (prefs_mergerColorBackground_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewFrontLegendLinesColorWell?.bind_color (prefs_mergerColorFrontLegendLines_property, file: #file, line: #line, sendContinously:false)
    self.mergerViewBackLegendLinesColorWell?.bind_color (prefs_mergerColorBackLegendLines_property, file: #file, line: #line, sendContinously:false)
    self.mBoardModelView?.bind_zoom (self.mBoardModelSelection.zoom_property, file: #file, line: #line)
    self.mBoardModelView?.bind_horizontalFlip (prefs_mergerModelViewHorizontalFlip_property, file: #file, line: #line)
    self.mBoardModelView?.bind_verticalFlip (prefs_mergerModelViewVerticalFlip_property, file: #file, line: #line)
    ...
    self.mComposedBoardView?.bind_horizontalFlip (prefs_mergerBoardViewHorizontalFlip_property, file: #file, line: #line)
    self.mComposedBoardView?.bind_verticalFlip (prefs_mergerBoardViewVerticalFlip_property, file: #file, line: #line)
