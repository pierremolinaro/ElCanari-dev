...
@objc(MergerDocument) class MergerDocument : EBManagedDocument {
  ...
  //--------------------------- Install regular bindings
    ...
    mBoardModelView?.bind_rect (self.mBoardModelSelection.modelRect_property, file: #file, line: #line)
    ...
    mComposedBoardView?.bind_rect (self.rootObject.boardRect_property, file: #file, line: #line)
    ...
    mComposedBoardView?.bind_overObjectsDisplay (self.rootObject.boardOutlineRectDisplay_property, file: #file, line: #line)
  ...
  //--------------------------- Unbind regular bindings
    ...
    mComposedBoardView?.unbind_rect ()
