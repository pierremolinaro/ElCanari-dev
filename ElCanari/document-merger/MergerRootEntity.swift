  ...
  private var mValue = [BoardModelEntity] () {
    didSet {
      ...
      //--- Removed object set
        ...
        removeEBObserversOf_displayBackComponentNames_fromElementsOfSet (removedObjectSet)
        removeEBObserversOf_displayBackComponentValues_fromElementsOfSet (removedObjectSet)
        removeEBObserversOf_displayBackPackages_fromElementsOfSet (removedObjectSet)
        removeEBObserversOf_displayBackPads_fromElementsOfSet (removedObjectSet)
        removeEBObserversOf_displayBackTracks_fromElementsOfSet (removedObjectSet)
        removeEBObserversOf_displayBoardLimits_fromElementsOfSet (removedObjectSet)
        removeEBObserversOf_displayFrontComponentNames_fromElementsOfSet (removedObjectSet)
        removeEBObserversOf_displayFrontComponentValues_fromElementsOfSet (removedObjectSet)
        removeEBObserversOf_displayFrontPackages_fromElementsOfSet (removedObjectSet)
      ...
      //--- Added object set
        ...
        addEBObserversOf_displayBackComponentNames_toElementsOfSet (addedObjectSet)
        addEBObserversOf_displayBackComponentValues_toElementsOfSet (addedObjectSet)
        addEBObserversOf_displayBackPackages_toElementsOfSet (addedObjectSet)
        addEBObserversOf_displayBackPads_toElementsOfSet (addedObjectSet)
        addEBObserversOf_displayBackTracks_toElementsOfSet (addedObjectSet)
        addEBObserversOf_displayBoardLimits_toElementsOfSet (addedObjectSet)
        addEBObserversOf_displayFrontComponentNames_toElementsOfSet (addedObjectSet)
        addEBObserversOf_displayFrontComponentValues_toElementsOfSet (addedObjectSet)
        addEBObserversOf_displayFrontPackages_toElementsOfSet (addedObjectSet)
