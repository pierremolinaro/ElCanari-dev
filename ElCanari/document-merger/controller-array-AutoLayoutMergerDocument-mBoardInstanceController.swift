...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//    Array controller AutoLayoutMergerDocument mBoardInstanceController
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

final class Controller_AutoLayoutMergerDocument_mBoardInstanceController : ReadOnlyAbstractGenericRelationshipProperty, EBGraphicViewControllerProtocol, HiddenEBProtocol {
  ...
  private var mPrivateSelectedSet = EBReferenceSet <MergerBoardInstance> () {
    didSet {
  ...
  final func bind_model (_ inModel : ReadWriteArrayOf_MergerBoardInstance, _ inUndoManager : EBUndoManager?) {
    self.mModel = inModel
  ...
  @objc func remove (_ sender : Any) {
    if let model = self.mModel {
      ...
      //--- Dictionary of object sorted indexes
        var sortedObjectDictionary = EBReferenceDictionary <MergerBoardInstance, Int> ()
      ...
      //--- Dictionary of object absolute indexes
        var objectDictionary = EBReferenceDictionary <MergerBoardInstance, Int> ()
        for (index, object) in model_prop.enumerated () {
      ...
      //----------------------------------------- Set new selection
        var newSelectionSet = EBReferenceSet <MergerBoardInstance> ()
