...
class BoardModel : EBManagedObject,
  ...
  final var frontLegendLines : [SegmentEntity] {
  ...
  final var frontLegendTexts : [SegmentEntity] {
  ...
  final var backLegendTexts : [SegmentEntity] {
  ...
  final var internalBoardsLimits : [SegmentEntity] {
  ...
  final var backPads : [BoardModelPad] {
  ...
  final var backComponentNames : [SegmentEntity] {
  ...
  final var frontComponentValues : [SegmentEntity] {
  ...
  final var backTracks : [SegmentEntity] {
  ...
  final var backPackages : [SegmentEntity] {
  ...
  final var myInstances : [MergerBoardInstance] {
  ...
  final let boardLimits_property = EBTransientProperty_MergerBoardLimits ()
  ...
  //--- Atomic property: backLegendLinesBezierPaths
    // self.backLegendLinesBezierPaths_property.configure (self.backLegendLinesSegments_property, transient_BoardModel_backLegendLinesBezierPaths)
  ...
  //--- Atomic property: frontLegendTextsBezierPaths
    // self.frontLegendTextsBezierPaths_property.configure (self.frontLegendTextsSegments_property, transient_BoardModel_frontLegendTextsBezierPaths)
  ...
  //--- Atomic property: frontLayoutTextsBezierPaths
    // self.frontLayoutTextsBezierPaths_property.configure (self.frontLayoutTextsSegments_property, transient_BoardModel_frontLayoutTextsBezierPaths)
  ...
  //--- Atomic property: backLegendTextsBezierPaths
    // self.backLegendTextsBezierPaths_property.configure (self.backLegendTextsSegments_property, transient_BoardModel_backLegendTextsBezierPaths)
  ...
  //--- Atomic property: backLayoutTextsBezierPaths
    // self.backLayoutTextsBezierPaths_property.configure (self.backLayoutTextsSegments_property, transient_BoardModel_backLayoutTextsBezierPaths)
  ...
  //--- Atomic property: internalBoardsLimitsBezierPaths
    // self.internalBoardsLimitsBezierPaths_property.configure (self.internalBoardsLimitsSegments_property, transient_BoardModel_internalBoardsLimitsBezierPaths)
  ...
  //--- Atomic property: holesBezierPaths
    // self.holesBezierPaths_property.configure (self.drillSegments_property, transient_BoardModel_holesBezierPaths)
  ...
  //--- Atomic property: viasBezierPaths
    // self.viasBezierPaths_property.configure (self.viaShapes_property, transient_BoardModel_viasBezierPaths)
  ...
  //--- Atomic property: frontPadsBezierPaths
    // self.frontPadsBezierPaths_property.configure (self.frontPadArray_property, transient_BoardModel_frontPadsBezierPaths)
  ...
  //--- Atomic property: backPadsBezierPaths
    // self.backPadsBezierPaths_property.configure (self.backPadArray_property, transient_BoardModel_backPadsBezierPaths)
  ...
  //--- Atomic property: boardLimits
    // self.boardLimits_property.configure (self.modelWidth_property, self.modelHeight_property, self.modelLimitWidth_property, prefs_mergerModelViewDisplayBoardLimits_property, transient_BoardModel_boardLimits)
    self.boardLimits_property.mReadModelFunction = { [weak self] in
      if let unwSelf = self {
        ...
        kind &= prefs_mergerModelViewDisplayBoardLimits_property_selection.kind ()
        switch kind {
        case .empty :
          return .empty
        case .multiple :
          return .multiple
        case .single :
          switch (unwSelf.modelWidth_property_selection, unwSelf.modelHeight_property_selection, unwSelf.modelLimitWidth_property_selection, prefs_mergerModelViewDisplayBoardLimits_property_selection) {
    ...
    prefs_mergerModelViewDisplayBoardLimits_property.addEBObserver (self.boardLimits_property)
  //--- Atomic property: boardLimitsBezierPaths
    // self.boardLimitsBezierPaths_property.configure (self.modelWidth_property, self.modelHeight_property, self.modelLimitWidth_property, transient_BoardModel_boardLimitsBezierPaths)
  ...
  //--- Atomic property: backComponentNamesBezierPaths
    // self.backComponentNamesBezierPaths_property.configure (self.backComponentNameSegments_property, transient_BoardModel_backComponentNamesBezierPaths)
  ...
  //--- Atomic property: frontComponentNamesBezierPaths
    // self.frontComponentNamesBezierPaths_property.configure (self.frontComponentNameSegments_property, transient_BoardModel_frontComponentNamesBezierPaths)
  ...
  //--- Atomic property: frontComponentValuesBezierPaths
    // self.frontComponentValuesBezierPaths_property.configure (self.frontComponentValueSegments_property, transient_BoardModel_frontComponentValuesBezierPaths)
  ...
  //--- Atomic property: backComponentValuesBezierPaths
    // self.backComponentValuesBezierPaths_property.configure (self.backComponentValueSegments_property, transient_BoardModel_backComponentValuesBezierPaths)
  ...
  //--- Atomic property: backTracksBezierPaths
    // self.backTracksBezierPaths_property.configure (self.backTrackSegments_property, transient_BoardModel_backTracksBezierPaths)
  ...
  //--- Atomic property: frontTracksBezierPaths
    // self.frontTracksBezierPaths_property.configure (self.frontTrackSegments_property, transient_BoardModel_frontTracksBezierPaths)
  ...
  //--- Atomic property: frontPackagesBezierPaths
    // self.frontPackagesBezierPaths_property.configure (self.frontPackagesSegments_property, transient_BoardModel_frontPackagesBezierPaths)
  ...
  //--- Atomic property: backPackagesBezierPaths
    // self.backPackagesBezierPaths_property.configure (self.backPackagesSegments_property, transient_BoardModel_backPackagesBezierPaths)
  ...
  //--- Atomic property: instanceCount
    // self.instanceCount_property.configure (self.myInstances_property, transient_BoardModel_instanceCount)
  ...
  //--- Atomic property: frontLegendLinesBezierPaths
    // self.frontLegendLinesBezierPaths_property.configure (self.frontLegendLinesSegments_property, transient_BoardModel_frontLegendLinesBezierPaths)
  ...
  //--- Atomic property: imageForModel
    // self.imageForModel_property.configure (prefs_mergerColorBackground_property, self.modelWidth_property, self.modelHeight_property, self.boardLimitsBezierPaths_property, prefs_mergerModelViewDisplayBoardLimits_property, prefs_mergerColorBoardLimits_property, self.internalBoardsLimitsBezierPaths_property, prefs_mergerModelViewDisplayInternalBoardsLimits_property, prefs_mergerColorInternalBoardsLimits_property, self.frontTracksBezierPaths_property, prefs_mergerModelViewDisplayFrontTracks_property, prefs_mergerColorFrontTracks_property, self.backTracksBezierPaths_property, prefs_mergerModelViewDisplayBackTracks_property, prefs_mergerColorBackTracks_property, self.frontPadsBezierPaths_property, prefs_mergerModelViewDisplayFrontPads_property, prefs_mergerColorFrontPads_property, self.backPadsBezierPaths_property, prefs_mergerModelViewDisplayBackPads_property, prefs_mergerColorBackPads_property, self.viasBezierPaths_property, prefs_mergerModelViewDisplayVias_property, prefs_mergerColorVias_property, self.holesBezierPaths_property, prefs_mergerModelViewDisplayHoles_property, prefs_mergerColorHoles_property, self.frontLegendLinesBezierPaths_property, prefs_mergerModelViewDisplayFrontLegendLines_property, prefs_mergerColorFrontLegendLines_property, self.backLegendLinesBezierPaths_property, prefs_mergerModelViewDisplayBackLegendLines_property, prefs_mergerColorBackLegendLines_property, self.frontLegendTextsBezierPaths_property, prefs_mergerModelViewDisplayFrontLegendTexts_property, prefs_mergerColorFrontLegendTexts_property, self.frontLayoutTextsBezierPaths_property, prefs_mergerModelViewDisplayFrontLayoutTexts_property, prefs_mergerColorFrontLayoutTexts_property, self.backLegendTextsBezierPaths_property, prefs_mergerModelViewDisplayBackLegendTexts_property, prefs_mergerColorBackLegendTexts_property, self.backLayoutTextsBezierPaths_property, prefs_mergerModelViewDisplayBackLayoutTexts_property, prefs_mergerColorBackLayoutTexts_property, self.backComponentNamesBezierPaths_property, prefs_mergerModelViewDisplayBackComponentNames_property, prefs_mergerColorBackComponentNames_property, self.frontComponentNamesBezierPaths_property, prefs_mergerModelViewDisplayFrontComponentNames_property, prefs_mergerColorFrontComponentNames_property, self.frontComponentValuesBezierPaths_property, prefs_mergerModelViewDisplayFrontComponentValues_property, prefs_mergerColorFrontComponentValues_property, self.backComponentValuesBezierPaths_property, prefs_mergerModelViewDisplayBackComponentValues_property, prefs_mergerColorBackComponentValues_property, self.frontPackagesBezierPaths_property, prefs_mergerModelViewDisplayFrontPackages_property, prefs_mergerColorFrontPackages_property, self.backPackagesBezierPaths_property, prefs_mergerModelViewDisplayBackPackages_property, prefs_mergerColorBackPackages_property, transient_BoardModel_imageForModel)
    self.imageForModel_property.mReadModelFunction = { [weak self] in
      if let unwSelf = self {
        var kind = prefs_mergerColorBackground_property_selection.kind ()
        ...
        kind &= prefs_mergerModelViewDisplayInternalBoardsLimits_property_selection.kind ()
        kind &= prefs_mergerColorInternalBoardsLimits_property_selection.kind ()
        kind &= unwSelf.frontTracksBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayFrontTracks_property_selection.kind ()
        kind &= prefs_mergerColorFrontTracks_property_selection.kind ()
        kind &= unwSelf.backTracksBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayBackTracks_property_selection.kind ()
        kind &= prefs_mergerColorBackTracks_property_selection.kind ()
        kind &= unwSelf.frontPadsBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayFrontPads_property_selection.kind ()
        kind &= prefs_mergerColorFrontPads_property_selection.kind ()
        kind &= unwSelf.backPadsBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayBackPads_property_selection.kind ()
        kind &= prefs_mergerColorBackPads_property_selection.kind ()
        kind &= unwSelf.viasBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayVias_property_selection.kind ()
        kind &= prefs_mergerColorVias_property_selection.kind ()
        kind &= unwSelf.holesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayHoles_property_selection.kind ()
        kind &= prefs_mergerColorHoles_property_selection.kind ()
        kind &= unwSelf.frontLegendLinesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayFrontLegendLines_property_selection.kind ()
        kind &= prefs_mergerColorFrontLegendLines_property_selection.kind ()
        kind &= unwSelf.backLegendLinesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayBackLegendLines_property_selection.kind ()
        kind &= prefs_mergerColorBackLegendLines_property_selection.kind ()
        kind &= unwSelf.frontLegendTextsBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayFrontLegendTexts_property_selection.kind ()
        kind &= prefs_mergerColorFrontLegendTexts_property_selection.kind ()
        kind &= unwSelf.frontLayoutTextsBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayFrontLayoutTexts_property_selection.kind ()
        kind &= prefs_mergerColorFrontLayoutTexts_property_selection.kind ()
        kind &= unwSelf.backLegendTextsBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayBackLegendTexts_property_selection.kind ()
        kind &= prefs_mergerColorBackLegendTexts_property_selection.kind ()
        kind &= unwSelf.backLayoutTextsBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayBackLayoutTexts_property_selection.kind ()
        kind &= prefs_mergerColorBackLayoutTexts_property_selection.kind ()
        kind &= unwSelf.backComponentNamesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayBackComponentNames_property_selection.kind ()
        kind &= prefs_mergerColorBackComponentNames_property_selection.kind ()
        kind &= unwSelf.frontComponentNamesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayFrontComponentNames_property_selection.kind ()
        kind &= prefs_mergerColorFrontComponentNames_property_selection.kind ()
        kind &= unwSelf.frontComponentValuesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayFrontComponentValues_property_selection.kind ()
        kind &= prefs_mergerColorFrontComponentValues_property_selection.kind ()
        kind &= unwSelf.backComponentValuesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayBackComponentValues_property_selection.kind ()
        kind &= prefs_mergerColorBackComponentValues_property_selection.kind ()
        kind &= unwSelf.frontPackagesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayFrontPackages_property_selection.kind ()
        kind &= prefs_mergerColorFrontPackages_property_selection.kind ()
        kind &= unwSelf.backPackagesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerModelViewDisplayBackPackages_property_selection.kind ()
        kind &= prefs_mergerColorBackPackages_property_selection.kind ()
        switch kind {
        case .empty :
          return .empty
        case .multiple :
          return .multiple
        case .single :
          switch (prefs_mergerColorBackground_property_selection, unwSelf.modelWidth_property_selection, unwSelf.modelHeight_property_selection, unwSelf.boardLimitsBezierPaths_property_selection, prefs_mergerModelViewDisplayBoardLimits_property_selection, prefs_mergerColorBoardLimits_property_selection, unwSelf.internalBoardsLimitsBezierPaths_property_selection, prefs_mergerModelViewDisplayInternalBoardsLimits_property_selection, prefs_mergerColorInternalBoardsLimits_property_selection, unwSelf.frontTracksBezierPaths_property_selection, prefs_mergerModelViewDisplayFrontTracks_property_selection, prefs_mergerColorFrontTracks_property_selection, unwSelf.backTracksBezierPaths_property_selection, prefs_mergerModelViewDisplayBackTracks_property_selection, prefs_mergerColorBackTracks_property_selection, unwSelf.frontPadsBezierPaths_property_selection, prefs_mergerModelViewDisplayFrontPads_property_selection, prefs_mergerColorFrontPads_property_selection, unwSelf.backPadsBezierPaths_property_selection, prefs_mergerModelViewDisplayBackPads_property_selection, prefs_mergerColorBackPads_property_selection, unwSelf.viasBezierPaths_property_selection, prefs_mergerModelViewDisplayVias_property_selection, prefs_mergerColorVias_property_selection, unwSelf.holesBezierPaths_property_selection, prefs_mergerModelViewDisplayHoles_property_selection, prefs_mergerColorHoles_property_selection, unwSelf.frontLegendLinesBezierPaths_property_selection, prefs_mergerModelViewDisplayFrontLegendLines_property_selection, prefs_mergerColorFrontLegendLines_property_selection, unwSelf.backLegendLinesBezierPaths_property_selection, prefs_mergerModelViewDisplayBackLegendLines_property_selection, prefs_mergerColorBackLegendLines_property_selection, unwSelf.frontLegendTextsBezierPaths_property_selection, prefs_mergerModelViewDisplayFrontLegendTexts_property_selection, prefs_mergerColorFrontLegendTexts_property_selection, unwSelf.frontLayoutTextsBezierPaths_property_selection, prefs_mergerModelViewDisplayFrontLayoutTexts_property_selection, prefs_mergerColorFrontLayoutTexts_property_selection, unwSelf.backLegendTextsBezierPaths_property_selection, prefs_mergerModelViewDisplayBackLegendTexts_property_selection, prefs_mergerColorBackLegendTexts_property_selection, unwSelf.backLayoutTextsBezierPaths_property_selection, prefs_mergerModelViewDisplayBackLayoutTexts_property_selection, prefs_mergerColorBackLayoutTexts_property_selection, unwSelf.backComponentNamesBezierPaths_property_selection, prefs_mergerModelViewDisplayBackComponentNames_property_selection, prefs_mergerColorBackComponentNames_property_selection, unwSelf.frontComponentNamesBezierPaths_property_selection, prefs_mergerModelViewDisplayFrontComponentNames_property_selection, prefs_mergerColorFrontComponentNames_property_selection, unwSelf.frontComponentValuesBezierPaths_property_selection, prefs_mergerModelViewDisplayFrontComponentValues_property_selection, prefs_mergerColorFrontComponentValues_property_selection, unwSelf.backComponentValuesBezierPaths_property_selection, prefs_mergerModelViewDisplayBackComponentValues_property_selection, prefs_mergerColorBackComponentValues_property_selection, unwSelf.frontPackagesBezierPaths_property_selection, prefs_mergerModelViewDisplayFrontPackages_property_selection, prefs_mergerColorFrontPackages_property_selection, unwSelf.backPackagesBezierPaths_property_selection, prefs_mergerModelViewDisplayBackPackages_property_selection, prefs_mergerColorBackPackages_property_selection) {
    ...
    prefs_mergerColorBackground_property.addEBObserver (self.imageForModel_property)
    ...
    prefs_mergerModelViewDisplayBoardLimits_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorBoardLimits_property.addEBObserver (self.imageForModel_property)
    self.internalBoardsLimitsBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayInternalBoardsLimits_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorInternalBoardsLimits_property.addEBObserver (self.imageForModel_property)
    self.frontTracksBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayFrontTracks_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorFrontTracks_property.addEBObserver (self.imageForModel_property)
    self.backTracksBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayBackTracks_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorBackTracks_property.addEBObserver (self.imageForModel_property)
    self.frontPadsBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayFrontPads_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorFrontPads_property.addEBObserver (self.imageForModel_property)
    self.backPadsBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayBackPads_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorBackPads_property.addEBObserver (self.imageForModel_property)
    self.viasBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayVias_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorVias_property.addEBObserver (self.imageForModel_property)
    self.holesBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayHoles_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorHoles_property.addEBObserver (self.imageForModel_property)
    self.frontLegendLinesBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayFrontLegendLines_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorFrontLegendLines_property.addEBObserver (self.imageForModel_property)
    self.backLegendLinesBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayBackLegendLines_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorBackLegendLines_property.addEBObserver (self.imageForModel_property)
    self.frontLegendTextsBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayFrontLegendTexts_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorFrontLegendTexts_property.addEBObserver (self.imageForModel_property)
    self.frontLayoutTextsBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayFrontLayoutTexts_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorFrontLayoutTexts_property.addEBObserver (self.imageForModel_property)
    self.backLegendTextsBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayBackLegendTexts_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorBackLegendTexts_property.addEBObserver (self.imageForModel_property)
    self.backLayoutTextsBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayBackLayoutTexts_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorBackLayoutTexts_property.addEBObserver (self.imageForModel_property)
    self.backComponentNamesBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayBackComponentNames_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorBackComponentNames_property.addEBObserver (self.imageForModel_property)
    self.frontComponentNamesBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayFrontComponentNames_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorFrontComponentNames_property.addEBObserver (self.imageForModel_property)
    self.frontComponentValuesBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayFrontComponentValues_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorFrontComponentValues_property.addEBObserver (self.imageForModel_property)
    self.backComponentValuesBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayBackComponentValues_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorBackComponentValues_property.addEBObserver (self.imageForModel_property)
    self.frontPackagesBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayFrontPackages_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorFrontPackages_property.addEBObserver (self.imageForModel_property)
    self.backPackagesBezierPaths_property.addEBObserver (self.imageForModel_property)
    prefs_mergerModelViewDisplayBackPackages_property.addEBObserver (self.imageForModel_property)
    prefs_mergerColorBackPackages_property.addEBObserver (self.imageForModel_property)
  //--- Atomic property: imageForInstances
    // self.imageForInstances_property.configure (prefs_mergerColorBackground_property, self.modelWidth_property, self.modelHeight_property, self.frontTracksBezierPaths_property, prefs_mergerBoardViewDisplayFrontTracks_property, prefs_mergerColorFrontTracks_property, self.backTracksBezierPaths_property, prefs_mergerBoardViewDisplayBackTracks_property, prefs_mergerColorBackTracks_property, self.internalBoardsLimitsBezierPaths_property, self.boardLimitsBezierPaths_property, prefs_mergerBoardViewDisplayInternalBoardsLimits_property, prefs_mergerColorInternalBoardsLimits_property, self.frontPadsBezierPaths_property, prefs_mergerBoardViewDisplayFrontPads_property, prefs_mergerColorFrontPads_property, self.backPadsBezierPaths_property, prefs_mergerBoardViewDisplayBackPads_property, prefs_mergerColorBackPads_property, self.viasBezierPaths_property, prefs_mergerBoardViewDisplayVias_property, prefs_mergerColorVias_property, self.holesBezierPaths_property, prefs_mergerBoardViewDisplayHoles_property, prefs_mergerColorHoles_property, self.frontLegendLinesBezierPaths_property, prefs_mergerBoardViewDisplayFrontLegendLines_property, prefs_mergerColorFrontLegendLines_property, self.backLegendLinesBezierPaths_property, prefs_mergerBoardViewDisplayBackLegendLines_property, prefs_mergerColorBackLegendLines_property, self.frontLegendTextsBezierPaths_property, prefs_mergerBoardViewDisplayFrontLegendTexts_property, prefs_mergerColorFrontLegendTexts_property, self.frontLayoutTextsBezierPaths_property, prefs_mergerBoardViewDisplayFrontLayoutTexts_property, prefs_mergerColorFrontLayoutTexts_property, self.backLegendTextsBezierPaths_property, prefs_mergerBoardViewDisplayBackLegendTexts_property, prefs_mergerColorBackLegendTexts_property, self.backLayoutTextsBezierPaths_property, prefs_mergerBoardViewDisplayBackLayoutTexts_property, prefs_mergerColorBackLayoutTexts_property, self.backComponentNamesBezierPaths_property, prefs_mergerBoardViewDisplayBackComponentNames_property, prefs_mergerColorBackComponentNames_property, self.frontComponentNamesBezierPaths_property, prefs_mergerBoardViewDisplayFrontComponentNames_property, prefs_mergerColorFrontComponentNames_property, self.frontComponentValuesBezierPaths_property, prefs_mergerBoardViewDisplayFrontComponentValues_property, prefs_mergerColorFrontComponentValues_property, self.backComponentValuesBezierPaths_property, prefs_mergerBoardViewDisplayBackComponentValues_property, prefs_mergerColorBackComponentValues_property, self.frontPackagesBezierPaths_property, prefs_mergerBoardViewDisplayFrontPackages_property, prefs_mergerColorFrontPackages_property, self.backPackagesBezierPaths_property, prefs_mergerBoardViewDisplayBackPackages_property, prefs_mergerColorBackPackages_property, transient_BoardModel_imageForInstances)
    self.imageForInstances_property.mReadModelFunction = { [weak self] in
      if let unwSelf = self {
        ...
        kind &= unwSelf.modelHeight_property_selection.kind ()
        kind &= unwSelf.frontTracksBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayFrontTracks_property_selection.kind ()
        kind &= prefs_mergerColorFrontTracks_property_selection.kind ()
        kind &= unwSelf.backTracksBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayBackTracks_property_selection.kind ()
        kind &= prefs_mergerColorBackTracks_property_selection.kind ()
        kind &= unwSelf.internalBoardsLimitsBezierPaths_property_selection.kind ()
        kind &= unwSelf.boardLimitsBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayInternalBoardsLimits_property_selection.kind ()
        kind &= prefs_mergerColorInternalBoardsLimits_property_selection.kind ()
        kind &= unwSelf.frontPadsBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayFrontPads_property_selection.kind ()
        kind &= prefs_mergerColorFrontPads_property_selection.kind ()
        kind &= unwSelf.backPadsBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayBackPads_property_selection.kind ()
        kind &= prefs_mergerColorBackPads_property_selection.kind ()
        kind &= unwSelf.viasBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayVias_property_selection.kind ()
        kind &= prefs_mergerColorVias_property_selection.kind ()
        kind &= unwSelf.holesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayHoles_property_selection.kind ()
        kind &= prefs_mergerColorHoles_property_selection.kind ()
        kind &= unwSelf.frontLegendLinesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayFrontLegendLines_property_selection.kind ()
        kind &= prefs_mergerColorFrontLegendLines_property_selection.kind ()
        kind &= unwSelf.backLegendLinesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayBackLegendLines_property_selection.kind ()
        kind &= prefs_mergerColorBackLegendLines_property_selection.kind ()
        kind &= unwSelf.frontLegendTextsBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayFrontLegendTexts_property_selection.kind ()
        kind &= prefs_mergerColorFrontLegendTexts_property_selection.kind ()
        kind &= unwSelf.frontLayoutTextsBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayFrontLayoutTexts_property_selection.kind ()
        kind &= prefs_mergerColorFrontLayoutTexts_property_selection.kind ()
        kind &= unwSelf.backLegendTextsBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayBackLegendTexts_property_selection.kind ()
        kind &= prefs_mergerColorBackLegendTexts_property_selection.kind ()
        kind &= unwSelf.backLayoutTextsBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayBackLayoutTexts_property_selection.kind ()
        kind &= prefs_mergerColorBackLayoutTexts_property_selection.kind ()
        kind &= unwSelf.backComponentNamesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayBackComponentNames_property_selection.kind ()
        kind &= prefs_mergerColorBackComponentNames_property_selection.kind ()
        kind &= unwSelf.frontComponentNamesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayFrontComponentNames_property_selection.kind ()
        kind &= prefs_mergerColorFrontComponentNames_property_selection.kind ()
        kind &= unwSelf.frontComponentValuesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayFrontComponentValues_property_selection.kind ()
        kind &= prefs_mergerColorFrontComponentValues_property_selection.kind ()
        kind &= unwSelf.backComponentValuesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayBackComponentValues_property_selection.kind ()
        kind &= prefs_mergerColorBackComponentValues_property_selection.kind ()
        kind &= unwSelf.frontPackagesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayFrontPackages_property_selection.kind ()
        kind &= prefs_mergerColorFrontPackages_property_selection.kind ()
        kind &= unwSelf.backPackagesBezierPaths_property_selection.kind ()
        kind &= prefs_mergerBoardViewDisplayBackPackages_property_selection.kind ()
        kind &= prefs_mergerColorBackPackages_property_selection.kind ()
        switch kind {
        case .empty :
          return .empty
        case .multiple :
          return .multiple
        case .single :
          switch (prefs_mergerColorBackground_property_selection, unwSelf.modelWidth_property_selection, unwSelf.modelHeight_property_selection, unwSelf.frontTracksBezierPaths_property_selection, prefs_mergerBoardViewDisplayFrontTracks_property_selection, prefs_mergerColorFrontTracks_property_selection, unwSelf.backTracksBezierPaths_property_selection, prefs_mergerBoardViewDisplayBackTracks_property_selection, prefs_mergerColorBackTracks_property_selection, unwSelf.internalBoardsLimitsBezierPaths_property_selection, unwSelf.boardLimitsBezierPaths_property_selection, prefs_mergerBoardViewDisplayInternalBoardsLimits_property_selection, prefs_mergerColorInternalBoardsLimits_property_selection, unwSelf.frontPadsBezierPaths_property_selection, prefs_mergerBoardViewDisplayFrontPads_property_selection, prefs_mergerColorFrontPads_property_selection, unwSelf.backPadsBezierPaths_property_selection, prefs_mergerBoardViewDisplayBackPads_property_selection, prefs_mergerColorBackPads_property_selection, unwSelf.viasBezierPaths_property_selection, prefs_mergerBoardViewDisplayVias_property_selection, prefs_mergerColorVias_property_selection, unwSelf.holesBezierPaths_property_selection, prefs_mergerBoardViewDisplayHoles_property_selection, prefs_mergerColorHoles_property_selection, unwSelf.frontLegendLinesBezierPaths_property_selection, prefs_mergerBoardViewDisplayFrontLegendLines_property_selection, prefs_mergerColorFrontLegendLines_property_selection, unwSelf.backLegendLinesBezierPaths_property_selection, prefs_mergerBoardViewDisplayBackLegendLines_property_selection, prefs_mergerColorBackLegendLines_property_selection, unwSelf.frontLegendTextsBezierPaths_property_selection, prefs_mergerBoardViewDisplayFrontLegendTexts_property_selection, prefs_mergerColorFrontLegendTexts_property_selection, unwSelf.frontLayoutTextsBezierPaths_property_selection, prefs_mergerBoardViewDisplayFrontLayoutTexts_property_selection, prefs_mergerColorFrontLayoutTexts_property_selection, unwSelf.backLegendTextsBezierPaths_property_selection, prefs_mergerBoardViewDisplayBackLegendTexts_property_selection, prefs_mergerColorBackLegendTexts_property_selection, unwSelf.backLayoutTextsBezierPaths_property_selection, prefs_mergerBoardViewDisplayBackLayoutTexts_property_selection, prefs_mergerColorBackLayoutTexts_property_selection, unwSelf.backComponentNamesBezierPaths_property_selection, prefs_mergerBoardViewDisplayBackComponentNames_property_selection, prefs_mergerColorBackComponentNames_property_selection, unwSelf.frontComponentNamesBezierPaths_property_selection, prefs_mergerBoardViewDisplayFrontComponentNames_property_selection, prefs_mergerColorFrontComponentNames_property_selection, unwSelf.frontComponentValuesBezierPaths_property_selection, prefs_mergerBoardViewDisplayFrontComponentValues_property_selection, prefs_mergerColorFrontComponentValues_property_selection, unwSelf.backComponentValuesBezierPaths_property_selection, prefs_mergerBoardViewDisplayBackComponentValues_property_selection, prefs_mergerColorBackComponentValues_property_selection, unwSelf.frontPackagesBezierPaths_property_selection, prefs_mergerBoardViewDisplayFrontPackages_property_selection, prefs_mergerColorFrontPackages_property_selection, unwSelf.backPackagesBezierPaths_property_selection, prefs_mergerBoardViewDisplayBackPackages_property_selection, prefs_mergerColorBackPackages_property_selection) {
    ...
    prefs_mergerColorBackground_property.addEBObserver (self.imageForInstances_property)
    ...
    prefs_mergerBoardViewDisplayFrontTracks_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorFrontTracks_property.addEBObserver (self.imageForInstances_property)
    self.backTracksBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayBackTracks_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorBackTracks_property.addEBObserver (self.imageForInstances_property)
    ...
    prefs_mergerBoardViewDisplayInternalBoardsLimits_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorInternalBoardsLimits_property.addEBObserver (self.imageForInstances_property)
    self.frontPadsBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayFrontPads_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorFrontPads_property.addEBObserver (self.imageForInstances_property)
    self.backPadsBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayBackPads_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorBackPads_property.addEBObserver (self.imageForInstances_property)
    self.viasBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayVias_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorVias_property.addEBObserver (self.imageForInstances_property)
    self.holesBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayHoles_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorHoles_property.addEBObserver (self.imageForInstances_property)
    self.frontLegendLinesBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayFrontLegendLines_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorFrontLegendLines_property.addEBObserver (self.imageForInstances_property)
    self.backLegendLinesBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayBackLegendLines_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorBackLegendLines_property.addEBObserver (self.imageForInstances_property)
    self.frontLegendTextsBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayFrontLegendTexts_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorFrontLegendTexts_property.addEBObserver (self.imageForInstances_property)
    self.frontLayoutTextsBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayFrontLayoutTexts_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorFrontLayoutTexts_property.addEBObserver (self.imageForInstances_property)
    self.backLegendTextsBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayBackLegendTexts_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorBackLegendTexts_property.addEBObserver (self.imageForInstances_property)
    self.backLayoutTextsBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayBackLayoutTexts_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorBackLayoutTexts_property.addEBObserver (self.imageForInstances_property)
    self.backComponentNamesBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayBackComponentNames_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorBackComponentNames_property.addEBObserver (self.imageForInstances_property)
    self.frontComponentNamesBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayFrontComponentNames_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorFrontComponentNames_property.addEBObserver (self.imageForInstances_property)
    self.frontComponentValuesBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayFrontComponentValues_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorFrontComponentValues_property.addEBObserver (self.imageForInstances_property)
    self.backComponentValuesBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayBackComponentValues_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorBackComponentValues_property.addEBObserver (self.imageForInstances_property)
    self.frontPackagesBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayFrontPackages_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorFrontPackages_property.addEBObserver (self.imageForInstances_property)
    self.backPackagesBezierPaths_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerBoardViewDisplayBackPackages_property.addEBObserver (self.imageForInstances_property)
    prefs_mergerColorBackPackages_property.addEBObserver (self.imageForInstances_property)
  ...
  override internal func removeAllObservers () {
    ...
    // prefs_mergerModelViewDisplayBoardLimits_property.removeEBObserver (self.boardLimits_property)
    ...
    // prefs_mergerColorBackground_property.removeEBObserver (self.imageForModel_property)
    ...
    // prefs_mergerModelViewDisplayBoardLimits_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorBoardLimits_property.removeEBObserver (self.imageForModel_property)
    // self.internalBoardsLimitsBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayInternalBoardsLimits_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorInternalBoardsLimits_property.removeEBObserver (self.imageForModel_property)
    // self.frontTracksBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayFrontTracks_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorFrontTracks_property.removeEBObserver (self.imageForModel_property)
    // self.backTracksBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayBackTracks_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorBackTracks_property.removeEBObserver (self.imageForModel_property)
    // self.frontPadsBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayFrontPads_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorFrontPads_property.removeEBObserver (self.imageForModel_property)
    // self.backPadsBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayBackPads_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorBackPads_property.removeEBObserver (self.imageForModel_property)
    // self.viasBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayVias_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorVias_property.removeEBObserver (self.imageForModel_property)
    // self.holesBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayHoles_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorHoles_property.removeEBObserver (self.imageForModel_property)
    // self.frontLegendLinesBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayFrontLegendLines_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorFrontLegendLines_property.removeEBObserver (self.imageForModel_property)
    // self.backLegendLinesBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayBackLegendLines_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorBackLegendLines_property.removeEBObserver (self.imageForModel_property)
    // self.frontLegendTextsBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayFrontLegendTexts_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorFrontLegendTexts_property.removeEBObserver (self.imageForModel_property)
    // self.frontLayoutTextsBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayFrontLayoutTexts_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorFrontLayoutTexts_property.removeEBObserver (self.imageForModel_property)
    // self.backLegendTextsBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayBackLegendTexts_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorBackLegendTexts_property.removeEBObserver (self.imageForModel_property)
    // self.backLayoutTextsBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayBackLayoutTexts_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorBackLayoutTexts_property.removeEBObserver (self.imageForModel_property)
    // self.backComponentNamesBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayBackComponentNames_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorBackComponentNames_property.removeEBObserver (self.imageForModel_property)
    // self.frontComponentNamesBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayFrontComponentNames_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorFrontComponentNames_property.removeEBObserver (self.imageForModel_property)
    // self.frontComponentValuesBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayFrontComponentValues_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorFrontComponentValues_property.removeEBObserver (self.imageForModel_property)
    // self.backComponentValuesBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayBackComponentValues_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorBackComponentValues_property.removeEBObserver (self.imageForModel_property)
    // self.frontPackagesBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayFrontPackages_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorFrontPackages_property.removeEBObserver (self.imageForModel_property)
    // self.backPackagesBezierPaths_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerModelViewDisplayBackPackages_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorBackPackages_property.removeEBObserver (self.imageForModel_property)
    // prefs_mergerColorBackground_property.removeEBObserver (self.imageForInstances_property)
    ...
    // prefs_mergerBoardViewDisplayFrontTracks_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorFrontTracks_property.removeEBObserver (self.imageForInstances_property)
    // self.backTracksBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayBackTracks_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorBackTracks_property.removeEBObserver (self.imageForInstances_property)
    ...
    // prefs_mergerBoardViewDisplayInternalBoardsLimits_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorInternalBoardsLimits_property.removeEBObserver (self.imageForInstances_property)
    // self.frontPadsBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayFrontPads_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorFrontPads_property.removeEBObserver (self.imageForInstances_property)
    // self.backPadsBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayBackPads_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorBackPads_property.removeEBObserver (self.imageForInstances_property)
    // self.viasBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayVias_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorVias_property.removeEBObserver (self.imageForInstances_property)
    // self.holesBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayHoles_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorHoles_property.removeEBObserver (self.imageForInstances_property)
    // self.frontLegendLinesBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayFrontLegendLines_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorFrontLegendLines_property.removeEBObserver (self.imageForInstances_property)
    // self.backLegendLinesBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayBackLegendLines_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorBackLegendLines_property.removeEBObserver (self.imageForInstances_property)
    // self.frontLegendTextsBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayFrontLegendTexts_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorFrontLegendTexts_property.removeEBObserver (self.imageForInstances_property)
    // self.frontLayoutTextsBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayFrontLayoutTexts_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorFrontLayoutTexts_property.removeEBObserver (self.imageForInstances_property)
    // self.backLegendTextsBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayBackLegendTexts_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorBackLegendTexts_property.removeEBObserver (self.imageForInstances_property)
    // self.backLayoutTextsBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayBackLayoutTexts_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorBackLayoutTexts_property.removeEBObserver (self.imageForInstances_property)
    // self.backComponentNamesBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayBackComponentNames_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorBackComponentNames_property.removeEBObserver (self.imageForInstances_property)
    // self.frontComponentNamesBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayFrontComponentNames_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorFrontComponentNames_property.removeEBObserver (self.imageForInstances_property)
    // self.frontComponentValuesBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayFrontComponentValues_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorFrontComponentValues_property.removeEBObserver (self.imageForInstances_property)
    // self.backComponentValuesBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayBackComponentValues_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorBackComponentValues_property.removeEBObserver (self.imageForInstances_property)
    // self.frontPackagesBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayFrontPackages_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorFrontPackages_property.removeEBObserver (self.imageForInstances_property)
    // self.backPackagesBezierPaths_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerBoardViewDisplayBackPackages_property.removeEBObserver (self.imageForInstances_property)
    // prefs_mergerColorBackPackages_property.removeEBObserver (self.imageForInstances_property)
