...
final class RectangleEntity : EBManagedObject,
  ...
  final func reset_p0y_toDefaultValue () {
    self.p0y = 0
  }
  ...
  final func reset_p1x_toDefaultValue () {
    self.p1x = 0
  }
  ...
  final func reset_p1y_toDefaultValue () {
    self.p1y = 0
  }
  ...
  final func reset_p2x_toDefaultValue () {
    self.p2x = 0
  }
  ...
  final func reset_p2y_toDefaultValue () {
    self.p2y = 0
  }
  ...
  final func reset_p3x_toDefaultValue () {
    self.p3x = 0
  }
  ...
  final func reset_p3y_toDefaultValue () {
    self.p3y = 0
  }
  ...
  final func reset_p0x_toDefaultValue () {
    self.p0x = 0
  }
