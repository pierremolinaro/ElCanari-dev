//
//  extension-AutoLayoutMergerDocument-file-system-observing.swift
//  ElCanari
//
//  Created by Pierre Molinaro on 25/10/2024.
//
//--------------------------------------------------------------------------------------------------
...
extension AutoLayoutMergerDocument {
  ...
  func triggerStandAlonePropertyComputationForMerger () {
