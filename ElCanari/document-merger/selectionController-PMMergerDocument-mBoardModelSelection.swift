...
final class SelectionController_PMMergerDocument_mBoardModelSelection : EBObject {
  ...
  var displayBackPads = EBPropertyProxy_Bool () 
  ...
  var displayVias = EBPropertyProxy_Bool () 
  ...
  func bind_selection (model : ReadOnlyArrayOf_BoardModelEntity, file:String, line:Int) {
    ...
    bind_property_displayBackPads (model: model)
    ...
    bind_property_displayVias (model: model)
  ...
  private final func bind_property_displayBackPads (model : ReadOnlyArrayOf_BoardModelEntity) {
    model.addEBObserverOf_displayBackPads (self.displayBackPads)
    self.displayBackPads.readModelFunction = {
      if let model = self.mModel {
        switch model.prop {
        case .noSelection :
          return .noSelection
        ...
        case .singleSelection (let v) :
          ...
          var isMultipleSelection = false
          for object in v {
            switch object.displayBackPads.prop {
            case .noSelection :
              return .noSelection
            case .multipleSelection :
              isMultipleSelection = true
    ...
    self.displayBackPads.writeModelFunction = { (inValue : Bool) in
      if let model = self.mModel {
        switch model.prop {
        case .noSelection, .multipleSelection :
          break
        case .singleSelection (let v) :
          for object in v {
            object.displayBackPads.setProp (inValue)
          }
        }
      }
    }
    self.displayBackPads.validateAndWriteModelFunction = { (candidateValue : Bool, windowForSheet : NSWindow?) in
      if let model = self.mModel {
        switch model.prop {
        case .noSelection, .multipleSelection :
          return false
        case .singleSelection (let v) :
          for object in v {
            let result = object.displayBackPads.validateAndSetProp (candidateValue, windowForSheet:windowForSheet)
            if !result {
              return false
            }
          }
  ...
  private final func bind_property_displayVias (model : ReadOnlyArrayOf_BoardModelEntity) {
    model.addEBObserverOf_displayVias (self.displayVias)
    self.displayVias.readModelFunction = {
      if let model = self.mModel {
        switch model.prop {
        case .noSelection :
          return .noSelection
        ...
        case .singleSelection (let v) :
          ...
          var isMultipleSelection = false
          for object in v {
            switch object.displayVias.prop {
            case .noSelection :
              return .noSelection
            case .multipleSelection :
              isMultipleSelection = true
    ...
    self.displayVias.writeModelFunction = { (inValue : Bool) in
      if let model = self.mModel {
        switch model.prop {
        case .noSelection, .multipleSelection :
          break
        case .singleSelection (let v) :
          for object in v {
            object.displayVias.setProp (inValue)
          }
        }
      }
    }
    self.displayVias.validateAndWriteModelFunction = { (candidateValue : Bool, windowForSheet : NSWindow?) in
      if let model = self.mModel {
        switch model.prop {
        case .noSelection, .multipleSelection :
          return false
        case .singleSelection (let v) :
          for object in v {
            let result = object.displayVias.validateAndSetProp (candidateValue, windowForSheet:windowForSheet)
            if !result {
              return false
            }
          }
  ...
  //--- displayBackPads
    self.displayBackPads.readModelFunction = nil 
    self.displayBackPads.writeModelFunction = nil 
    self.displayBackPads.validateAndWriteModelFunction = nil 
    mModel?.removeEBObserverOf_displayBackPads (self.displayBackPads)
  //--- displayBackTracks
  ...
  //--- displayVias
    self.displayVias.readModelFunction = nil 
    self.displayVias.writeModelFunction = nil 
    self.displayVias.validateAndWriteModelFunction = nil 
    mModel?.removeEBObserverOf_displayVias (self.displayVias)
