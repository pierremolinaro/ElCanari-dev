...
class StoredArrayOf_BoardModelPad : StandAloneArrayOf_BoardModelPad, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
