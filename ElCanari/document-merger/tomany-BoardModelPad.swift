...
class ReadOnlyArrayOf_BoardModelPad : EBReadOnlyAbstractArrayProperty <BoardModelPad> {
  ...
  final func toMany_shape_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_shape_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
