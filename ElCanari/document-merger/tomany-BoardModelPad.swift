...
class ReadOnlyArrayOf_BoardModelPad : ReadOnlyAbstractArrayProperty <BoardModelPad> {
  ...
  final func addEBObserversOf_shape_toElementsOfSet (_ inSet : EBReferenceSet <BoardModelPad>) {
    if !self.mObserversOf_shape.isEmpty {
      for managedObject in inSet.values {
        self.mObserversOf_shape.apply { (_ observer : EBObserverProtocol) in
  ...
  final func addEBObserversOf_rotation_toElementsOfSet (_ inSet : EBReferenceSet <BoardModelPad>) {
    if !self.mObserversOf_rotation.isEmpty {
      for managedObject in inSet.values {
        self.mObserversOf_rotation.apply { (_ observer : EBObserverProtocol) in
...
final class TransientArrayOf_BoardModelPad : ReadOnlyArrayOf_BoardModelPad {
  ...
  private final func computeModelArray () {
    if self.mModelArrayShouldBeComputed {
      ...
      let newArray : EBReferenceArray <BoardModelPad>
  ...
  override var propval : EBReferenceArray <BoardModelPad> {
    self.computeModelArray ()
...
final class TransientArrayOfSuperOf_BoardModelPad <SUPER : EBManagedObject> : ReadOnlyArrayOf_BoardModelPad {
  ...
  private final func computeModelArray () {
    if self.mModelArrayShouldBeComputed {
      ...
      var newArray = EBReferenceArray <BoardModelPad> ()
...
final class ProxyArrayOf_BoardModelPad : ReadWriteArrayOf_BoardModelPad {
  ...
  override func notifyModelDidChange () {
    let newModelArray : EBReferenceArray <BoardModelPad>
    if let model = self.mModel {
      switch model.selection {
      case .empty :
        newModelArray = EBReferenceArray ()
      case .single (let v) :
        newModelArray = EBReferenceArray <BoardModelPad> (v)
      case .multiple :
        newModelArray = EBReferenceArray ()
      }
    }else{
  ...
  override func setProp (_ inArrayValue : EBReferenceArray <BoardModelPad>) {
...
final class StandAloneArrayOf_BoardModelPad : ReadWriteArrayOf_BoardModelPad {
  ...
  override var selection : EBSelection < [BoardModelPad] > { return .single (self.mInternalArrayValue.values) }
  ...
  override var propval : EBReferenceArray <BoardModelPad> { return self.mInternalArrayValue }
