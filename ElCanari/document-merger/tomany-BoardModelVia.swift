...
//    self.undoManager?.registerUndo < EBReferenceArray <BoardModelVia> > (withTarget: self) {
...
//    }
  ...
  final override var propval : EBReferenceArray <BoardModelVia> { return self.mInternalArrayValue }
