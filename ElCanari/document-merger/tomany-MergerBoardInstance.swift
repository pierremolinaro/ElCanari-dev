...
class ReadOnlyArrayOf_MergerBoardInstance : EBReadOnlyAbstractArrayProperty <MergerBoardInstance> {
  ...
  final func toMany_instanceRotation_StartsBeingObserved (by inObserver : any EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_instanceRotation_StopsBeingObserved (by inObserver : any EBObserverProtocol) {
  ...
  final func toMany_instanceRect_StartsBeingObserved (by inObserver : any EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_instanceRect_StopsBeingObserved (by inObserver : any EBObserverProtocol) {
  ...
  final func toMany_modelName_StartsBeingObserved (by inObserver : any EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_modelName_StopsBeingObserved (by inObserver : any EBObserverProtocol) {
  ...
  final func toMany_boardLimitWidth_StartsBeingObserved (by inObserver : any EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_boardLimitWidth_StopsBeingObserved (by inObserver : any EBObserverProtocol) {
...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: MergerBoardInstance
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_MergerBoardInstance : ReadWriteArrayOf_MergerBoardInstance { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
...
/*  private final class MyPrivateUndoer : NSObject { // For Swift 6
    let mOldValue : EBReferenceArray <MergerBoardInstance>

    init (_ inOldValue : EBReferenceArray <MergerBoardInstance>) {
...
//  }
  ...
  override final var selection : EBSelection < [MergerBoardInstance] > {
    return .single (self.mInternalArrayValue.values)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  override func setProp (_ inValue : EBReferenceArray <MergerBoardInstance>) {
    self.mInternalArrayValue = inValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override var propval : EBReferenceArray <MergerBoardInstance> {
    return self.mInternalArrayValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final func remove (_ inObject : MergerBoardInstance) {
  ...
  final func add (_ inObject : MergerBoardInstance) {
...
class StoredArrayOf_MergerBoardInstance : StandAloneArrayOf_MergerBoardInstance, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
