...
class ReadOnlyArrayOf_MergerBoardInstance : EBReadOnlyAbstractArrayProperty <MergerBoardInstance> {
  ...
  final func toMany_instanceRotation_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_instanceRotation_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_instanceRect_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_instanceRect_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_modelName_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
