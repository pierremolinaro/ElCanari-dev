...
@MainActor func transient_BoardModel_backComponentNameSegments (
       _ self_backComponentNames_x1 : [any SegmentEntity_x1],   
       _ self_backComponentNames_y1 : [any SegmentEntity_y1],   
       _ self_backComponentNames_x2 : [any SegmentEntity_x2],   
       _ self_backComponentNames_y2 : [any SegmentEntity_y2],   
       _ self_backComponentNames_width : [any SegmentEntity_width]
) -> MergerSegmentArray {
