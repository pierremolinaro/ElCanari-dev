...
@MainActor func transient_BoardModel_backLayoutTextsSegments (
       _ self_backLayoutTexts_x1 : [any SegmentEntity_x1],    
       _ self_backLayoutTexts_y1 : [any SegmentEntity_y1],    
       _ self_backLayoutTexts_x2 : [any SegmentEntity_x2],    
       _ self_backLayoutTexts_y2 : [any SegmentEntity_y2],    
       _ self_backLayoutTexts_width : [any SegmentEntity_width]
) -> MergerSegmentArray {
