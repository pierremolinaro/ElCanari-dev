...
//--- START OF USER ZONE 2
        ...
        var idx = 0
        while idx < self_legendBackImages_p0x.count {
          let p0 = CanariPoint (x: self_legendBackImages_p0x [idx].p0x, y: self_legendBackImages_p0y [idx].p0y).cocoaPoint
          let p1 = CanariPoint (x: self_legendBackImages_p1x [idx].p1x, y: self_legendBackImages_p1y [idx].p1y).cocoaPoint
          let p2 = CanariPoint (x: self_legendBackImages_p2x [idx].p2x, y: self_legendBackImages_p2y [idx].p2y).cocoaPoint
          let p3 = CanariPoint (x: self_legendBackImages_p3x [idx].p3x, y: self_legendBackImages_p3y [idx].p3y).cocoaPoint
