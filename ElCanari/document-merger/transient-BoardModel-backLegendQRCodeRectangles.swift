...
@MainActor func transient_BoardModel_backLegendQRCodeRectangles (
       _ self_legendBackQRCodes_p0x : [any RectangleEntity_p0x], 
       _ self_legendBackQRCodes_p0y : [any RectangleEntity_p0y], 
       _ self_legendBackQRCodes_p1x : [any RectangleEntity_p1x], 
       _ self_legendBackQRCodes_p1y : [any RectangleEntity_p1y], 
       _ self_legendBackQRCodes_p2x : [any RectangleEntity_p2x], 
       _ self_legendBackQRCodes_p2y : [any RectangleEntity_p2y], 
       _ self_legendBackQRCodes_p3x : [any RectangleEntity_p3x], 
       _ self_legendBackQRCodes_p3y : [any RectangleEntity_p3y]
