...
//--- START OF USER ZONE 2
  ...
  var idx = 0
  while idx < self_backTracksNoSilkScreen_x1.count {
    let x1 = self_backTracksNoSilkScreen_x1 [idx].x1
    let y1 = self_backTracksNoSilkScreen_y1 [idx].y1
    let x2 = self_backTracksNoSilkScreen_x2 [idx].x2
    let y2 = self_backTracksNoSilkScreen_y2 [idx].y2
    let width = self_backTracksNoSilkScreen_width [idx].width
    let endStyle = self_backTracksNoSilkScreen_endStyle [idx].endStyle
