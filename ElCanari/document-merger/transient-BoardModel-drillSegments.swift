...
@MainActor func transient_BoardModel_drillSegments (
       _ self_drills_x1 : [any SegmentEntity_x1],   
       _ self_drills_y1 : [any SegmentEntity_y1],   
       _ self_drills_x2 : [any SegmentEntity_x2],   
       _ self_drills_y2 : [any SegmentEntity_y2],   
       _ self_drills_width : [any SegmentEntity_width]
) -> MergerSegmentArray {
