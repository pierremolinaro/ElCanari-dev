...
@MainActor func transient_BoardModel_frontLegendTextsSegments (
       _ self_frontLegendTexts_x1 : [any SegmentEntity_x1],    
       _ self_frontLegendTexts_y1 : [any SegmentEntity_y1],    
       _ self_frontLegendTexts_x2 : [any SegmentEntity_x2],    
       _ self_frontLegendTexts_y2 : [any SegmentEntity_y2],    
       _ self_frontLegendTexts_width : [any SegmentEntity_width]
) -> MergerSegmentArray {
