...
func compute_BoardModelEntity_backComponentNameSegments (
       _ self_backComponentNames_x1 : [CanariSegmentEntity_x1],
       _ self_backComponentNames_y1 : [CanariSegmentEntity_y1],
       _ self_backComponentNames_x2 : [CanariSegmentEntity_x2],
       _ self_backComponentNames_y2 : [CanariSegmentEntity_y2],
       _ self_backComponentNames_width : [CanariSegmentEntity_width]
) -> MergerSegmentArray {
