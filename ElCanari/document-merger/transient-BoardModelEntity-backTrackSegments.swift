...
func compute_BoardModelEntity_backTrackSegments (
       _ self_backTracks_x1 : [CanariSegmentEntity_x1],
       _ self_backTracks_y1 : [CanariSegmentEntity_y1],
       _ self_backTracks_x2 : [CanariSegmentEntity_x2],
       _ self_backTracks_y2 : [CanariSegmentEntity_y2],
       _ self_backTracks_width : [CanariSegmentEntity_width]
) -> MergerSegmentArray {
