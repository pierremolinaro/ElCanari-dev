...
@objc(PackageDocument) class PackageDocument : EBManagedXibDocument {
  ...
  //--------------------------- Install regular bindings
    ...
    self.mComposedPackageView?.bind_gridLineColor (prefs_lineColorOfPackageGrid_property)
    self.mComposedPackageView?.bind_gridCrossColor (prefs_crossColorOfPackageGrid_property)
    self.mComposedPackageView?.bind_zoom (self.rootObject.zoom_property)
    self.mComposedPackageView?.bind_backColor (prefs_packageBackgroundColor_property)
    ...
    self.mShowPadNumberSwitch?.bind_value (prefs_showPadNumber_property)
    ...
    self.mCrossColorOfPackageGridColorWell?.bind_color (prefs_crossColorOfPackageGrid_property, sendContinously:false)
    self.mLineColorOfPackageGridColorWell?.bind_color (prefs_lineColorOfPackageGrid_property, sendContinously:false)
    self.mPackageColorColorWell?.bind_color (prefs_packageColor_property, sendContinously:false)
    self.mTopSidePadColorWell?.bind_color (prefs_frontSidePadColor_property, sendContinously:false)
    self.mBottomSidePadColorWell?.bind_color (prefs_backSidePadColor_property, sendContinously:false)
    self.mPackageBackgroundColorColorWell?.bind_color (prefs_packageBackgroundColor_property, sendContinously:false)
    self.mPackageDrawingWidthMultipliedByTenPopupButton?.bind_selectedTag (prefs_packageDrawingWidthMultipliedByTen_property)
    self.mPadNumberColorWell?.bind_color (prefs_padNumberColor_property, sendContinously:false)
    self.mDisplayTopSidePadSwitch?.bind_value (prefs_displayPackageFrontSidePads_property)
    self.mDisplayBottomSidePadSwitch?.bind_value (prefs_displayPackageBackSidePads_property)
    self.mPadNumberFontButton?.bind_fontValue (prefs_padNumberFont_property)
    ...
    self.mModelImageView?.bind_gridLineColor (prefs_lineColorOfPackageGrid_property)
    self.mModelImageView?.bind_gridCrossColor (prefs_crossColorOfPackageGrid_property)
    self.mModelImageView?.bind_zoom (self.rootObject.mModelImagePageZoom_property)
    self.mModelImageView?.bind_backColor (prefs_packageBackgroundColor_property)
