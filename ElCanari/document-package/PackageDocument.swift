...
@objc(PackageDocument) class PackageDocument : EBManagedXibDocument {
  ...
  @IBOutlet final var mAddArcButton : CanariDragSourceButton? = nil
  @IBOutlet final var mAddBezierButton : CanariDragSourceButton? = nil
  @IBOutlet final var mAddDimensionButton : CanariDragSourceButton? = nil
  @IBOutlet final var mAddGuideButton : CanariDragSourceButton? = nil
  @IBOutlet final var mAddOvalButton : CanariDragSourceButton? = nil
  @IBOutlet final var mAddPadButton : CanariDragSourceButton? = nil
  @IBOutlet final var mAddSegmentButton : CanariDragSourceButton? = nil
  @IBOutlet final var mAddSlavePadButton : CanariDragSourceButton? = nil
  @IBOutlet final var mAddZoneButton : CanariDragSourceButton? = nil
  ...
  @IBOutlet final var mBaseInspectorView : NSView? = nil
  ...
  @IBOutlet final var mBottomSidePadColorWell : EBColorWell? = nil
  @IBOutlet final var mClearProgramErrorButton : EBButton? = nil
  @IBOutlet final var mCommentTextView : EBTextView? = nil
  @IBOutlet final var mComposedPackageView : EBEnclosingGraphicView? = nil
  @IBOutlet final var mCounterClockNumberingStartAngleIntField : EBIntField? = nil
  @IBOutlet final var mCounterClockNumberingStartAngleView : NSView? = nil
  @IBOutlet final var mCrossColorOfPackageGridColorWell : EBColorWell? = nil
  ...
  @IBOutlet final var mDisplayBottomSidePadSwitch : EBSwitch? = nil
  ...
  @IBOutlet final var mGridUnitPopUp : EBPopUpButton? = nil
  @IBOutlet final var mGridZoomInspectorView : CanariViewWithKeyView? = nil
  ...
  @IBOutlet final var mIssueInspectorView : CanariViewWithKeyView? = nil
  ...
  @IBOutlet final var mIssuesInspectorView : CanariViewWithKeyView? = nil
  @IBOutlet final var mKnobSizeSlider : EBSlider? = nil
  @IBOutlet final var mLineColorOfPackageGridColorWell : EBColorWell? = nil
  @IBOutlet final var mLoadDIL16ModelImageFromResourcesdMenuItem : EBMenuItem? = nil
  @IBOutlet final var mLoadFromDesignButton : EBButton? = nil
  @IBOutlet final var mLoadModelImageFromPasteboardMenuItem : EBMenuItem? = nil
  @IBOutlet final var mLockImagePointsButton : EBButton? = nil
  @IBOutlet final var mLockImageView : EBImageObserverView? = nil
  @IBOutlet final var mMasterView : NSView? = nil
  @IBOutlet final var mModelImageFirstPointXDimensionUnitPopUp : EBPopUpButton? = nil
  @IBOutlet final var mModelImageFirstPointXTextField : CanariDimensionTextField? = nil
  @IBOutlet final var mModelImageFirstPointYDimensionUnitPopUp : EBPopUpButton? = nil
  @IBOutlet final var mModelImageFirstPointYTextField : CanariDimensionTextField? = nil
  @IBOutlet final var mModelImageOpacitySlider : EBSlider? = nil
  @IBOutlet final var mModelImagePageGridDisplayPopUpButton : EBPopUpButton? = nil
  @IBOutlet final var mModelImagePageGridStyle : EBPopUpButton? = nil
  @IBOutlet final var mModelImagePageGridTextField : CanariDimensionTextField? = nil
  @IBOutlet final var mModelImagePageGridUnitPopUp : EBPopUpButton? = nil
  @IBOutlet final var mModelImagePageHorizontalFlip : EBSwitch? = nil
  @IBOutlet final var mModelImagePageVerticalFlip : EBSwitch? = nil
  @IBOutlet final var mModelImagePageView : CanariViewWithKeyView? = nil
  @IBOutlet final var mModelImagePageXPlacardUnitPopUpButton : EBPopUpButton? = nil
  @IBOutlet final var mModelImagePageYPlacardUnitPopUpButton : EBPopUpButton? = nil
  @IBOutlet final var mModelImagePointDxTextField : CanariDimensionTextField? = nil
  @IBOutlet final var mModelImagePointDyTextField : CanariDimensionTextField? = nil
  @IBOutlet final var mModelImagePointsDxDimensionUnitPopUp : EBPopUpButton? = nil
  @IBOutlet final var mModelImagePointsDyDimensionUnitPopUp : EBPopUpButton? = nil
  @IBOutlet final var mModelImageSecondPointXDimensionUnitPopUp : EBPopUpButton? = nil
  @IBOutlet final var mModelImageSecondPointXTextField : CanariDimensionObserverTextField? = nil
  @IBOutlet final var mModelImageSecondPointYDimensionUnitPopUp : EBPopUpButton? = nil
  @IBOutlet final var mModelImageSecondPointYTextField : CanariDimensionObserverTextField? = nil
  @IBOutlet final var mModelImageSizeTextField : EBTextObserverField? = nil
  @IBOutlet final var mModelImageView : EBEnclosingGraphicView? = nil
  @IBOutlet final var mModelPointsCircleRadiusSlider : EBSlider? = nil
  ...
  @IBOutlet final var mPackageBackgroundColorColorWell : EBColorWell? = nil
  @IBOutlet final var mPackageColorColorWell : EBColorWell? = nil
  @IBOutlet final var mPackageDrawingWidthMultipliedByTenPopupButton : EBPopUpButton? = nil
  ...
  @IBOutlet final var mPadNumberColorWell : EBColorWell? = nil
  @IBOutlet final var mPadNumberFontButton : EBFontButton? = nil
  @IBOutlet final var mPadNumberTextField : EBIntObserverField? = nil
  @IBOutlet final var mPadNumberingPopUpButton : EBPopUpButton? = nil
  ...
  @IBOutlet final var mProgramErrorTextField : EBTextField? = nil
  @IBOutlet final var mProgramHelpButton : EBButton? = nil
  @IBOutlet final var mProgramHelpSheet : NSPanel? = nil
  @IBOutlet final var mProgramPageView : CanariViewWithKeyView? = nil
  @IBOutlet final var mProgramTextView : EBTextView? = nil
  @IBOutlet final var mRemoveModelImageMenuItem : EBMenuItem? = nil
  @IBOutlet final var mRemoveZoneForbiddenPadNumberButton : EBButton? = nil
  @IBOutlet final var mResetModelImagePointsMenuItem : EBMenuItem? = nil
  @IBOutlet final var mResetVersionButton : EBButton? = nil
  @IBOutlet final var mRunProgramButton : EBButton? = nil
  ...
  @IBOutlet final var mSelectedObjectsInspectorView : CanariViewWithKeyView? = nil
  ...
  @IBOutlet final var mShowPadNumberSwitch : EBSwitch? = nil
  ...
  @IBOutlet final var mTopSidePadColorWell : EBColorWell? = nil
  ...
  final var mController_mModelImageOpacitySlider_enabled : MultipleBindingController_enabled? = nil
  final var mController_mPadStyleView_hidden : MultipleBindingController_hidden? = nil
  final var mController_mPadRenumberingPullDownButton_enabled : MultipleBindingController_enabled? = nil
  final var mController_mSlavePadStyleView_hidden : MultipleBindingController_hidden? = nil
  final var mController_mRemoveZoneForbiddenPadNumberButton_enabled : MultipleBindingController_enabled? = nil
  final var mController_mCounterClockNumberingStartAngleView_hidden : MultipleBindingController_hidden? = nil
  final var mController_mDeselectIssueButton_enabled : MultipleBindingController_enabled? = nil
  final var mController_mAddSlavePadButton_enabled : MultipleBindingController_enabled? = nil
  final var mController_mModelPointsCircleRadiusSlider_enabled : MultipleBindingController_enabled? = nil
  final var mController_mLoadModelImageFromPasteboardMenuItem_enabled : MultipleBindingController_enabled? = nil
  final var mController_mLoadDIL16ModelImageFromResourcesdMenuItem_enabled : MultipleBindingController_enabled? = nil
  final var mController_mRemoveModelImageMenuItem_enabled : MultipleBindingController_enabled? = nil
  final var mController_mResetModelImagePointsMenuItem_enabled : MultipleBindingController_enabled? = nil
  final var mController_mLockImagePointsButton_enabled : MultipleBindingController_enabled? = nil
  ...
  //--------------------------- Install regular bindings
    ...
    self.mModelImageOpacitySlider?.bind_doubleValue (self.rootObject.mModelImageOpacity_property, sendContinously:true)
    self.mSegmentX1UnitPopUp?.bind_selectedTag (self.mPackageSegmentSelectionController.x1Unit_property)
    self.mSegmentX1TextField?.bind_dimensionAndUnit (self.mPackageSegmentSelectionController.x1_property, self.mPackageSegmentSelectionController.x1Unit_property)
    self.mSegmentY1UnitPopUp?.bind_selectedTag (self.mPackageSegmentSelectionController.y1Unit_property)
    self.mSegmentY1TextField?.bind_dimensionAndUnit (self.mPackageSegmentSelectionController.y1_property, self.mPackageSegmentSelectionController.y1Unit_property)
    self.mSegmentX2UnitPopUp?.bind_selectedTag (self.mPackageSegmentSelectionController.x2Unit_property)
    self.mSegmentX2TextField?.bind_dimensionAndUnit (self.mPackageSegmentSelectionController.x2_property, self.mPackageSegmentSelectionController.x2Unit_property)
    self.mSegmentY2UnitPopUp?.bind_selectedTag (self.mPackageSegmentSelectionController.y2Unit_property)
    self.mSegmentY2TextField?.bind_dimensionAndUnit (self.mPackageSegmentSelectionController.y2_property, self.mPackageSegmentSelectionController.y2Unit_property)
    self.mSegmentLengthUnitPopUp?.bind_selectedTag (self.mPackageSegmentSelectionController.lengthUnit_property)
    self.mSegmentLengthTextField?.bind_dimensionAndUnit (self.mPackageSegmentSelectionController.lengthInCanariUnit_property, self.mPackageSegmentSelectionController.lengthUnit_property)
    self.mBezierCurveX1UnitPopUp?.bind_selectedTag (self.mPackageBezierCurveSelectionController.x1Unit_property)
    self.mBezierCurveX1TextField?.bind_dimensionAndUnit (self.mPackageBezierCurveSelectionController.x1_property, self.mPackageBezierCurveSelectionController.x1Unit_property)
    self.mBezierCurveY1UnitPopUp?.bind_selectedTag (self.mPackageBezierCurveSelectionController.y1Unit_property)
    self.mBezierCurveY1TextField?.bind_dimensionAndUnit (self.mPackageBezierCurveSelectionController.y1_property, self.mPackageBezierCurveSelectionController.y1Unit_property)
    self.mBezierCurveX2UnitPopUp?.bind_selectedTag (self.mPackageBezierCurveSelectionController.x2Unit_property)
    self.mBezierCurveX2TextField?.bind_dimensionAndUnit (self.mPackageBezierCurveSelectionController.x2_property, self.mPackageBezierCurveSelectionController.x2Unit_property)
    self.mBezierCurveY2UnitPopUp?.bind_selectedTag (self.mPackageBezierCurveSelectionController.y2Unit_property)
    self.mBezierCurveY2TextField?.bind_dimensionAndUnit (self.mPackageBezierCurveSelectionController.y2_property, self.mPackageBezierCurveSelectionController.y2Unit_property)
    self.mBezierCurveCPX1UnitPopUp?.bind_selectedTag (self.mPackageBezierCurveSelectionController.cpx1Unit_property)
    self.mBezierCurveCPX1TextField?.bind_dimensionAndUnit (self.mPackageBezierCurveSelectionController.cpx1_property, self.mPackageBezierCurveSelectionController.cpx1Unit_property)
    self.mBezierCurveCPY1UnitPopUp?.bind_selectedTag (self.mPackageBezierCurveSelectionController.cpy1Unit_property)
    self.mBezierCurveCPY1TextField?.bind_dimensionAndUnit (self.mPackageBezierCurveSelectionController.cpy1_property, self.mPackageBezierCurveSelectionController.cpy1Unit_property)
    self.mBezierCurveCPX2UnitPopUp?.bind_selectedTag (self.mPackageBezierCurveSelectionController.cpx2Unit_property)
    self.mBezierCurveCPX2TextField?.bind_dimensionAndUnit (self.mPackageBezierCurveSelectionController.cpx2_property, self.mPackageBezierCurveSelectionController.cpx2Unit_property)
    self.mBezierCurveCPY2UnitPopUp?.bind_selectedTag (self.mPackageBezierCurveSelectionController.cpy2Unit_property)
    self.mBezierCurveCPY2TextField?.bind_dimensionAndUnit (self.mPackageBezierCurveSelectionController.cpy2_property, self.mPackageBezierCurveSelectionController.cpy2Unit_property)
    self.mOvalXUnitPopUp?.bind_selectedTag (self.mPackageOvalSelectionController.xUnit_property)
    self.mOvalXTextField?.bind_dimensionAndUnit (self.mPackageOvalSelectionController.x_property, self.mPackageOvalSelectionController.xUnit_property)
    self.mOvalYUnitPopUp?.bind_selectedTag (self.mPackageOvalSelectionController.yUnit_property)
    self.mOvalYTextField?.bind_dimensionAndUnit (self.mPackageOvalSelectionController.y_property, self.mPackageOvalSelectionController.yUnit_property)
    self.mOvalWidthUnitPopUp?.bind_selectedTag (self.mPackageOvalSelectionController.widthUnit_property)
    self.mOvalWidthTextField?.bind_dimensionAndUnit (self.mPackageOvalSelectionController.width_property, self.mPackageOvalSelectionController.widthUnit_property)
    self.mOvalHeightUnitPopUp?.bind_selectedTag (self.mPackageOvalSelectionController.heightUnit_property)
    self.mOvalHeightTextField?.bind_dimensionAndUnit (self.mPackageOvalSelectionController.height_property, self.mPackageOvalSelectionController.heightUnit_property)
    self.mArcRadiusUnitPopUp?.bind_selectedTag (self.mPackageArcSelectionController.radiusUnit_property)
    self.mArcRadiusTextField?.bind_dimensionAndUnit (self.mPackageArcSelectionController.radius_property, self.mPackageArcSelectionController.radiusUnit_property)
    self.mArcXCenterUnitPopUp?.bind_selectedTag (self.mPackageArcSelectionController.xCenterUnit_property)
    self.mArcXCenterTextField?.bind_dimensionAndUnit (self.mPackageArcSelectionController.xCenter_property, self.mPackageArcSelectionController.xCenterUnit_property)
    self.mArcYCenterUnitPopUp?.bind_selectedTag (self.mPackageArcSelectionController.yCenterUnit_property)
    self.mArcYCenterTextField?.bind_dimensionAndUnit (self.mPackageArcSelectionController.yCenter_property, self.mPackageArcSelectionController.yCenterUnit_property)
    self.mArcStartTangentUnitPopUp?.bind_selectedTag (self.mPackageArcSelectionController.startTangentUnit_property)
    self.mArcStartTangentTextField?.bind_dimensionAndUnit (self.mPackageArcSelectionController.startTangent_property, self.mPackageArcSelectionController.startTangentUnit_property)
    self.mArcEndTangentUnitPopUp?.bind_selectedTag (self.mPackageArcSelectionController.endTangentUnit_property)
    self.mArcEndTangentTextField?.bind_dimensionAndUnit (self.mPackageArcSelectionController.endTangent_property, self.mPackageArcSelectionController.endTangentUnit_property)
    self.mArcPathIsClosedSwitch?.bind_value (self.mPackageArcSelectionController.pathIsClosed_property)
    self.mArcStartAngleTextField?.bind_angle (self.mPackageArcSelectionController.startAngle_property)
    self.mArcStartAngleSlider?.bind_angle (self.mPackageArcSelectionController.startAngle_property)
    self.mArcAngle?.bind_angle (self.mPackageArcSelectionController.arcAngle_property)
    self.mPackagePadShapePopUpButton?.bind_selectedIndex (self.mPackagePadSelectionController.padShape_property)
    self.mPackagePadStylePopUpButton?.bind_selectedIndex (self.mPackagePadSelectionController.padStyle_property)
    self.mPadXCenterUnitPopUp?.bind_selectedTag (self.mPackagePadSelectionController.xCenterUnit_property)
    self.mPadXCenterTextField?.bind_dimensionAndUnit (self.mPackagePadSelectionController.xCenter_property, self.mPackagePadSelectionController.xCenterUnit_property)
    self.mPadYCenterUnitPopUp?.bind_selectedTag (self.mPackagePadSelectionController.yCenterUnit_property)
    self.mPadYCenterTextField?.bind_dimensionAndUnit (self.mPackagePadSelectionController.yCenter_property, self.mPackagePadSelectionController.yCenterUnit_property)
    self.mPadWidthUnitPopUp?.bind_selectedTag (self.mPackagePadSelectionController.widthUnit_property)
    self.mPadWidthTextField?.bind_dimensionAndUnit (self.mPackagePadSelectionController.width_property, self.mPackagePadSelectionController.widthUnit_property)
    self.mPadHeightUnitPopUp?.bind_selectedTag (self.mPackagePadSelectionController.heightUnit_property)
    self.mPadHeightTextField?.bind_dimensionAndUnit (self.mPackagePadSelectionController.height_property, self.mPackagePadSelectionController.heightUnit_property)
    self.mPadHoleWidthUnitPopUp?.bind_selectedTag (self.mPackagePadSelectionController.holeWidthUnit_property)
    self.mPadHoleWidthTextField?.bind_dimensionAndUnit (self.mPackagePadSelectionController.holeWidth_property, self.mPackagePadSelectionController.holeWidthUnit_property)
    self.mPadHoleHeightUnitPopUp?.bind_selectedTag (self.mPackagePadSelectionController.holeHeightUnit_property)
    self.mPadHoleHeightTextField?.bind_dimensionAndUnit (self.mPackagePadSelectionController.holeHeight_property, self.mPackagePadSelectionController.holeHeightUnit_property)
    self.mPadAnnularRingUnitPopUp?.bind_selectedTag (self.mPackagePadSelectionController.annularRingUnit_property)
    self.mPadAnnularRingTextField?.bind_dimensionAndUnit (self.mPackagePadSelectionController.annularRing_property, self.mPackagePadSelectionController.annularRingUnit_property)
    self.mPadZoneNameTextField?.bind_valueObserver (self.mPackagePadSelectionController.zoneName_property)
    self.mPadNumberTextField?.bind_valueObserver (self.mPackagePadSelectionController.padNumber_property, autoFormatter:true)
    self.mPadRenumberingPullDownButton?.bind_currentNumber (self.mPackagePadSelectionController.padNumber_property)
    self.mPadRenumberingPullDownButton?.bind_currentZoneName (self.mPackagePadSelectionController.zoneName_property)
    self.mPadSlaveCountTextField?.bind_valueObserver (self.mPackagePadSelectionController.slavePadCount_property, autoFormatter:true)
    self.mPackageSlavePadShapePopUpButton?.bind_selectedIndex (self.mPackageSlavePadSelectionController.padShape_property)
    self.mPackageSlavePadStylePopUpButton?.bind_selectedIndex (self.mPackageSlavePadSelectionController.padStyle_property)
    self.mSlavePadXCenterUnitPopUp?.bind_selectedTag (self.mPackageSlavePadSelectionController.xCenterUnit_property)
    self.mSlavePadXCenterTextField?.bind_dimensionAndUnit (self.mPackageSlavePadSelectionController.xCenter_property, self.mPackageSlavePadSelectionController.xCenterUnit_property)
    self.mSlavePadYCenterUnitPopUp?.bind_selectedTag (self.mPackageSlavePadSelectionController.yCenterUnit_property)
    self.mSlavePadYCenterTextField?.bind_dimensionAndUnit (self.mPackageSlavePadSelectionController.yCenter_property, self.mPackageSlavePadSelectionController.yCenterUnit_property)
    self.mSlavePadWidthUnitPopUp?.bind_selectedTag (self.mPackageSlavePadSelectionController.widthUnit_property)
    self.mSlavePadWidthTextField?.bind_dimensionAndUnit (self.mPackageSlavePadSelectionController.width_property, self.mPackageSlavePadSelectionController.widthUnit_property)
    self.mSlavePadHeightUnitPopUp?.bind_selectedTag (self.mPackageSlavePadSelectionController.heightUnit_property)
    self.mSlavePadHeightTextField?.bind_dimensionAndUnit (self.mPackageSlavePadSelectionController.height_property, self.mPackageSlavePadSelectionController.heightUnit_property)
    self.mSlavePadHoleWidthUnitPopUp?.bind_selectedTag (self.mPackageSlavePadSelectionController.holeWidthUnit_property)
    self.mSlavePadHoleWidthTextField?.bind_dimensionAndUnit (self.mPackageSlavePadSelectionController.holeWidth_property, self.mPackageSlavePadSelectionController.holeWidthUnit_property)
    self.mSlavePadHoleHeightUnitPopUp?.bind_selectedTag (self.mPackageSlavePadSelectionController.holeHeightUnit_property)
    self.mSlavePadHoleHeightTextField?.bind_dimensionAndUnit (self.mPackageSlavePadSelectionController.holeHeight_property, self.mPackageSlavePadSelectionController.holeHeightUnit_property)
    self.mSlavePadAnnularRingUnitPopUp?.bind_selectedTag (self.mPackageSlavePadSelectionController.annularRingUnit_property)
    self.mSlavePadAnnularRingTextField?.bind_dimensionAndUnit (self.mPackageSlavePadSelectionController.annularRing_property, self.mPackageSlavePadSelectionController.annularRingUnit_property)
    self.mSlavePadAssignmentPopUpButton?.bind_masterPadName (self.mPackageSlavePadSelectionController.masterPadNameWithZoneName_property)
    self.mSlavePadAssignmentPopUpButton?.bind_masterPadObjectIndexArray (self.rootObject.masterPadObjectIndexArray_property)
    self.mGuideX1UnitPopUp?.bind_selectedTag (self.mPackageGuideSelectionController.x1Unit_property)
    self.mGuideX1TextField?.bind_dimensionAndUnit (self.mPackageGuideSelectionController.x1_property, self.mPackageGuideSelectionController.x1Unit_property)
    self.mGuideY1UnitPopUp?.bind_selectedTag (self.mPackageGuideSelectionController.y1Unit_property)
    self.mGuideY1TextField?.bind_dimensionAndUnit (self.mPackageGuideSelectionController.y1_property, self.mPackageGuideSelectionController.y1Unit_property)
    self.mGuideX2UnitPopUp?.bind_selectedTag (self.mPackageGuideSelectionController.x2Unit_property)
    self.mGuideX2TextField?.bind_dimensionAndUnit (self.mPackageGuideSelectionController.x2_property, self.mPackageGuideSelectionController.x2Unit_property)
    self.mGuideY2UnitPopUp?.bind_selectedTag (self.mPackageGuideSelectionController.y2Unit_property)
    self.mGuideY2TextField?.bind_dimensionAndUnit (self.mPackageGuideSelectionController.y2_property, self.mPackageGuideSelectionController.y2Unit_property)
    self.mDimensionX1UnitPopUp?.bind_selectedTag (self.mPackageDimensionSelectionController.x1Unit_property)
    self.mDimensionX1TextField?.bind_dimensionAndUnit (self.mPackageDimensionSelectionController.x1_property, self.mPackageDimensionSelectionController.x1Unit_property)
    self.mDimensionY1UnitPopUp?.bind_selectedTag (self.mPackageDimensionSelectionController.y1Unit_property)
    self.mDimensionY1TextField?.bind_dimensionAndUnit (self.mPackageDimensionSelectionController.y1_property, self.mPackageDimensionSelectionController.y1Unit_property)
    self.mDimensionX2UnitPopUp?.bind_selectedTag (self.mPackageDimensionSelectionController.x2Unit_property)
    self.mDimensionX2TextField?.bind_dimensionAndUnit (self.mPackageDimensionSelectionController.x2_property, self.mPackageDimensionSelectionController.x2Unit_property)
    self.mDimensionY2UnitPopUp?.bind_selectedTag (self.mPackageDimensionSelectionController.y2Unit_property)
    self.mDimensionY2TextField?.bind_dimensionAndUnit (self.mPackageDimensionSelectionController.y2_property, self.mPackageDimensionSelectionController.y2Unit_property)
    self.mDimensionDistanceUnitPopUp?.bind_selectedTag (self.mPackageDimensionSelectionController.distanceUnit_property)
    self.mDimensionDistanceTextField?.bind_dimensionAndUnit (self.mPackageDimensionSelectionController.distanceInCanariUnit_property, self.mPackageDimensionSelectionController.distanceUnit_property)
    self.mDimensionXLabelUnitPopUp?.bind_selectedTag (self.mPackageDimensionSelectionController.xDimensionUnit_property)
    ...
    self.mZoneYTextField?.bind_dimensionAndUnit (self.mPackageZoneSelectionController.y_property, self.mPackageZoneSelectionController.yUnit_property)
    self.mZoneWidthUnitPopUp?.bind_selectedTag (self.mPackageZoneSelectionController.widthUnit_property)
    self.mZoneWidthTextField?.bind_dimensionAndUnit (self.mPackageZoneSelectionController.width_property, self.mPackageZoneSelectionController.widthUnit_property)
    self.mZoneHeightUnitPopUp?.bind_selectedTag (self.mPackageZoneSelectionController.heightUnit_property)
    self.mZoneHeightTextField?.bind_dimensionAndUnit (self.mPackageZoneSelectionController.height_property, self.mPackageZoneSelectionController.heightUnit_property)
    self.mZoneNameTextField?.bind_value (self.mPackageZoneSelectionController.zoneName_property, sendContinously:true)
    self.mDisplayZoneNameSwitch?.bind_value (self.mPackageZoneSelectionController.displayZoneName_property)
    self.mZoneNumberingPopUpButton?.bind_selectedIndex (self.mPackageZoneSelectionController.zoneNumbering_property)
    self.mZoneXLabelUnitPopUp?.bind_selectedTag (self.mPackageZoneSelectionController.xNameUnit_property)
    self.mZoneXLabelTextField?.bind_dimensionAndUnit (self.mPackageZoneSelectionController.xName_property, self.mPackageZoneSelectionController.xNameUnit_property)
    self.mZoneYLabelUnitPopUp?.bind_selectedTag (self.mPackageZoneSelectionController.yNameUnit_property)
    self.mZoneYLabelTextField?.bind_dimensionAndUnit (self.mPackageZoneSelectionController.yName_property, self.mPackageZoneSelectionController.yNameUnit_property)
    self.mZoneForbiddenPadNumberTableView?.bind_array (self.mPackageZoneSelectionController.forbiddenPadArray_property)
    self.mPadNumberingPopUpButton?.bind_selectedIndex (self.rootObject.padNumbering_property)
    self.mCounterClockNumberingStartAngleIntField?.bind_value (self.rootObject.counterClockNumberingStartAngle_property, sendContinously:true, autoFormatter:false)
    self.mStatusImageViewInToolbar?.bind_image (self.statusImage_property)
    self.mStatusImageViewInToolbar?.bind_tooltip (self.statusMessage_property)
    self.mIssueTextField?.bind_valueObserver (self.statusMessage_property)
    self.mIssueTableView?.bind_issues (self.rootObject.issues_property)
    self.mComposedPackageView?.bind_foregroundImageData (self.rootObject.mModelImageData_property)
    self.mComposedPackageView?.bind_foregroundImageOpacity (self.rootObject.mModelImageOpacity_property)
    self.mComposedPackageView?.bind_horizontalFlip (self.rootObject.horizontalFlip_property)
    self.mComposedPackageView?.bind_verticalFlip (self.rootObject.verticalFlip_property)
    self.mComposedPackageView?.bind_overObjectsDisplay (self.rootObject.padNumberDisplay_property)
    self.mComposedPackageView?.bind_mouseGrid (self.rootObject.gridStep_property)
    self.mComposedPackageView?.bind_gridStep (self.rootObject.gridStep_property)
    self.mComposedPackageView?.bind_arrowKeyMagnitude (self.rootObject.gridStep_property)
    self.mComposedPackageView?.bind_shiftArrowKeyMagnitude (self.rootObject.gridStepMultipliedByDisplayFactor_property)
    self.mComposedPackageView?.bind_gridStyle (self.rootObject.gridStyle_property)
    self.mComposedPackageView?.bind_gridDisplayFactor (self.rootObject.gridDisplayFactor_property)
    self.mComposedPackageView?.bind_gridLineColor (preferences_lineColorOfPackageGrid_property)
    self.mComposedPackageView?.bind_gridCrossColor (preferences_crossColorOfPackageGrid_property)
    self.mComposedPackageView?.bind_zoom (self.rootObject.zoom_property)
    self.mComposedPackageView?.bind_backColor (preferences_packageBackgroundColor_property)
    self.mComposedPackageView?.bind_xPlacardUnit (self.rootObject.xPlacardUnit_property)
    self.mComposedPackageView?.bind_yPlacardUnit (self.rootObject.yPlacardUnit_property)
    self.mHorizontalFlip?.bind_value (self.rootObject.horizontalFlip_property)
    self.mVerticalFlip?.bind_value (self.rootObject.verticalFlip_property)
    self.mShowPadNumberSwitch?.bind_value (preferences_showPadNumber_property)
    self.mGridStyle?.bind_selectedIndex (self.rootObject.gridStyle_property)
    self.mGridDisplayPopUpButton?.bind_selectedTag (self.rootObject.gridDisplayFactor_property)
    self.mXPlacardUnitPopUpButton?.bind_selectedTag (self.rootObject.xPlacardUnit_property)
    self.mYPlacardUnitPopUpButton?.bind_selectedTag (self.rootObject.yPlacardUnit_property)
    self.mKnobSizeSlider?.bind_intValue (self.rootObject.knobSizeMultpliedByTen_property, sendContinously:true)
    self.mCrossColorOfPackageGridColorWell?.bind_color (preferences_crossColorOfPackageGrid_property, sendContinously:false)
    self.mLineColorOfPackageGridColorWell?.bind_color (preferences_lineColorOfPackageGrid_property, sendContinously:false)
    self.mPackageColorColorWell?.bind_color (preferences_packageColor_property, sendContinously:false)
    self.mTopSidePadColorWell?.bind_color (preferences_frontSidePadColor_property, sendContinously:false)
    self.mBottomSidePadColorWell?.bind_color (preferences_backSidePadColor_property, sendContinously:false)
    self.mPackageBackgroundColorColorWell?.bind_color (preferences_packageBackgroundColor_property, sendContinously:false)
    self.mPackageDrawingWidthMultipliedByTenPopupButton?.bind_selectedTag (preferences_packageDrawingWidthMultipliedByTen_property)
    self.mPadNumberColorWell?.bind_color (preferences_padNumberColor_property, sendContinously:false)
    self.mDisplayTopSidePadSwitch?.bind_value (preferences_displayPackageFrontSidePads_property)
    self.mDisplayBottomSidePadSwitch?.bind_value (preferences_displayPackageBackSidePads_property)
    self.mPadNumberFontButton?.bind_fontValue (preferences_padNumberFont_property)
    self.mGridUnitPopUp?.bind_selectedTag (self.rootObject.gridStepUnit_property)
    self.mGridTextField?.bind_dimensionAndUnit (self.rootObject.gridStep_property, self.rootObject.gridStepUnit_property)
    self.mProgramTextView?.bind_value (self.rootObject.program_property)
    self.mModelImageView?.bind_backgroundImageData (self.rootObject.mModelImageData_property)
    self.mModelImageView?.bind_underObjectsDisplay (self.rootObject.backgroundImagePageBackgroundDisplay_property)
    self.mModelImageView?.bind_horizontalFlip (self.rootObject.mModelImagePageHorizontalFlip_property)
    self.mModelImageView?.bind_verticalFlip (self.rootObject.mModelImagePageVerticalFlip_property)
    self.mModelImageView?.bind_mouseGrid (self.rootObject.mModelImagePageGridStep_property)
    self.mModelImageView?.bind_gridStep (self.rootObject.mModelImagePageGridStep_property)
    self.mModelImageView?.bind_arrowKeyMagnitude (self.rootObject.mModelImagePageGridStep_property)
    self.mModelImageView?.bind_gridStyle (self.rootObject.mModelImagePageGridStyle_property)
    self.mModelImageView?.bind_gridDisplayFactor (self.rootObject.mModelImagePageGridDisplayFactor_property)
    self.mModelImageView?.bind_gridLineColor (preferences_lineColorOfPackageGrid_property)
    self.mModelImageView?.bind_gridCrossColor (preferences_crossColorOfPackageGrid_property)
    self.mModelImageView?.bind_zoom (self.rootObject.mModelImagePageZoom_property)
    self.mModelImageView?.bind_backColor (preferences_packageBackgroundColor_property)
    self.mModelImageView?.bind_xPlacardUnit (self.rootObject.mModelImagePageXPlacardUnit_property)
    self.mModelImageView?.bind_yPlacardUnit (self.rootObject.mModelImagePageYPlacardUnit_property)
    self.mModelImagePageHorizontalFlip?.bind_value (self.rootObject.mModelImagePageHorizontalFlip_property)
    self.mModelImagePageVerticalFlip?.bind_value (self.rootObject.mModelImagePageVerticalFlip_property)
    self.mModelImagePageGridStyle?.bind_selectedIndex (self.rootObject.mModelImagePageGridStyle_property)
    self.mModelImagePageGridDisplayPopUpButton?.bind_selectedTag (self.rootObject.mModelImagePageGridDisplayFactor_property)
    self.mModelImagePageGridUnitPopUp?.bind_selectedTag (self.rootObject.mModelImagePageGridStepUnit_property)
    self.mModelImagePageGridTextField?.bind_dimensionAndUnit (self.rootObject.mModelImagePageGridStep_property, self.rootObject.mModelImagePageGridStepUnit_property)
    self.mModelImagePageXPlacardUnitPopUpButton?.bind_selectedTag (self.rootObject.mModelImagePageXPlacardUnit_property)
    self.mModelImagePageYPlacardUnitPopUpButton?.bind_selectedTag (self.rootObject.mModelImagePageYPlacardUnit_property)
    self.mModelPointsCircleRadiusSlider?.bind_intValue (self.rootObject.mModelPointsCircleRadius_property, sendContinously:true)
    self.mModelImageSizeTextField?.bind_valueObserver (self.rootObject.modelImageSizeString_property)
    self.mModelImageFirstPointXDimensionUnitPopUp?.bind_selectedTag (self.rootObject.mDimensionUnitFirstModelPointX_property)
    self.mModelImageFirstPointXTextField?.bind_dimensionAndUnit (self.rootObject.mModelImageFirstPointX_property, self.rootObject.mDimensionUnitFirstModelPointX_property)
    self.mModelImageFirstPointYDimensionUnitPopUp?.bind_selectedTag (self.rootObject.mDimensionUnitFirstModelPointY_property)
    self.mModelImageFirstPointYTextField?.bind_dimensionAndUnit (self.rootObject.mModelImageFirstPointY_property, self.rootObject.mDimensionUnitFirstModelPointY_property)
    self.mModelImagePointsDxDimensionUnitPopUp?.bind_selectedTag (self.rootObject.mDimensionUnitSecondModelPointDx_property)
    self.mModelImagePointDxTextField?.bind_dimensionAndUnit (self.rootObject.mModelImageSecondPointDx_property, self.rootObject.mDimensionUnitSecondModelPointDx_property)
    self.mModelImagePointsDyDimensionUnitPopUp?.bind_selectedTag (self.rootObject.mDimensionUnitSecondModelPointDy_property)
