...
//----------------------------------------------------------------------------------------------------------------------
//    Array controller PackageDocument mModelImageObjectsController
//----------------------------------------------------------------------------------------------------------------------

final class Controller_PackageDocument_mModelImageObjectsController : ReadOnlyAbstractGenericRelationshipProperty, EBGraphicViewControllerProtocol, HiddenEBProtocol {
  ...
  var selectedArray_property_selection : EBSelection <[PackageModelImageDoublePoint]> { return self.selectedArray_property.selection }
  ...
  final func bind_model (_ inModel : ReadWriteArrayOf_PackageModelImageDoublePoint, _ inUndoManager : EBUndoManager?) {
    self.mModel = inModel
 ...
 //····················································································································
  ...
  func sendToBack () {
    var objects = self.objectArray
    let sortedIndexArray = self.sortedIndexArrayOfSelectedObjects ()
    var newObjectArray = [PackageModelImageDoublePoint] ()
    for idx in sortedIndexArray.reversed () {
      let object = objects [idx]
      objects.remove (at: idx)
