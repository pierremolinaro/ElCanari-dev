...
final class Controller_PackageDocument_mPackageObjectsController : ReadOnlyAbstractGenericRelationshipProperty, EBGraphicViewControllerProtocol {
  ...
  private let mInternalSelectedArrayProperty = StoredArrayOf_PackageObject ()
  ...
  func bind_model (_ inModel : ReadWriteArrayOf_PackageObject, _ inUndoManager : EBUndoManager) {
    self.mModel = inModel
  ...
  @objc func remove (_ sender : Any) {
    if let model = self.mModel {
      ...
      //--- Find the first index of a non selected object
        ...
        var newSelectedObject : PackageObject? = nil
