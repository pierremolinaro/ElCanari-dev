...
@MainActor final class SelectionController_AutoLayoutPackageDocument_mPackagePadSelectionController {
  ...
  var selectedArray : EBReferenceArray <PackagePad> { return self.selectedArray_property.propval }
  ...
  //--- padNumber
    ...
    self.selectedArray_property.toMany_padNumber_StopsBeingObserved (by: self.padNumber_property)
  //--- xCenterUnit
  ...
  //--- noZone
    ...
    self.selectedArray_property.toMany_noZone_StopsBeingObserved (by: self.noZone_property)
  //--- zoneAllowsManualRenumbering
    self.zoneAllowsManualRenumbering_property.mReadModelFunction = nil 
    self.selectedArray_property.toMany_zoneAllowsManualRenumbering_StopsBeingObserved (by: self.zoneAllowsManualRenumbering_property)
  //--- slavePadCount
    self.slavePadCount_property.mReadModelFunction = nil 
    self.selectedArray_property.toMany_slavePadCount_StopsBeingObserved (by: self.slavePadCount_property)
  //--- masterPadObjectIndex
    self.masterPadObjectIndex_property.mReadModelFunction = nil 
    self.selectedArray_property.toMany_masterPadObjectIndex_StopsBeingObserved (by: self.masterPadObjectIndex_property)
  //--- padNumberDisplay
  ...
  private final func bind_property_padNumber () {
    self.selectedArray_property.toMany_padNumber_StartsBeingObserved (by: self.padNumber_property)
  ...
  private final func bind_property_noZone () {
    self.selectedArray_property.toMany_noZone_StartsBeingObserved (by: self.noZone_property)
  ...
  private final func bind_property_zoneAllowsManualRenumbering () {
    self.selectedArray_property.toMany_zoneAllowsManualRenumbering_StartsBeingObserved (by: self.zoneAllowsManualRenumbering_property)
  ...
  private final func bind_property_slavePadCount () {
    self.selectedArray_property.toMany_slavePadCount_StartsBeingObserved (by: self.slavePadCount_property)
  ...
  private final func bind_property_masterPadObjectIndex () {
    self.selectedArray_property.toMany_masterPadObjectIndex_StartsBeingObserved (by: self.masterPadObjectIndex_property)
