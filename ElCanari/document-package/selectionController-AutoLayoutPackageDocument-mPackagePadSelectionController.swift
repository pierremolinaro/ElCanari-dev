...
@MainActor final class SelectionController_AutoLayoutPackageDocument_mPackagePadSelectionController {
  ...
  private final func bind_property_padNumber () {
    self.selectedArray_property.toMany_padNumber_StartsToBeObserved (by: self.padNumber_property)
  ...
  private final func bind_property_noZone () {
    self.selectedArray_property.toMany_noZone_StartsToBeObserved (by: self.noZone_property)
  ...
  private final func bind_property_zoneAllowsManualRenumbering () {
    self.selectedArray_property.toMany_zoneAllowsManualRenumbering_StartsToBeObserved (by: self.zoneAllowsManualRenumbering_property)
  ...
  private final func bind_property_slavePadCount () {
    self.selectedArray_property.toMany_slavePadCount_StartsToBeObserved (by: self.slavePadCount_property)
  ...
  private final func bind_property_masterPadObjectIndex () {
    self.selectedArray_property.toMany_masterPadObjectIndex_StartsToBeObserved (by: self.masterPadObjectIndex_property)
