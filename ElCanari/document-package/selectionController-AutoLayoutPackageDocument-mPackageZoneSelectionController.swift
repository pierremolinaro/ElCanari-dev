...
@MainActor final class SelectionController_AutoLayoutPackageDocument_mPackageZoneSelectionController {
  ...
  private final func bind_property_xUnit () {
    self.selectedArray_property.toMany_xUnit_StartsBeingObserved (by: self.xUnit_property)
  ...
  private final func bind_property_yUnit () {
    self.selectedArray_property.toMany_yUnit_StartsBeingObserved (by: self.yUnit_property)
  ...
  private final func bind_property_zoneName () {
    self.selectedArray_property.toMany_zoneName_StartsBeingObserved (by: self.zoneName_property)
  ...
  private final func bind_property_displayZoneName () {
    self.selectedArray_property.toMany_displayZoneName_StartsBeingObserved (by: self.displayZoneName_property)
  ...
  private final func bind_property_displayZoneNameWithPadNumbers () {
    self.selectedArray_property.toMany_displayZoneNameWithPadNumbers_StartsBeingObserved (by: self.displayZoneNameWithPadNumbers_property)
  ...
  private final func bind_property_xName () {
    self.selectedArray_property.toMany_xName_StartsBeingObserved (by: self.xName_property)
  ...
  private final func bind_property_yName () {
    self.selectedArray_property.toMany_yName_StartsBeingObserved (by: self.yName_property)
  ...
  private final func bind_property_xNameUnit () {
    self.selectedArray_property.toMany_xNameUnit_StartsBeingObserved (by: self.xNameUnit_property)
  ...
  private final func bind_property_yNameUnit () {
    self.selectedArray_property.toMany_yNameUnit_StartsBeingObserved (by: self.yNameUnit_property)
  ...
  private final func bind_property_zoneNumbering () {
    self.selectedArray_property.toMany_zoneNumbering_StartsBeingObserved (by: self.zoneNumbering_property)
  ...
  private final func bind_property_rect () {
    self.selectedArray_property.toMany_rect_StartsBeingObserved (by: self.rect_property)
  ...
  private final func bind_property_forbiddenPadArray () {
    self.selectedArray_property.toMany_forbiddenPadArray_StartsBeingObserved (by: self.forbiddenPadArray_property)
  ...
  private final func bind_property_emptyForbiddenPadArray () {
    self.selectedArray_property.toMany_emptyForbiddenPadArray_StartsBeingObserved (by: self.emptyForbiddenPadArray_property)
