...
@objc(SelectionController_PackageDocument_mPackageGuideSelectionController)
final class SelectionController_PackageDocument_mPackageGuideSelectionController : EBObject {
  ...
  //····················································································································
   ...
   private var mActualModel = TransientArrayOf_PackageGuide ()

  //····················································································································

  func bind_selection (model : ReadOnlyArrayOf_PackageObject, file : String, line : Int) {
    self.mModel = model
    self.mActualModel.readModelFunction = { [weak self] () -> EBSelection < [PackageGuide] > in
      if let model = self?.mModel {
        ...
        case .single (let v) :
          var s = [PackageGuide] ()
          for baseObject in v {
            if let object = baseObject as? PackageGuide {
              s.append (object)
            }
          }
          return .single (s)
