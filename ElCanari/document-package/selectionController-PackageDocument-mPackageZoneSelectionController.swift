...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//    Derived selection controller PackageDocument mPackageZoneSelectionController
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
...
final class SelectionController_PackageDocument_mPackageZoneSelectionController : EBObject {
  ...
  private final func bind_property_x () {
    self.selectedArray_property.addEBObserverOf_x (self.x_property, postEvent: true)
  ...
  private final func bind_property_y () {
    self.selectedArray_property.addEBObserverOf_y (self.y_property, postEvent: true)
  ...
  private final func bind_property_xUnit () {
    self.selectedArray_property.addEBObserverOf_xUnit (self.xUnit_property, postEvent: true)
  ...
  private final func bind_property_yUnit () {
    self.selectedArray_property.addEBObserverOf_yUnit (self.yUnit_property, postEvent: true)
  ...
  private final func bind_property_xNameUnit () {
    self.selectedArray_property.addEBObserverOf_xNameUnit (self.xNameUnit_property, postEvent: true)
  ...
  private final func bind_property_yNameUnit () {
    self.selectedArray_property.addEBObserverOf_yNameUnit (self.yNameUnit_property, postEvent: true)
  ...
  private final func bind_property_zoneNumbering () {
    self.selectedArray_property.addEBObserverOf_zoneNumbering (self.zoneNumbering_property, postEvent: true)
  ...
  private final func bind_property_rect () {
    self.selectedArray_property.addEBObserverOf_rect (self.rect_property, postEvent: true)
