...
class ReadOnlyArrayOf_PackageBezier : EBReadOnlyAbstractArrayProperty <PackageBezier> {
  ...
  //--- Add observers to added objects
    for managedObject in inAddedSet.values {
      ...
      if let relay = self.mObserversOf_cpx1 { // Stored property
        managedObject.cpx1_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_cpy1 { // Stored property
        managedObject.cpy1_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_cpx2 { // Stored property
        managedObject.cpx2_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_cpy2 { // Stored property
        managedObject.cpy2_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_x1Unit { // Stored property
      ...
      if let relay = self.mObserversOf_cpx1Unit { // Stored property
        managedObject.cpx1Unit_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_cpy1Unit { // Stored property
        managedObject.cpy1Unit_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_cpx2Unit { // Stored property
        managedObject.cpx2Unit_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_cpy2Unit { // Stored property
        managedObject.cpy2Unit_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_x1 { // Stored property
  ...
  final func toMany_cpx1_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_cpx1_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_cpy1_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_cpy1_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_cpx2_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_cpx2_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_cpy2_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_cpy2_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_cpx1Unit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_cpx1Unit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_cpy1Unit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_cpy1Unit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_cpx2Unit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_cpx2Unit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_cpy2Unit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_cpy2Unit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
