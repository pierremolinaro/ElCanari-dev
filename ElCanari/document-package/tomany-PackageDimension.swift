...
final class TransientArrayOf_PackageDimension : ReadOnlyArrayOf_PackageDimension {
  ...
  private weak var mDataProvider : ReadOnlyArrayOf_PackageDimension? = nil // SHOULD BE WEAK
...
final class ProxyArrayOf_PackageDimension : ReadWriteArrayOf_PackageDimension {
  ...
  private weak var mModel : ReadWriteArrayOf_PackageDimension? = nil // SHOULD BE WEAK
  ...
  init (prefKey : String) {
    ...
    if let array = UserDefaults.standard.array (forKey: prefKey) as? [NSDictionary] {
      ...
      for dictionary in array {
        let object = newInstanceOfEntityNamed (self.undoManager, "PackageDimension") as! PackageDimension
