...
class ReadOnlyArrayOf_PackageDimension : EBReadOnlyAbstractArrayProperty <PackageDimension> {
  ...
  final func toMany_y1_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_y1_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_x2_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_x2_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_y2_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_y2_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_xDimension_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_xDimension_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_yDimension_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_yDimension_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_x1Unit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_x1Unit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_y1Unit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_y1Unit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_x2Unit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_x2Unit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_y2Unit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_y2Unit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_xDimensionUnit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_xDimensionUnit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_yDimensionUnit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_yDimensionUnit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_distanceUnit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_distanceUnit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_drawDimensionBackground_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_drawDimensionBackground_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_x1_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_x1_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_distanceInCanariUnit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_distanceInCanariUnit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
