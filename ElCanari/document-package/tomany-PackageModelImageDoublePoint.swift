...
class ReadOnlyArrayOf_PackageModelImageDoublePoint : EBReadOnlyAbstractArrayProperty <PackageModelImageDoublePoint> {
  ...
  final func toMany_mFirstX_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mFirstX_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mFirstY_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mFirstY_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mFirstColor_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mFirstColor_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mSecondDx_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mSecondDx_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mSecondDy_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mSecondDy_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mSecondColor_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mSecondColor_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: PackageModelImageDoublePoint
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_PackageModelImageDoublePoint : ReadWriteArrayOf_PackageModelImageDoublePoint { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
...
class StoredArrayOf_PackageModelImageDoublePoint : StandAloneArrayOf_PackageModelImageDoublePoint, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
