...
class ReadOnlyArrayOf_PackageObject : ReadOnlyAbstractArrayProperty <PackageObject> {
  ...
  final func addEBObserversOf_issues_toElementsOfSet (_ inSet : EBReferenceSet <PackageObject>) {
  ...
  final func removeEBObserversOf_issues_fromElementsOfSet (_ inSet : EBReferenceSet <PackageObject>) {
    for managedObject in inSet.values {
      for (_, entry) in self.mObserversOf_issues.dictionary {
        if let observer = entry.possibleObserver {
  ...
  final func addEBObserversOf_selectionDisplay_toElementsOfSet (_ inSet : EBReferenceSet <PackageObject>) {
    for managedObject in inSet.values {
  ...
  final func removeEBObserversOf_selectionDisplay_fromElementsOfSet (_ inSet : EBReferenceSet <PackageObject>) {
    for managedObject in inSet.values {
      for (_, entry) in self.mObserversOf_selectionDisplay.dictionary {
        if let observer = entry.possibleObserver {
  ...
  final func addEBObserversOf_objectDisplay_toElementsOfSet (_ inSet : EBReferenceSet <PackageObject>) {
    for managedObject in inSet.values {
  ...
  final func removeEBObserversOf_objectDisplay_fromElementsOfSet (_ inSet : EBReferenceSet <PackageObject>) {
    for managedObject in inSet.values {
      for (_, entry) in self.mObserversOf_objectDisplay.dictionary {
        if let observer = entry.possibleObserver {
  ...
  final func addEBObserverOf_knobSize (_ inObserver : EBObserverProtocol) {
    self.addEBObserver (inObserver)
  ...
  final func removeEBObserverOf_knobSize (_ inObserver : EBObserverProtocol) {
    self.removeEBObserver (inObserver)
  ...
  final func addEBObserversOf_knobSize_toElementsOfSet (_ inSet : EBReferenceSet <PackageObject>) {
    for managedObject in inSet.values {
      for (_, entry) in self.mObserversOf_knobSize.dictionary {
        if let observer = entry.possibleObserver {
          managedObject.knobSize_property.addEBObserver (observer)
        }else{
          self.mObserversOf_knobSize.triggerPacking ()
        }
      }
    }
  }
  ...
  final func removeEBObserversOf_knobSize_fromElementsOfSet (_ inSet : EBReferenceSet <PackageObject>) {
    for managedObject in inSet.values {
      for (_, entry) in self.mObserversOf_knobSize.dictionary {
        if let observer = entry.possibleObserver {
...
final class TransientArrayOf_PackageObject : ReadOnlyArrayOf_PackageObject {
  ...
  private final func computeModelArray () {
    if self.mModelArrayShouldBeComputed {
      ...
      let newArray : EBReferenceArray <PackageObject>
  ...
  override var propval : EBReferenceArray <PackageObject> {
    self.computeModelArray ()
...
final class TransientArrayOfSuperOf_PackageObject <SUPER : EBManagedObject> : ReadOnlyArrayOf_PackageObject {
  ...
  private final func computeModelArray () {
    if self.mModelArrayShouldBeComputed {
      ...
      var newArray = EBReferenceArray <PackageObject> ()
...
final class ProxyArrayOf_PackageObject : ReadWriteArrayOf_PackageObject {
  ...
  override func notifyModelDidChange () {
    let newModelArray : EBReferenceArray <PackageObject>
    if let model = self.mModel {
      switch model.selection {
      case .empty :
        newModelArray = EBReferenceArray ()
      case .single (let v) :
        newModelArray = EBReferenceArray <PackageObject> (v)
      case .multiple :
        newModelArray = EBReferenceArray ()
      }
    }else{
  ...
  override func setProp (_ inArrayValue : EBReferenceArray <PackageObject>) {
...
class StoredArrayOf_PackageObject : ReadWriteArrayOf_PackageObject, EBSignatureObserverProtocol {
  ...
  override final var propval : EBReferenceArray <PackageObject> { return self.mInternalArrayValue }
...
final class StandAloneArrayOf_PackageObject : ReadWriteArrayOf_PackageObject {
  ...
  override var selection : EBSelection < [PackageObject] > { return .single (self.mInternalArrayValue.values) }
  ...
  override var propval : EBReferenceArray <PackageObject> { return self.mInternalArrayValue }
  ...
  init (prefKey : String) {
    ...
    if let array = UserDefaults.standard.array (forKey: prefKey) as? [NSDictionary] {
      ...
      for dictionary in array {
        let object = newInstanceOfEntityNamed (self.undoManager, "PackageObject") as! PackageObject
