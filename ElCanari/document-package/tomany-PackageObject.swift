...
class ReadOnlyArrayOf_PackageObject : EBReadOnlyAbstractArrayProperty <PackageObject> {
  ...
  final func toMany_knobSize_StartsBeingObserved (by inObserver : any EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_knobSize_StopsBeingObserved (by inObserver : any EBObserverProtocol) {
...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: PackageObject
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_PackageObject : ReadWriteArrayOf_PackageObject { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
...
/*  private final class MyPrivateUndoer : NSObject { // For Swift 6
    let mOldValue : EBReferenceArray <PackageObject>

    init (_ inOldValue : EBReferenceArray <PackageObject>) {
...
//  }
  ...
  override final var selection : EBSelection < [PackageObject] > {
    return .single (self.mInternalArrayValue.values)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  override func setProp (_ inValue : EBReferenceArray <PackageObject>) {
    self.mInternalArrayValue = inValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override var propval : EBReferenceArray <PackageObject> {
    return self.mInternalArrayValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final func remove (_ inObject : PackageObject) {
  ...
  final func add (_ inObject : PackageObject) {
...
class StoredArrayOf_PackageObject : StandAloneArrayOf_PackageObject, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
