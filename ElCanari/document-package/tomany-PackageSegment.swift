...
class ReadOnlyArrayOf_PackageSegment : ReadOnlyAbstractArrayProperty <PackageSegment> {
  ...
  final func addEBObserverOf_lengthUnit (_ inObserver : EBEvent, postEvent inPostEvent : Bool) {
    self.addEBObserver (inObserver)
    ...
    case .single (let v) :
      for managedObject in v {
        managedObject.lengthUnit_property.addEBObserver (inObserver, postEvent: inPostEvent)
      }
    }
  }
  ...
  final func addEBObserverOf_lengthInCanariUnit (_ inObserver : EBEvent, postEvent inPostEvent : Bool) {
    self.addEBObserver (inObserver)
    ...
    case .single (let v) :
      for managedObject in v {
        managedObject.lengthInCanariUnit_property.addEBObserver (inObserver, postEvent: inPostEvent)
      }
    }
  }
...
final class PreferencesArrayOf_PackageSegment : StoredArrayOf_PackageSegment {
  ...
  init (prefKey : String) {
    ...
    self.addEBObserverOf_lengthUnit (self.mObserverForWritingPreferences, postEvent: true)
