...
class ReadOnlyArrayOf_PackageSlavePad : EBReadOnlyAbstractArrayProperty <PackageSlavePad> {
  ...
  final func toMany_masterPadNameWithZoneName_StartsBeingObserved (by inObserver : any EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_masterPadNameWithZoneName_StopsBeingObserved (by inObserver : any EBObserverProtocol) {
...
/*  private final class MyPrivateUndoer : NSObject { // For Swift 6
    let mOldValue : EBReferenceArray <PackageSlavePad>

    init (_ inOldValue : EBReferenceArray <PackageSlavePad>) {
