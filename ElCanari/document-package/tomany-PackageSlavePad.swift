...
//    self.undoManager?.registerUndo < EBReferenceArray <PackageSlavePad> > (withTarget: self) {
//      DispatchQueue.main.async {
...
//    }
  ...
  final override var propval : EBReferenceArray <PackageSlavePad> { return self.mInternalArrayValue }
