...
class ReadOnlyArrayOf_PackageSlavePad : EBReadOnlyAbstractArrayProperty <PackageSlavePad> {
  ...
  //--- Remove observers from removed objects
    for managedObject in inRemovedSet.values {
      ...
      if let relay = self.mObserversOf_masterPadNameWithZoneName { // Transient property
        managedObject.masterPadNameWithZoneName_property.stopsBeingObserved (by: relay)
      }
  ...
  //--- Add observers to added objects
    for managedObject in inAddedSet.values {
      ...
      if let relay = self.mObserversOf_masterPadNameWithZoneName { // Transient property
        managedObject.masterPadNameWithZoneName_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_padNameForDisplay { // Transient property
  ...
  private final var mObserversOf_masterPadNameWithZoneName : EBObservedObserver? = nil

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final func toMany_masterPadNameWithZoneName_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
    if let r = self.mObserversOf_masterPadNameWithZoneName {
      relay = r
    }else{
      relay = EBObservedObserver ()
      self.startsBeingObserved (by: relay)
      ...
      self.mObserversOf_masterPadNameWithZoneName = relay
    }
    relay.startsBeingObserved (by:  inObserver)
  }
  ...
  final func toMany_masterPadNameWithZoneName_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
    self.mObserversOf_masterPadNameWithZoneName?.stopsBeingObserved (by: inObserver)
  }
...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: PackageSlavePad
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_PackageSlavePad : ReadWriteArrayOf_PackageSlavePad { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
  ...
  override final var selection : EBSelection < [PackageSlavePad] > {
    return .single (self.mInternalArrayValue.values)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  override func setProp (_ inValue : EBReferenceArray <PackageSlavePad>) {
    self.mInternalArrayValue = inValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override var propval : EBReferenceArray <PackageSlavePad> {
    return self.mInternalArrayValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final func remove (_ inObject : PackageSlavePad) {
  ...
  final func add (_ inObject : PackageSlavePad) {
...
class StoredArrayOf_PackageSlavePad : StandAloneArrayOf_PackageSlavePad, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
