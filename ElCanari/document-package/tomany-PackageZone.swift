...
class ReadOnlyArrayOf_PackageZone : EBReadOnlyAbstractArrayProperty <PackageZone> {
  ...
  final func toMany_x_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_y_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_y_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_xUnit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_xUnit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_yUnit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_yUnit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_displayZoneName_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_displayZoneName_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_displayZoneNameWithPadNumbers_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_displayZoneNameWithPadNumbers_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_xName_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_xName_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_yName_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_yName_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_xNameUnit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_xNameUnit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_yNameUnit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_yNameUnit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_zoneNumbering_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_zoneNumbering_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_rect_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_rect_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_forbiddenPadArray_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_forbiddenPadArray_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_emptyForbiddenPadArray_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_emptyForbiddenPadArray_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: PackageZone
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_PackageZone : ReadWriteArrayOf_PackageZone { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
  ...
  override final var selection : EBSelection < [PackageZone] > {
    return .single (self.mInternalArrayValue.values)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  override func setProp (_ inValue : EBReferenceArray <PackageZone>) {
    self.mInternalArrayValue = inValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override var propval : EBReferenceArray <PackageZone> {
    return self.mInternalArrayValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final func remove (_ inObject : PackageZone) {
  ...
  final func add (_ inObject : PackageZone) {
...
class StoredArrayOf_PackageZone : StandAloneArrayOf_PackageZone, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
