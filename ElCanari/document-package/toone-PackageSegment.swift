...
class ReadOnlyObject_PackageSegment : ReadOnlyAbstractObjectProperty <PackageSegment> {
  ...
  //--- Remove observers from removed objects
    ...
    inOldValue?.lengthUnit_property.removeEBObserver (self.lengthUnit_property) // Stored property
    ...
    inOldValue?.lengthInCanariUnit_property.removeEBObserver (self.lengthInCanariUnit_property) // Transient property
  //--- Add observers to added objects
    ...
    self.mInternalValue?.lengthUnit_property.addEBObserver (self.lengthUnit_property) // Stored property
    ...
    self.mInternalValue?.lengthInCanariUnit_property.addEBObserver (self.lengthInCanariUnit_property) // Transient property
  }
  ...
  override init () {
    ...
    self.lengthUnit_property.mReadModelFunction = { [weak self] in self?.mInternalValue?.lengthUnit_property.prop ?? .empty }
    self.lengthUnit_property.mWriteModelFunction = { [weak self] (inValue : Int) in self?.mInternalValue?.lengthUnit_property.setProp (inValue) }
    ...
    self.lengthInCanariUnit_property.mReadModelFunction = { [weak self] in self?.mInternalValue?.lengthInCanariUnit_property.prop ?? .empty }
  }
