...
//--- START OF USER ZONE 2
    ...
    shape.addKnob (at: CGPoint (x: x + width / 2.0, y: y), knobIndex: PACKAGE_ZONE_BOTTOM, .circ, 2.0)
    shape.addKnob (at: CGPoint (x: x, y: y + height / 2.0), knobIndex: PACKAGE_ZONE_LEFT, .circ, 2.0)
    shape.addKnob (at: CGPoint (x: x + width / 2.0, y: y + height), knobIndex: PACKAGE_ZONE_TOP, .circ, 2.0)
    shape.addKnob (at: CGPoint (x: x + width, y: y + height / 2.0), knobIndex: PACKAGE_ZONE_RIGHT, .circ, 2.0)
  //--- Zone
