...
//--------------------------------------------------------------------------------------------------
//    Array controller AutoLayoutProjectDocument boardObjectsController
//--------------------------------------------------------------------------------------------------

final class Controller_AutoLayoutProjectDocument_boardObjectsController : EBReadOnlyAbstractGenericRelationshipProperty, EBGraphicViewControllerProtocol, HiddenEBProtocol {
  ...
  var selectedArray : EBReferenceArray <BoardObject> { return self.selectedArray_property.propval }
  ...
  func select (object inObject : BoardObject) {
  ...
  @objc func remove (_ _ : Any) {
    if let model = self.mModel {
      ...
      //--- Find the first index of a non selected object
        ...
        var newSelectedObject : BoardObject? = nil
 ...
 // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  func sendToBack () {
    var objects = self.objectArray
    let sortedIndexArray = self.sortedIndexArrayOfSelectedObjects ()
    var newObjectArray = EBReferenceArray <BoardObject> ()
    for idx in sortedIndexArray.reversed () {
      let object = objects [idx]
      objects.remove (at: idx)
 ...
 // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  func addToSelection (objects inObjects : [BoardObject]) {
