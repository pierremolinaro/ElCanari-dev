...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//    Array controller AutoLayoutProjectDocument schematicObjectsController
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

final class Controller_AutoLayoutProjectDocument_schematicObjectsController : EBReadOnlyAbstractGenericRelationshipProperty, EBGraphicViewControllerProtocol, HiddenEBProtocol {
  ...
  var objects : EBReferenceArray <SchematicObject> {
  ...
  var selectedSet : EBReferenceSet <SchematicObject> {
    set {
  ...
  private var mPrivateSelectedSet = EBReferenceSet <SchematicObject> () {
    didSet {
  ...
  var selectedArray : EBReferenceArray <SchematicObject> { return self.selectedArray_property.propval }
  ...
  @objc func remove (_ _ : Any) {
    if let model = self.mModel {
      ...
      //--- Dictionary of object sorted indexes
        var sortedObjectDictionary = EBReferenceDictionary <SchematicObject, Int> ()
      ...
      //--- Dictionary of object absolute indexes
        var objectDictionary = EBReferenceDictionary <SchematicObject, Int> ()
        for (index, object) in model_prop.enumerated () {
      ...
      //----------------------------------------- Set new selection
        var newSelectionSet = EBReferenceSet <SchematicObject> ()
 ...
 //····················································································································
  ...
  func sendToBack () {
    var objects = self.objectArray
    let sortedIndexArray = self.sortedIndexArrayOfSelectedObjects ()
    var newObjectArray = EBReferenceArray <SchematicObject> ()
    for idx in sortedIndexArray.reversed () {
      let object = objects [idx]
      objects.remove (at: idx)
 ...
 //····················································································································
  ...
  func addToSelection (objects inObjects : [SchematicObject]) {
