...
final class Controller_AutoLayoutProjectDocument_projectFontController : NSObject, AutoLayoutTableViewDelegate {
  ...
  private weak var mModel : ReadWriteArrayOf_FontInProject? = nil // SHOULD BE WEAK
  ...
  final func select (object inObject: FontInProject) {
    if let model = self.mModel {
