...
self.configure_boardOperationPullDownButtonConfigurator (toTopHStack) // Configurator
 ...
 ; return right } ())
  ...
  final func RestrictRectangleInspectorView () -> AutoLayoutVerticalStackView {
    ...
    _ = vStackView.appendView (view_2)
    let view_3 = AutoLayoutGridView2 ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Left", bold: false, size: .small, alignment: .left)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
  .bind_dimensionAndUnit (self.restrictRectSelController.mX_property, self.restrictRectSelController.mXUnit_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Bottom", bold: false, size: .small, alignment: .left)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
  .bind_dimensionAndUnit (self.restrictRectSelController.mY_property, self.restrictRectSelController.mYUnit_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Width", bold: false, size: .small, alignment: .left)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
  .bind_dimensionAndUnit (self.restrictRectSelController.mWidth_property, self.restrictRectSelController.mWidthUnit_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Height", bold: false, size: .small, alignment: .left)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
 ...
 ; return right } ())
  ...
  final func BoardImageInspectorView () -> AutoLayoutVerticalStackView {
    ...
    _ = vStackView.appendView (view_2)
    let view_3 = AutoLayoutGridView2 ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Image Data", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .set (alignment: .left)
  .bind_title (self.boardImageSelectionController.imageDataByteCount_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Image Width", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .set (alignment: .left)
  .bind_title (self.boardImageSelectionController.boardOriginalImageWidth_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Image Height", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .set (alignment: .left)
  .bind_title (self.boardImageSelectionController.boardOriginalImageHeight_property)
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Scale", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutDoubleField (width: 64, size: .small)
  .bind_value (self.boardImageSelectionController.mScale_property, sendContinously:false)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Scaled Image Width", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .set (alignment: .left)
  .bind_title (self.boardImageSelectionController.boardScaledImageWidth_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Scaled Image Height", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .set (alignment: .left)
  .bind_title (self.boardImageSelectionController.boardScaledImageHeight_property)
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Threshold", bold: false, size: .small, alignment: .right)
 ...
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Pixel Size", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Actual Image Width", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariObservedDimensionAndPopUp (size: .small)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Actual Image Height", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariObservedDimensionAndPopUp (size: .small)
 ...
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Layer", bold: false, size: .small, alignment: .right)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Center X", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Center Y", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
 ...
 ; return right } ())
  ...
  final func BoardQRCodeInspectorView () -> AutoLayoutVerticalStackView {
    ...
    _ = vStackView.appendView (view_2)
    let view_3 = AutoLayoutGridView2 ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Correction Level", bold: false, size: .small, alignment: .right)
 ...
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Module Count", bold: false, size: .small, alignment: .right)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Module Size", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Actual Image Size", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariObservedDimensionAndPopUp (size: .small)
