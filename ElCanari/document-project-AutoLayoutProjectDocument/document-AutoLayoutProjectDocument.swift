...
do{
 ...
 ; return right } ())
        .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Display", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutEnumPopUpButton (titles: GridStyle.popupTitles (), size: .small)
 ...
 ; return right } ())
        .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Cross Grid", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .expandableWidth ()
  .set (toolTip: "Stored in Preferences")
  .bind_color (preferences_crossColorGridForBoard_property)
 ; return right } ())
        .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Line Grid", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .expandableWidth ()
  .set (toolTip: "Stored in Preferences")
 ...
 ; return single } ())
  ...
  .set (margins: .zero)
do{
  let single_0 = AutoLayoutDisclosureTriangle (size: .small)
    .bind_expanded (self.rootObject.mExpandFrontSideBoardSettings_property)
  _ = single.appendView (single_0)
  let single_1 = AutoLayoutStaticLabel (title: "Front side Display", bold: true, size: .small, alignment: .left)
  _ = single.appendView (single_1)
}
 ; return single } ())
        .add (left: { () -> NSView in let left = AutoLayoutHorizontalStackView ()
...
do{
  ...
  _ = single.appendView (single_0)
  let single_1 = AutoLayoutStaticLabel (title: "Back Side Display", bold: true, size: .small, alignment: .left)
  _ = single.appendView (single_1)
}
 ; return single } ())
        .add (left: { () -> NSView in let left = AutoLayoutHorizontalStackView ()
...
do{
  ...
  _ = single.appendView (single_0)
  let single_1 = AutoLayoutStaticLabel (title: "Inner 1 Layer Display", bold: true, size: .small, alignment: .left)
  _ = single.appendView (single_1)
}
 ; return single } ())
        .add (left: { () -> NSView in let left = AutoLayoutHorizontalStackView ()
...
do{
  ...
  _ = single.appendView (single_0)
  let single_1 = AutoLayoutStaticLabel (title: "Inner 2 Layer Display", bold: true, size: .small, alignment: .left)
  _ = single.appendView (single_1)
}
 ; return single } ())
        .add (left: { () -> NSView in let left = AutoLayoutHorizontalStackView ()
...
do{
  ...
  _ = single.appendView (single_0)
  let single_1 = AutoLayoutStaticLabel (title: "Inner 3 Layer Display", bold: true, size: .small, alignment: .left)
  _ = single.appendView (single_1)
}
 ; return single } ())
        .add (left: { () -> NSView in let left = AutoLayoutHorizontalStackView ()
...
do{
  ...
  _ = single.appendView (single_0)
  let single_1 = AutoLayoutStaticLabel (title: "Inner 4 Layer Display", bold: true, size: .small, alignment: .left)
  _ = single.appendView (single_1)
}
 ; return single } ())
        .add (left: { () -> NSView in let left = AutoLayoutHorizontalStackView ()
...
do{
  ...
  _ = single.appendView (single_0)
  let single_1 = AutoLayoutStaticLabel (title: "Other", bold: true, size: .small, alignment: .left)
  _ = single.appendView (single_1)
}
 ; return single } ())
        .add (left: { () -> NSView in let left = AutoLayoutHorizontalStackView ()
