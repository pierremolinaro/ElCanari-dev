...
@objc(AutoLayoutProjectDocument) class AutoLayoutProjectDocument : AutoLayoutProjectDocumentSuperClass {
  ...
  private final func computeImplicitView_263 () -> NSView {
    let view = AutoLayoutStaticLabel (title: "Min Width", bold: false, size: .small, alignment: .right)
    return view
  }
  ...
  private final func computeImplicitView_264 () -> NSView {
    let view = AutoLayoutCanariObservedDimensionAndPopUp (size: .small)
      .bind_dimensionAndUnit (self.boardQRCodeSelectionController.minWidthInCanariUnit_property, self.boardQRCodeSelectionController.mMinWidthUnit_property)
    return view
  }
  ...
  private final func computeImplicitView_265 () -> NSView {
    let view = AutoLayoutStaticLabel (title: "Min Height", bold: false, size: .small, alignment: .right)
    return view
  }
  ...
  private final func computeImplicitView_266 () -> NSView {
    let view = AutoLayoutCanariObservedDimensionAndPopUp (size: .small)
      .bind_dimensionAndUnit (self.boardQRCodeSelectionController.minHeightInCanariUnit_property, self.boardQRCodeSelectionController.mMinHeightUnit_property)
    return view
  }
