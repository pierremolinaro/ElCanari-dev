...
self.configure_sheetPopUpButtonConfigurator2 (toTopHStack) // Configurator
 ; return toTopHStack } ())
  ...
  .set (margins: .regular)
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Grid Step", bold: false, size: .small, alignment: .center)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutStaticLabel (title: "50 mils", bold: true, size: .small, alignment: .center)
 ; return right } ())
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Display Grid", bold: false, size: .small, alignment: .center)
 ...
 ; return right } ())
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Every", bold: false, size: .small, alignment: .center)
 ...
 ; return right } ())
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Cross Grid Color", bold: false, size: .small, alignment: .center)
...
do{
 ...
 ; return right } ())
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Line Grid Color", bold: false, size: .small, alignment: .center)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutHorizontalStackView ()
do{
  let right_0 = AutoLayoutColorWell ()
    .set (toolTip: "Stored in Preferences")
 ...
 ; return contentView } ())
  ...
  .set (margins: .regular)
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Symbols, unplaced Component", bold: false, size: .small, alignment: .center)
 ...
 ; return right } ())
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Symbols, placed Component", bold: false, size: .small, alignment: .center)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .set (toolTip: "Stored in Preferences")
...
do{
 ...
 ; return single } ())
  .addSeparator ()
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Component Name", bold: false, size: .small, alignment: .center)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .set (toolTip: "Stored in Preferences")
 ...
 ; return single } ())
  .addSeparator ()
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Component Value", bold: false, size: .small, alignment: .center)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .set (toolTip: "Stored in Preferences")
 ...
 ; return single } ())
  .addSeparator ()
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Pin Number", bold: false, size: .small, alignment: .center)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .set (toolTip: "Stored in Preferences")
 ...
 ; return single } ())
  .addSeparator ()
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Connection", bold: false, size: .small, alignment: .center)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .set (toolTip: "Stored in Preferences")
  .bind_color (preferences_connectionColorForSchematic_property)
 ; return right } ())
  .addSeparator ()
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Background Color", bold: false, size: .small, alignment: .center)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .set (toolTip: "Stored in Preferences")
  .bind_color (preferences_schematicBackColor_property)
 ; return right } ())
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Frame Color", bold: false, size: .small, alignment: .center)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .set (toolTip: "Stored in Preferences")
