...
self.configure_sheetPopUpButtonConfigurator2 (toTopHStack) // Configurator
 ...
 ; return left } (), right: { () -> NSView in let right = AutoLayoutStaticLabel (title: "50 mils", bold: true, size: .small, alignment: .left)
 ; return right } ())
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Display Grid", bold: false, size: .small, alignment: .right)
 ...
 ; return right } ())
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Every", bold: false, size: .small, alignment: .right)
 ...
 ; return right } ())
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Cross Grid Color", bold: false, size: .small, alignment: .right)
...
do{
 ...
 ; return right } ())
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Line Grid Color", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutHorizontalStackView ()
do{
  let right_0 = AutoLayoutColorWell ()
    .set (toolTip: "Stored in Preferences")
 ...
 ; return contentView } ())
  ...
  .set (margins: .regular)
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Symbols, unplaced Component", bold: false, size: .small, alignment: .right)
 ...
 ; return right } ())
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Symbols, placed Component", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .set (toolTip: "Stored in Preferences")
...
do{
  ...
  let single_1 = AutoLayoutStaticLabel (title: "Symbols Drawing Width", bold: false, size: .small, alignment: .right)
 ...
 ; return single } ())
  .addSeparator ()
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Component Name", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .set (toolTip: "Stored in Preferences")
 ...
 ; return single } ())
  .addSeparator ()
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Component Value", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .set (toolTip: "Stored in Preferences")
 ...
 ; return single } ())
  .addSeparator ()
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Pin Name", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .set (toolTip: "Stored in Preferences")
 ...
 ; return single } ())
  .addSeparator ()
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Pin Number", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .set (toolTip: "Stored in Preferences")
 ...
 ; return single } ())
  .addSeparator ()
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Connection", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .set (toolTip: "Stored in Preferences")
  .bind_color (preferences_connectionColorForSchematic_property)
 ; return right } ())
  .addSeparator ()
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Background Color", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .set (toolTip: "Stored in Preferences")
  .bind_color (preferences_schematicBackColor_property)
 ; return right } ())
  .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Frame Color", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .set (toolTip: "Stored in Preferences")
 ...
 ; return contentView } ())
  ...
  final func schematicsSheetInspectorView () -> AutoLayoutVerticalStackView {
    ...
    let view_8 = AutoLayoutGridView2 ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Title", bold: false, size: .small, alignment: .right)
  .expandableHeight ()
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Version", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutTextField (minWidth: 150, size: .small)
  .bind_value (self.rootObject.mSchematicVersion_property, sendContinously:true)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Date", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutHorizontalStackView ()
do{
 ...
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Size", bold: false, size: .small, alignment: .right)
...
self.configure_sheetOrientationSegmentedControlConfigurator (right) // Configurator
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Width", bold: false, size: .small, alignment: .center)
 ...
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
  ...
  .bind_hidden (.not (.prop (self.schematicSheetOrientationIsCustom_property)))
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Height", bold: false, size: .small, alignment: .center)
  .bind_hidden (.not (.prop (self.schematicSheetOrientationIsCustom_property)))
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
 ...
 ; return right } ())
  ...
  final func commentInSchematicsInspectorView () -> AutoLayoutVerticalStackView {
    ...
    let view_3 = AutoLayoutGridView2 ()
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Color", bold: true, size: .small, alignment: .left)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutColorWell ()
  .bind_color (self.commentInSchematicSelectionController.mColor_property)
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Rotation", bold: true, size: .small, alignment: .left)
 ...
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Size", bold: true, size: .small, alignment: .left)
 ...
 ; return right } ())
    ...
    let view_5 = AutoLayoutVerticalStackView.HorizontalSeparator ()
    _ = vStackView.appendView (view_5)
    let view_6 = AutoLayoutStaticLabel (title: "Alignment", bold: true, size: .small, alignment: .left)
    _ = vStackView.appendView (view_6)
    let view_7 = AutoLayoutEnumSegmentedControl (titles: HorizontalAlignment.popupTitles (), equalWidth: true, size: .small)
      .bind_selectedSegment (self.commentInSchematicSelectionController.mHorizontalAlignment_property)
    self.configure_labelHAlignmentSegmendControlConfigurator (view_7) // Configurator
    _ = vStackView.appendView (view_7)
    let view_8 = AutoLayoutEnumSegmentedControl (titles: VerticalAlignment.popupTitles (), equalWidth: true, size: .small)
      .bind_selectedSegment (self.commentInSchematicSelectionController.mVerticalAlignment_property)
    self.configure_labelVAlignmentSegmendControlConfigurator (view_8) // Configurator
    _ = vStackView.appendView (view_8)
    return vStackView
  }
  ...
  final func componentSymbolInspectorView () -> AutoLayoutVerticalStackView {
    ...
    let view_1 = AutoLayoutGridView2 ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Orientation", bold: false, size: .small, alignment: .center)
...
self.configure_boardOperationPullDownButtonConfigurator (toTopHStack) // Configurator
 ; return toTopHStack } ())
  ...
  final func BoardTrackInspectorView () -> AutoLayoutVerticalStackView {
    ...
    _ = vStackView.appendView (view_0)
    let view_1 = AutoLayoutGridView2 ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Net Name", bold: false, size: .small, alignment: .left)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Net Class Name", bold: false, size: .small, alignment: .left)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .set (alignment: .left)
  .expandableWidth ()
  .bind_title (self.boardTrackSelectionController.netClassName_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Side", bold: false, size: .small, alignment: .left)
 ...
 ; return single } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "On Knob Dragging", bold: false, size: .small, alignment: .left)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Track Angle", bold: false, size: .small, alignment: .left)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariAngleFieldAndSlider (fieldMinWidth: 64, size: .small)
  .bind_angle (self.boardTrackSelectionController.trackDirectionInDegrees_property)
 ...
 ; return single } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Track Width", bold: false, size: .small, alignment: .left)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "From Net Class", bold: false, size: .small, alignment: .left)
 ...
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariObservedDimensionAndPopUp (size: .small)
  ...
  .bind_hidden (.prop (self.boardTrackSelectionController.mUsesCustomTrackWidth_property))
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Custom Width", bold: false, size: .small, alignment: .left)
 ...
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
  ...
  .bind_hidden (.not (.prop (self.boardTrackSelectionController.mUsesCustomTrackWidth_property)))
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "End Style", bold: false, size: .small, alignment: .left)
 ...
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabels (left: "P1", right: "X", bold: false, size: .small)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
 ...
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
  ...
  .bind_enabled (.prop (self.boardTrackSelectionController.p1CanMove_property))
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabels (left: "P2", right: "X", bold: false, size: .small)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
 ...
 ; return right } ())
  ...
  final func BoardConnectorInspectorView () -> AutoLayoutVerticalStackView {
    ...
    _ = vStackView.appendView (view_0)
    let view_1 = AutoLayoutGridView2 ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Net Name", bold: false, size: .small, alignment: .center)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .set (alignment: .left)
  .expandableWidth ()
  .bind_title (self.boardConnectorSelectionController.netNameFromTracks_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Net Class Name", bold: false, size: .small, alignment: .center)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .set (alignment: .left)
  .expandableWidth ()
 ...
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Hole Diameter", bold: false, size: .small, alignment: .left)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCheckbox (title: "Use Custom", size: .small)
  .bind_value (self.boardConnectorSelectionController.mUsesCustomHoleDiameter_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "From Net Class", bold: false, size: .small, alignment: .center)
 ...
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariObservedDimensionAndPopUp (size: .small)
  ...
  .bind_hidden (.prop (self.boardConnectorSelectionController.mUsesCustomHoleDiameter_property))
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Custom", bold: false, size: .small, alignment: .center)
 ...
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Pad Diameter", bold: false, size: .small, alignment: .left)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCheckbox (title: "Use Custom", size: .small)
 ...
 ; return right } ())
  ...
  final func BoardTextInspectorView () -> AutoLayoutVerticalStackView {
    ...
    let view_2 = AutoLayoutGridView2 ()
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabels (left: "Origin", right: "X", bold: false, size: .small)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
 ...
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Font", bold: false, size: .small, alignment: .right)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Weight", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutDoubleField (width: 64, size: .small)
 ...
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Horizontal", bold: false, size: .small, alignment: .right)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Vertical", bold: false, size: .small, alignment: .right)
 ...
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Rotation", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariAngleFieldAndSlider (fieldMinWidth: 64, size: .small)
  .bind_angle (self.boardTextSelectionController.mRotation_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Side", bold: false, size: .small, alignment: .right)
 ...
 ; return single } ())
  ...
  final func ArtworkDescriptionPage () -> AutoLayoutVerticalStackView {
    ...
    let view_0 = AutoLayoutGridView2 ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Layer Description", bold: false, size: .regular, alignment: .center)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Artwork Version", bold: false, size: .regular, alignment: .center)
...
do{
  ...
  private final func computeImplicitView_1 () -> NSView {
    ...
    do{
      ...
      let view_5 = AutoLayoutGridView2 ()
        .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Board Limit Width", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
  .bind_dimensionAndUnit (self.rootObject.mBoardLimitsWidth_property, self.rootObject.mBoardLimitsWidthUnit_property)
 ; return right } ())
        .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Board Clearance", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
 ...
 ; return right } ())
      ...
      let view_14 = AutoLayoutHorizontalStackView ()
      do{
        let view_14_0 = AutoLayoutStaticLabel (title: "Grid Step", bold: false, size: .small, alignment: .right)
        _ = view_14.appendView (view_14_0)
        let view_14_1 = AutoLayoutHorizontalStackView.GutterSeparator ()
        _ = view_14.appendView (view_14_1)
        let view_14_2 = AutoLayoutCanariDimensionAndPopUp (size: .small)
      ...
      do{
        let view_15_0 = AutoLayoutStaticLabel (title: "Display Grid", bold: false, size: .small, alignment: .right)
        _ = view_15.appendView (view_15_0)
        let view_15_1 = AutoLayoutHorizontalStackView.GutterSeparator ()
        _ = view_15.appendView (view_15_1)
        let view_15_2 = AutoLayoutEnumPopUpButton (titles: GridStyle.popupTitles (), size: .small)
          .expandableWidth ()
      ...
      let view_16 = AutoLayoutHorizontalStackView ()
      do{
        let view_16_0 = AutoLayoutStaticLabel (title: "Grid Display", bold: false, size: .small, alignment: .right)
        _ = view_16.appendView (view_16_0)
        let view_16_1 = AutoLayoutHorizontalStackView.GutterSeparator ()
        _ = view_16.appendView (view_16_1)
        let view_16_2 = AutoLayoutTaggedPopUpButton (size: .small)
          .expandableWidth ()
          .add (title: "1 Step", withTag: 1)
          .add (title: "2 Steps", withTag: 2)
          .add (title: "4 Steps", withTag: 4)
      ...
      let view_17 = AutoLayoutHorizontalStackView ()
      do{
        let view_17_0 = AutoLayoutStaticLabel (title: "Flip", bold: false, size: .small, alignment: .right)
        _ = view_17.appendView (view_17_0)
        let view_17_1 = AutoLayoutHorizontalStackView.GutterSeparator ()
        _ = view_17.appendView (view_17_1)
        let view_17_2 = AutoLayoutCheckbox (title: "Horizontal", size: .small)
          .expandableWidth ()
      ...
      let view_18 = AutoLayoutHorizontalStackView ()
      do{
        let view_18_0 = AutoLayoutFlexibleSpace ()
        _ = view_18.appendView (view_18_0)
        let view_18_1 = AutoLayoutHorizontalStackView.GutterSeparator ()
        _ = view_18.appendView (view_18_1)
        let view_18_2 = AutoLayoutCheckbox (title: "Vertical", size: .small)
          .expandableWidth ()
      ...
      let view_20 = AutoLayoutStaticLabel (title: "Board Contents Opacity", bold: true, size: .small, alignment: .center)
      _ = view.appendView (view_20)
      let view_21 = AutoLayoutLinearSlider (min: 0, max: 1, ticks: 11)
        .bind_doubleValue (self.rootObject.mContentOpacityInBoardOutline_property, sendContinously:true)
      _ = view.appendView (view_21)
      let view_22 = AutoLayoutStaticLabels (left: "Transparent", right: "Opaque", bold: false, size: .mini)
  ...
  private final func computeImplicitView_3 () -> NSView {
    let view = AutoLayoutGridView2 ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Layers", bold: false, size: .small, alignment: .right)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Clearance", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
...
do{
 ...
 ; return single } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Top Layer Tracks", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .bind_title (self.rootObject.topSideTrackCountString_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Inner 1 Layer Tracks", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .bind_title (self.rootObject.inner1LayerTrackCountString_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Inner 2 Layer Tracks", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .bind_title (self.rootObject.inner2LayerTrackCountString_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Inner 3 Layer Tracks", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .bind_title (self.rootObject.inner3LayerTrackCountString_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Inner 4 Layer Tracks", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .bind_title (self.rootObject.inner4LayerTrackCountString_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Back Layer Tracks", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .bind_title (self.rootObject.backSideTrackCountString_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Total", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .bind_title (self.rootObject.trackCountString_property)
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Trace Length", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutHorizontalStackView ()
do{
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Via Count", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
...
self.configure_componentPackagePopUpButtonConfigurator (single) // Configurator
 ...
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Name", bold: true, size: .small, alignment: .left)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutLabel (bold: true, size: .small)
  .set (alignment: .left)
 ...
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Value", bold: true, size: .small, alignment: .left)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutTextField (minWidth: 150, size: .small)
  .automaticallyAdjustHeight (maxWidth: 150)
 ...
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Slave Pads", bold: true, size: .small, alignment: .left)
 ...
 ; return right } ())
      .addSeparator ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Side", bold: true, size: .small, alignment: .left)
