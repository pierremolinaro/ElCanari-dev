...
self.configure_sheetOrientationSegmentedControlConfigurator (right) // Configurator
 ...
 ; return right } ())
  ...
  final func BoardRectangularOutlineView () -> AutoLayoutVerticalStackView {
    ...
    let view_0 = AutoLayoutGridView2 ()
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Board Width", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Board Height", bold: false, size: .small, alignment: .right)
 ; return left } (), right: { () -> NSView in let right = AutoLayoutCanariDimensionAndPopUp (size: .small)
 ...
 ; return single } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Shape", bold: true, size: .small, alignment: .left)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "End Points", bold: true, size: .small, alignment: .left)
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutHorizontalStackView ()
do{
...
do{
 ...
 ; return right } ())
      .add (left: { () -> NSView in let left = AutoLayoutStaticLabel (title: "Control Points", bold: true, size: .small, alignment: .left)
