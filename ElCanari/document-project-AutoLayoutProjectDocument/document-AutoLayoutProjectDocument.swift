...
@objc(AutoLayoutProjectDocument) class AutoLayoutProjectDocument : EBAutoLayoutManagedDocument, NSToolbarDelegate {
  ...
  lazy var mSchematicsSheetInspectorView : AutoLayoutVerticalStackView = {
    ...
    let view_0 = AutoLayoutGridView2 ()
      .add (single: self.computeImplicitView_39 ())
    vStackView.appendView (view_0)
    return vStackView
  } ()
  ...
  lazy var mBoardBezierPathOutlineView : AutoLayoutVerticalStackView = {
    ...
    vStackView.appendView (view_0)
    let view_1 = AutoLayoutGridView2 ()
      .add (single: self.computeImplicitView_58 ())
  ...
  lazy var mBoardDisplayInspectorView : AutoLayoutVerticalStackView = {
    let vStackView = AutoLayoutVerticalStackView ()
      .set (margins: 8)
      .set (rightMargin: 0)
    let view_0 = AutoLayoutVerticalScrollView (content: self.computeImplicitView_133 ())
    vStackView.appendView (view_0)
  ...
  lazy var mComponentInBoardInspectorView : AutoLayoutVerticalStackView = {
    ...
    let view_1 = AutoLayoutGridView2 ()
      ...
      .add (single: self.computeImplicitView_253 ())
  ...
  lazy var mArtworkDescriptionPage : AutoLayoutVerticalStackView = {
    ...
    let view_0 = AutoLayoutGridView2 ()
      ...
      .addCenterYAligned (left: self.computeImplicitView_282 (), right: self.computeImplicitView_283 ())
    vStackView.appendView (view_0)
    return vStackView
  } ()
  ...
  fileprivate final func computeImplicitView_39 () -> NSView {
    let view = AutoLayoutStaticLabel (title: "Sheet Inspector", bold: true, size: .small)
      .expandableWidth ()
      .set (alignment: .center)
    return view
  }
  ...
  fileprivate final func computeImplicitView_145 () -> NSView {
    let view = AutoLayoutTabView (equalWidth: true, size: .small)
      .addTab (title: "Basic", tooltip: "Autorouter Basic Configuration", contentView: self.computeImplicitView_143 ())
      .addTab (title: "Advanced", tooltip: "Autorouter Advanced Configuration", contentView: self.computeImplicitView_144 ())
