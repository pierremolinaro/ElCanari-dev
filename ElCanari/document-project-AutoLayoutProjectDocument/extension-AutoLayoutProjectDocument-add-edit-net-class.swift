  ...
  fileprivate func netClassEditionPanel (with inNetClass : NetClassInProject,
    ...
    //---
      ...
      do{
        ...
        _ = gridView.add (left: left, right: netClassNameTextField)
      }
    //---
    ...
    //--- Color
      ...
      do{
        ...
        _ = gridView.add (left: left, right: AutoLayoutHorizontalStackView.viewFollowedByFlexibleSpace (wireColorWell))
      }
    //---  Width
      ...
      do{
        ...
        _ = gridView.add (left: left, right: widthFields)
      }
    //---  Allow front track
      ...
      _ = gridView.add (left: AutoLayoutHorizontalStackView (), right: allowFrontTrackCheckBox)
    //---  Allow Inner 1 Layer
      ...
      _ = gridView.add (left: AutoLayoutHorizontalStackView (), right: allowInner1TrackCheckBox)
    //---  Allow Inner 2 Layer
      ...
      _ = gridView.add (left: AutoLayoutHorizontalStackView (), right: allowInner2TrackCheckBox)
    //---  Allow Inner 3 Layer
      ...
      _ = gridView.add (left: AutoLayoutHorizontalStackView (), right: allowInner3TrackCheckBox)
    //---  Allow Inner 4 Layer
      ...
      _ = gridView.add (left: AutoLayoutHorizontalStackView (), right: allowInner4TrackCheckBox)
    //---  Allow Back track
      ...
      _ = gridView.add (left: AutoLayoutHorizontalStackView (), right: allowBackTrackCheckBox)
    //--- Hole Diameter
      ...
      do{
        ...
        _ = gridView.add (left: left, right: holeDiameterFields)
      }
    //--- Pad Diameter
      ...
      do{
        ...
        _ = gridView.add (left: left, right: padDiameterFields)
      }
    //---
