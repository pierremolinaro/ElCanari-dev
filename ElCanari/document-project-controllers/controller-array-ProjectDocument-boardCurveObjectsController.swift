...
final class Controller_ProjectDocument_boardCurveObjectsController : ReadOnlyAbstractGenericRelationshipProperty, EBGraphicViewControllerProtocol, HiddenEBProtocol {
  ...
  var selectedArray_property_selection : EBSelection <[BorderCurve]> { return self.selectedArray_property.selection }
  ...
  final func bind_model (_ inModel : ReadWriteArrayOf_BorderCurve, _ inUndoManager : EBUndoManager?) {
    self.mModel = inModel
 ...
 //····················································································································
  ...
  func sendToBack () {
    var objects = self.objectArray
    let sortedIndexArray = self.sortedIndexArrayOfSelectedObjects ()
    var newObjectArray = [BorderCurve] ()
    for idx in sortedIndexArray.reversed () {
      let object = objects [idx]
      objects.remove (at: idx)
