...
final class Controller_ProjectDocument_boardObjectsController : ReadOnlyAbstractGenericRelationshipProperty, EBGraphicViewControllerProtocol {
  ...
  private let mInternalSelectedArrayProperty = StoredArrayOf_BoardObject ()
  ...
  var selectedArray_property_selection : EBSelection <[BoardObject]> { return self.selectedArray_property.prop }
