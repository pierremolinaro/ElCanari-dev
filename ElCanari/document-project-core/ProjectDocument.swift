...
@objc(ProjectDocument) class ProjectDocument : EBManagedXibDocument {
  ...
  //--------------------------- Install regular bindings
    ...
    self.mSchematicsView?.bind_gridLineColor (prefs_lineColorOfSymbolGrid_property)
    self.mSchematicsView?.bind_gridCrossColor (prefs_crossColorOfSymbolGrid_property)
    self.mSchematicsView?.bind_zoom (self.rootObject.mSchematicZoom_property)
    self.mSchematicsView?.bind_backColor (prefs_schematicBackColor_property)
    ...
    self.mBoardLimitsView?.bind_gridLineColor (prefs_lineColorGridForBoard_property)
    self.mBoardLimitsView?.bind_gridCrossColor (prefs_crossColorGridForBoard_property)
    self.mBoardLimitsView?.bind_zoom (self.rootObject.mBoardLimitsZoom_property)
    self.mBoardLimitsView?.bind_backColor (prefs_boardBackgroundColorForBoard_property)
    ...
    self.mBoardView?.bind_gridLineColor (prefs_lineColorGridForBoard_property)
    self.mBoardView?.bind_gridCrossColor (prefs_crossColorGridForBoard_property)
    self.mBoardView?.bind_zoom (self.rootObject.mBoardZoom_property)
    self.mBoardView?.bind_backColor (prefs_boardBackgroundColorForBoard_property)
    ...
    self.mShowRotationKnobInBoardSwitch?.bind_value (prefs_mShowRotationKnobInBoard_property)
    ...
    self.mDisplayFrontPadsSwitch?.bind_value (prefs_displayFrontPadsForBoard_property)
    self.mDisplayFrontPadsColorWell?.bind_color (prefs_frontSidePadColorForBoard_property, sendContinously:true)
    self.mDisplayBackPadsSwitch?.bind_value (prefs_displayBackPadsForBoard_property)
    self.mDisplayBackPadsColorWell?.bind_color (prefs_backSidePadColorForBoard_property, sendContinously:true)
    self.mDisplayPadNumbersSwitch?.bind_value (prefs_displayPadNumbersForBoard_property)
    self.mDisplayPadNumbersColorWell?.bind_color (prefs_padNumberColorForBoard_property, sendContinously:true)
    self.mDisplayFrontLegendSwitch?.bind_value (prefs_displayFrontLegendForBoard_property)
    self.mDisplayFrontLegendColorWell?.bind_color (prefs_frontSideLegendColorForBoard_property, sendContinously:true)
    self.mDisplayBackLegendSwitch?.bind_value (prefs_displayBackLegendForBoard_property)
    self.mDisplayBackLegendColorWell?.bind_color (prefs_backSideLegendColorForBoard_property, sendContinously:true)
    self.mDisplayFrontLayoutSwitch?.bind_value (prefs_displayFrontLayoutForBoard_property)
    self.mDisplayFrontLayoutColorWell?.bind_color (prefs_frontSideLayoutColorForBoard_property, sendContinously:true)
    self.mDisplayBackLayoutSwitch?.bind_value (prefs_displayBackLayoutForBoard_property)
    self.mDisplayBackLayoutColorWell?.bind_color (prefs_backSideLayoutColorForBoard_property, sendContinously:true)
    self.mDisplayFrontRestrictRectanglesSwitch?.bind_value (prefs_displayFrontRestrictRectangles_property)
    self.mDisplayFrontRestrictRectanglesColorWell?.bind_color (prefs_frontSideRestrictRectangleColorForBoard_property, sendContinously:true)
    self.mDisplayBackRestrictRectanglesSwitch?.bind_value (prefs_displayBackRestrictRectangles_property)
    self.mDisplayBackRestrictRectanglesColorWell?.bind_color (prefs_backSideRestrictRectangleColorForBoard_property, sendContinously:true)
    self.mDisplayBoardLimitsColorWell?.bind_color (prefs_boardLimitsColorForBoard_property, sendContinously:true)
    self.mDisplayBoardClearanceColorWell?.bind_color (prefs_boardClearanceColorForBoard_property, sendContinously:true)
    self.mBoardBackgroundColorWell?.bind_color (prefs_boardBackgroundColorForBoard_property, sendContinously:true)
