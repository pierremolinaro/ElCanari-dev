...
@objc(ProjectDocument) class ProjectDocument : EBManagedXibDocument {
  ...
  @IBOutlet var mSlavePadsShouldBeRoutedPopUpButton : CanariBoolPopUpButton? = nil
  ...
  var mController_mSlavePadsShouldBeRoutedPopUpButton_enabled : MultipleBindingController_enabled? = nil
  ...
  //--------------------------- Install regular bindings
    ...
    self.mSlavePadsShouldBeRoutedPopUpButton?.bind_value (self.componentInBoardSelectionController.mSlavePadsShouldBeRouted_property, file: #file, line: #line, item0:"should be insulated", item1:"should be routed")
