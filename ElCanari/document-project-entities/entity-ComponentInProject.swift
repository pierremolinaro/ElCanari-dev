...
class ComponentInProject : BoardObject,
  ...
  //--- Atomic property: selectionDisplay
    ...
    g_Preferences?.packageDrawingWidthMultpliedByTenForBoard_property.addEBObserver (self.selectionDisplay_property)
  ...
  //--- ToMany proxy: mPackages
    ...
    g_Preferences?.packageDrawingWidthMultpliedByTenForBoard_property.removeEBObserver (self.selectionDisplay_property)
