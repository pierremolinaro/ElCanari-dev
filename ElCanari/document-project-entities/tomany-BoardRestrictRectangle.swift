...
class ReadOnlyArrayOf_BoardRestrictRectangle : ReadOnlyAbstractArrayProperty <BoardRestrictRectangle> {
  ...
  final func addEBObserverOf_mIsInFrontLayer (_ inObserver : EBEvent, postEvent inPostEvent : Bool) {
    ...
    case .single (let v) :
      for managedObject in v {
        managedObject.mIsInFrontLayer_property.addEBObserver (inObserver, postEvent: inPostEvent)
      }
    }
  }
  ...
  final func addEBObserverOf_mIsInBackLayer (_ inObserver : EBEvent, postEvent inPostEvent : Bool) {
    ...
    case .single (let v) :
      for managedObject in v {
        managedObject.mIsInBackLayer_property.addEBObserver (inObserver, postEvent: inPostEvent)
      }
    }
  }
...
class TransientArrayOf_BoardRestrictRectangle : ReadOnlyArrayOf_BoardRestrictRectangle {
...
class TransientArrayOfSuperOf_BoardRestrictRectangle <SUPER : EBManagedObject> : ReadOnlyArrayOf_BoardRestrictRectangle {
...
class StoredArrayOf_BoardRestrictRectangle : ReadWriteArrayOf_BoardRestrictRectangle, EBSignatureObserverProtocol {
  ...
  override var prop : EBSelection < [BoardRestrictRectangle] > { return .single (self.mInternalArrayValue) }
...
final class PreferencesArrayOf_BoardRestrictRectangle : StoredArrayOf_BoardRestrictRectangle {
  ...
  init (prefKey : String) {
    ...
    self.addEBObserverOf_mIsInFrontLayer (self.mObserverForWritingPreferences, postEvent: true)
    self.addEBObserverOf_mIsInBackLayer (self.mObserverForWritingPreferences, postEvent: true)
