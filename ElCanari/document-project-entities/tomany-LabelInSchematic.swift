...
class ReadOnlyArrayOf_LabelInSchematic : ReadOnlyAbstractArrayProperty <LabelInSchematic> {
  ...
  final func addEBObserverOf_mOrientation (_ inObserver : EBEvent, postEvent inPostEvent : Bool) {
    ...
    case .single (let v) :
      for managedObject in v {
        managedObject.mOrientation_property.addEBObserver (inObserver, postEvent: inPostEvent)
      }
    }
  }
...
class TransientArrayOf_LabelInSchematic : ReadOnlyArrayOf_LabelInSchematic {
  ...
  override var propval : [LabelInSchematic] { self.computeModelArray() ; return self.mInternalArrayValue }
...
final class PreferencesArrayOf_LabelInSchematic : StoredArrayOf_LabelInSchematic {
  ...
  init (prefKey : String) {
    ...
    self.addEBObserverOf_mOrientation (self.mObserverForWritingPreferences, postEvent: true)
