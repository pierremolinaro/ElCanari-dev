...
class ReadOnlyArrayOf_SchematicObject : ReadOnlyAbstractArrayProperty <SchematicObject> {
  ...
  final func addEBObserverOf_isPlacedInSchematic (_ inObserver : EBEvent, postEvent inPostEvent : Bool) {
    self.addEBObserver (inObserver)
    ...
    case .single (let v) :
      for managedObject in v {
        managedObject.isPlacedInSchematic_property.addEBObserver (inObserver, postEvent: inPostEvent)
      }
    }
  }
...
class TransientArrayOf_SchematicObject : ReadOnlyArrayOf_SchematicObject {
  ...
  override var propval : [SchematicObject] { self.computeModelArray() ; return self.mInternalArrayValue }
