...
class StandAloneArrayOf_BoardConnector : ReadWriteArrayOf_BoardConnector { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
