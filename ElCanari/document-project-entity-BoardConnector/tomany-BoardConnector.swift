...
//    self.undoManager?.registerUndo < EBReferenceArray <BoardConnector> > (withTarget: self) {
//      DispatchQueue.main.async {
...
//    }
  ...
  final override var propval : EBReferenceArray <BoardConnector> { return self.mInternalArrayValue }
