...
class ReadOnlyArrayOf_BoardText : EBReadOnlyAbstractArrayProperty <BoardText> {
  ...
  final func toMany_mFontSize_StartsBeingObserved (by inObserver : any EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mFontSize_StopsBeingObserved (by inObserver : any EBObserverProtocol) {
  ...
  final func toMany_mWeight_StartsBeingObserved (by inObserver : any EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mWeight_StopsBeingObserved (by inObserver : any EBObserverProtocol) {
  ...
  final func toMany_mOblique_StartsBeingObserved (by inObserver : any EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mOblique_StopsBeingObserved (by inObserver : any EBObserverProtocol) {
  ...
  final func toMany_fontName_StartsBeingObserved (by inObserver : any EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_fontName_StopsBeingObserved (by inObserver : any EBObserverProtocol) {
...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: BoardText
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_BoardText : ReadWriteArrayOf_BoardText { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
...
/*  private final class MyPrivateUndoer : NSObject { // For Swift 6
    let mOldValue : EBReferenceArray <BoardText>

    init (_ inOldValue : EBReferenceArray <BoardText>) {
...
//  }
  ...
  override final var selection : EBSelection < [BoardText] > {
    return .single (self.mInternalArrayValue.values)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  override func setProp (_ inValue : EBReferenceArray <BoardText>) {
    self.mInternalArrayValue = inValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override var propval : EBReferenceArray <BoardText> {
    return self.mInternalArrayValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final func remove (_ inObject : BoardText) {
  ...
  final func add (_ inObject : BoardText) {
...
class StoredArrayOf_BoardText : StandAloneArrayOf_BoardText, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
