...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: BorderCurve
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_BorderCurve : ReadWriteArrayOf_BorderCurve { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
...
/*  private final class MyPrivateUndoer : NSObject { // For Swift 6
    let mOldValue : EBReferenceArray <BorderCurve>

    init (_ inOldValue : EBReferenceArray <BorderCurve>) {
...
//  }
  ...
  override final var selection : EBSelection < [BorderCurve] > {
    return .single (self.mInternalArrayValue.values)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  override func setProp (_ inValue : EBReferenceArray <BorderCurve>) {
    self.mInternalArrayValue = inValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override var propval : EBReferenceArray <BorderCurve> {
    return self.mInternalArrayValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final func remove (_ inObject : BorderCurve) {
  ...
  final func add (_ inObject : BorderCurve) {
...
class StoredArrayOf_BorderCurve : StandAloneArrayOf_BorderCurve, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
