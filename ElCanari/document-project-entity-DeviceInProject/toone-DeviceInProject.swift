...
class ReadOnlyObject_DeviceInProject : EBReadOnlyAbstractObjectProperty <DeviceInProject> {
  ...
  final func toMany_mPadAssignments_StartsBeingObserved (by inObserver : any EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mPadAssignments_StopsBeingObserved (by inObserver : any EBObserverProtocol) {
...
final class StoredObject_DeviceInProject : ReadOnlyObject_DeviceInProject, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol {
 ...
 // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  private final class MyPrivateUndoer : NSObject { // For Swift 6
    let mOldValue : DeviceInProject?

    init (_ inOldValue : DeviceInProject?) {
