...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: DevicePackageInProject
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_DevicePackageInProject : ReadWriteArrayOf_DevicePackageInProject { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
...
/*  private final class MyPrivateUndoer : NSObject { // For Swift 6
    let mOldValue : EBReferenceArray <DevicePackageInProject>

    init (_ inOldValue : EBReferenceArray <DevicePackageInProject>) {
...
//  }
  ...
  override final var selection : EBSelection < [DevicePackageInProject] > {
    return .single (self.mInternalArrayValue.values)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  override func setProp (_ inValue : EBReferenceArray <DevicePackageInProject>) {
    self.mInternalArrayValue = inValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override var propval : EBReferenceArray <DevicePackageInProject> {
    return self.mInternalArrayValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final func remove (_ inObject : DevicePackageInProject) {
  ...
  final func add (_ inObject : DevicePackageInProject) {
...
class StoredArrayOf_DevicePackageInProject : StandAloneArrayOf_DevicePackageInProject, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
