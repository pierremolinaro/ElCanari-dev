...
class ReadOnlyObject_DevicePackageInProject : EBReadOnlyAbstractObjectProperty <DevicePackageInProject> {
...
final class StoredObject_DevicePackageInProject : ReadOnlyObject_DevicePackageInProject, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol {
 ...
 // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  private final class MyPrivateUndoer : NSObject { // For Swift 6
    let mOldValue : DevicePackageInProject?

    init (_ inOldValue : DevicePackageInProject?) {
