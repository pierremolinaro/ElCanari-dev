...
class ReadOnlyArrayOf_DevicePinInProject : ReadOnlyAbstractArrayProperty <DevicePinInProject> {
  ...
  final func addEBObserverOf_mPinName (_ inObserver : EBObserverProtocol) {
  ...
  final func removeEBObserverOf_mPinName (_ inObserver : EBObserverProtocol) {
  ...
  final func addEBObserversOf_mPinName_toElementsOfSet (_ inSet : EBReferenceSet <DevicePinInProject>) {
    if !self.mObserversOf_mPinName.isEmpty {
      for managedObject in inSet.values {
        self.mObserversOf_mPinName.apply { (_ observer : EBObserverProtocol) in
  ...
  final func addEBObserverOf_mPinNameIsDisplayedInSchematic (_ inObserver : EBObserverProtocol) {
    self.addEBObserver (inObserver)
  ...
  final func removeEBObserverOf_mPinNameIsDisplayedInSchematic (_ inObserver : EBObserverProtocol) {
    self.removeEBObserver (inObserver)
  ...
  final func addEBObserversOf_mPinNameIsDisplayedInSchematic_toElementsOfSet (_ inSet : EBReferenceSet <DevicePinInProject>) {
    if !self.mObserversOf_mPinNameIsDisplayedInSchematic.isEmpty {
      for managedObject in inSet.values {
        self.mObserversOf_mPinNameIsDisplayedInSchematic.apply { (_ observer : EBObserverProtocol) in
  ...
  final func addEBObserversOf_pinQualifiedName_toElementsOfSet (_ inSet : EBReferenceSet <DevicePinInProject>) {
    for managedObject in inSet.values {
      self.mObserversOf_pinQualifiedName.apply { (_ observer : EBObserverProtocol) in
