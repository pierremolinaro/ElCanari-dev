...
class ReadOnlyArrayOf_DeviceSlavePadInProject : EBReadOnlyAbstractArrayProperty <DeviceSlavePadInProject> {
...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: DeviceSlavePadInProject
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_DeviceSlavePadInProject : ReadWriteArrayOf_DeviceSlavePadInProject { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
  ...
  override final var selection : EBSelection < [DeviceSlavePadInProject] > {
    return .single (self.mInternalArrayValue.values)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  override func setProp (_ inValue : EBReferenceArray <DeviceSlavePadInProject>) {
    self.mInternalArrayValue = inValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override var propval : EBReferenceArray <DeviceSlavePadInProject> {
    return self.mInternalArrayValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final func remove (_ inObject : DeviceSlavePadInProject) {
  ...
  final func add (_ inObject : DeviceSlavePadInProject) {
...
class StoredArrayOf_DeviceSlavePadInProject : StandAloneArrayOf_DeviceSlavePadInProject, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
