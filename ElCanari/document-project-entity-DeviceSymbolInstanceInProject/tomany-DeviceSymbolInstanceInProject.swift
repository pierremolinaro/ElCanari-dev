...
final class TransientArrayOf_DeviceSymbolInstanceInProject : ReadOnlyArrayOf_DeviceSymbolInstanceInProject {
  ...
  private weak var mDataProvider : ReadOnlyArrayOf_DeviceSymbolInstanceInProject? = nil // SHOULD BE WEAK
...
final class ProxyArrayOf_DeviceSymbolInstanceInProject : ReadWriteArrayOf_DeviceSymbolInstanceInProject {
  ...
  private weak var mModel : ReadWriteArrayOf_DeviceSymbolInstanceInProject? = nil // SHOULD BE WEAK
  ...
  init (prefKey : String) {
    ...
    if let array = UserDefaults.standard.array (forKey: prefKey) as? [NSDictionary] {
      ...
      for dictionary in array {
        let object = newInstanceOfEntityNamed (self.undoManager, "DeviceSymbolInstanceInProject") as! DeviceSymbolInstanceInProject
