...
class ReadOnlyArrayOf_DeviceSymbolInstanceInProject : EBReadOnlyAbstractArrayProperty <DeviceSymbolInstanceInProject> {
  ...
  final func toMany_symbolAndTypeName_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_symbolAndTypeName_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_symbolTypeName_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_symbolTypeName_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
...
class StoredArrayOf_DeviceSymbolInstanceInProject : StandAloneArrayOf_DeviceSymbolInstanceInProject, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
