...
final class TransientArrayOf_LabelInSchematic : ReadOnlyArrayOf_LabelInSchematic {
  ...
  private weak var mDataProvider : ReadOnlyArrayOf_LabelInSchematic? = nil // SHOULD BE WEAK
...
final class ProxyArrayOf_LabelInSchematic : ReadWriteArrayOf_LabelInSchematic {
  ...
  private weak var mModel : ReadWriteArrayOf_LabelInSchematic? = nil // SHOULD BE WEAK
  ...
  init (prefKey : String) {
    ...
    if let array = UserDefaults.standard.array (forKey: prefKey) as? [NSDictionary] {
      ...
      for dictionary in array {
        let object = newInstanceOfEntityNamed (self.undoManager, "LabelInSchematic") as! LabelInSchematic
