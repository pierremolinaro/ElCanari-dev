...
class ReadOnlyObject_NCInSchematic : ReadOnlyAbstractObjectProperty <NCInSchematic> {
  ...
  //--- Configure mOrientation simple stored property
    self.mOrientation_property.mReadModelFunction = { [weak self] in
      return self?.mWeakInternalValue?.mOrientation_property.optionalSelection ?? .single (nil)
...
final class StoredObject_NCInSchematic : ReadOnlyObject_NCInSchematic, EBSignatureObserverProtocol, EBObservableObjectProtocol, DocumentStorablePropertyAndRelationshipProtocol {
