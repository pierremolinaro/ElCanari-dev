...
class ReadOnlyArrayOf_NetClassInProject : EBReadOnlyAbstractArrayProperty <NetClassInProject> {
  ...
  //--- Add observers to added objects
    for managedObject in inAddedSet.values {
      if let relay = self.mObserversOf_mNetClassName { // Stored property
        managedObject.mNetClassName_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_mNetClassColor { // Stored property
        managedObject.mNetClassColor_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_mTrackWidth { // Stored property
        managedObject.mTrackWidth_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_mTrackWidthUnit { // Stored property
        managedObject.mTrackWidthUnit_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_mViaHoleDiameter { // Stored property
        managedObject.mViaHoleDiameter_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_mViaHoleDiameterUnit { // Stored property
        managedObject.mViaHoleDiameterUnit_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_mViaPadDiameter { // Stored property
        managedObject.mViaPadDiameter_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_mViaPadDiameterUnit { // Stored property
        managedObject.mViaPadDiameterUnit_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_mAllowTracksOnFrontSide { // Stored property
        managedObject.mAllowTracksOnFrontSide_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_mAllowTracksOnBackSide { // Stored property
        managedObject.mAllowTracksOnBackSide_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_mAllowTracksOnInner1Layer { // Stored property
        managedObject.mAllowTracksOnInner1Layer_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_mAllowTracksOnInner2Layer { // Stored property
        managedObject.mAllowTracksOnInner2Layer_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_mAllowTracksOnInner3Layer { // Stored property
        managedObject.mAllowTracksOnInner3Layer_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_mAllowTracksOnInner4Layer { // Stored property
        managedObject.mAllowTracksOnInner4Layer_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_trackWidthString { // Transient property
        managedObject.trackWidthString_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_viaHoleDiameter { // Transient property
        managedObject.viaHoleDiameter_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_viaPadDiameter { // Transient property
        managedObject.viaPadDiameter_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_allowTracksOnFrontSideString { // Transient property
        managedObject.allowTracksOnFrontSideString_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_allowTracksOnBackSideString { // Transient property
        managedObject.allowTracksOnBackSideString_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_allowTracksOnInner1LayerString { // Transient property
        managedObject.allowTracksOnInner1LayerString_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_allowTracksOnInner2LayerString { // Transient property
        managedObject.allowTracksOnInner2LayerString_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_allowTracksOnInner3LayerString { // Transient property
        managedObject.allowTracksOnInner3LayerString_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_allowTracksOnInner4LayerString { // Transient property
        managedObject.allowTracksOnInner4LayerString_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_canRemove { // Transient property
        managedObject.canRemove_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_netUsage { // Transient property
        managedObject.netUsage_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_netsDescription { // Transient property
        managedObject.netsDescription_property.startsBeingObserved (by: relay)
      }
      if let relay = self.mObserversOf_netWarningCount { // Transient property
        managedObject.netWarningCount_property.startsBeingObserved (by: relay)
      }
    }
  }
  ...
  final func toMany_mNetClassName_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mNetClassName_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mNetClassColor_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mNetClassColor_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mTrackWidth_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mTrackWidth_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mTrackWidthUnit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mTrackWidthUnit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mViaHoleDiameter_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mViaHoleDiameter_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mViaHoleDiameterUnit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mViaHoleDiameterUnit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mViaPadDiameter_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mViaPadDiameter_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mViaPadDiameterUnit_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mViaPadDiameterUnit_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mAllowTracksOnFrontSide_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mAllowTracksOnFrontSide_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mAllowTracksOnBackSide_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mAllowTracksOnBackSide_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mAllowTracksOnInner1Layer_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mAllowTracksOnInner1Layer_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mAllowTracksOnInner2Layer_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mAllowTracksOnInner2Layer_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mAllowTracksOnInner3Layer_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mAllowTracksOnInner3Layer_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_mAllowTracksOnInner4Layer_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_mAllowTracksOnInner4Layer_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_trackWidthString_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_trackWidthString_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_viaHoleDiameter_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_viaHoleDiameter_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_viaPadDiameter_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_viaPadDiameter_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_allowTracksOnFrontSideString_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_allowTracksOnFrontSideString_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_allowTracksOnBackSideString_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_allowTracksOnBackSideString_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_allowTracksOnInner1LayerString_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_allowTracksOnInner1LayerString_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_allowTracksOnInner2LayerString_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_allowTracksOnInner2LayerString_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_allowTracksOnInner3LayerString_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_allowTracksOnInner3LayerString_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_allowTracksOnInner4LayerString_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_allowTracksOnInner4LayerString_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_canRemove_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_canRemove_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_netUsage_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_netUsage_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_netsDescription_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_netsDescription_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_netWarningCount_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_netWarningCount_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: NetClassInProject
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_NetClassInProject : ReadWriteArrayOf_NetClassInProject { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
  ...
  override final var selection : EBSelection < [NetClassInProject] > {
    return .single (self.mInternalArrayValue.values)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  override func setProp (_ inValue : EBReferenceArray <NetClassInProject>) {
    self.mInternalArrayValue = inValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override var propval : EBReferenceArray <NetClassInProject> {
    return self.mInternalArrayValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final func remove (_ inObject : NetClassInProject) {
  ...
  final func add (_ inObject : NetClassInProject) {
...
class StoredArrayOf_NetClassInProject : StandAloneArrayOf_NetClassInProject, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
