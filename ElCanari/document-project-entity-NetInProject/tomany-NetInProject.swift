...
final class TransientArrayOf_NetInProject : ReadOnlyArrayOf_NetInProject {
  ...
  private weak var mDataProvider : ReadOnlyArrayOf_NetInProject? = nil // SHOULD BE WEAK
  ...
  init (prefKey : String) {
    ...
    if let array = UserDefaults.standard.array (forKey: prefKey) as? [NSDictionary] {
      ...
      for dictionary in array {
        let object = newInstanceOfEntityNamed (self.undoManager, "NetInProject") as! NetInProject
