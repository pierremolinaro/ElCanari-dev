...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: PointInSchematic
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_PointInSchematic : ReadWriteArrayOf_PointInSchematic { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
...
/*  private final class MyPrivateUndoer : NSObject { // For Swift 6
    let mOldValue : EBReferenceArray <PointInSchematic>

    init (_ inOldValue : EBReferenceArray <PointInSchematic>) {
...
//  }
  ...
  override final var selection : EBSelection < [PointInSchematic] > {
    return .single (self.mInternalArrayValue.values)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  override func setProp (_ inValue : EBReferenceArray <PointInSchematic>) {
    self.mInternalArrayValue = inValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override var propval : EBReferenceArray <PointInSchematic> {
    return self.mInternalArrayValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final func remove (_ inObject : PointInSchematic) {
  ...
  final func add (_ inObject : PointInSchematic) {
...
class StoredArrayOf_PointInSchematic : StandAloneArrayOf_PointInSchematic, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
