...
final class ProjectRoot : EBManagedObject {
  ...
  required init (_ inUndoManager : UndoManager?) {
    ...
    self.accumulateProperty (self.mExpandInner1BoardSettings_property)
    self.accumulateProperty (self.mExpandInner2BoardSettings_property)
    self.accumulateProperty (self.mExpandInner3BoardSettings_property)
    self.accumulateProperty (self.mExpandInner4BoardSettings_property)
    self.accumulateProperty (self.mExpandOtherBoardSettings_property)
    self.accumulateProperty (self.mExpandFrontSideBoardSettings_property)
    self.accumulateProperty (self.mExpandBackSideBoardSettings_property)
    self.accumulateProperty (self.mCheckClearanceBetweenPadsOfSameNet_property)
    self.accumulateProperty (self.mLastERCCheckingIsSuccess_property)
    self.accumulateProperty (self.mLastERCCheckingSignature_property)
    self.accumulateProperty (self.mLayerConfiguration_property)
    self.accumulateProperty (self.mBoardSideForNewTrack_property)
    self.accumulateProperty (self.mDirectionForNewTrack_property)
    self.accumulateProperty (self.mBoardLayerForNewText_property)
    self.accumulateProperty (self.mBoardLayerForNewQRCode_property)
    self.accumulateProperty (self.mBoardLayerForNewImage_property)
    self.accumulateProperty (self.mBoardLayerForNewLine_property)
    self.accumulateProperty (self.mBoardSideForNewRestrictRectangle_property)
    self.accumulateProperty (self.mNewRestrictRectangleLayers_property)
    self.accumulateProperty (self.mAutoRouterPreferredDirections_property)
    self.accumulateProperty (self.mAutorouterSnapAngle_property)
    self.accumulateProperty (self.mRouteDirection_property)
    self.accumulateProperty (self.mRouteOrigin_property)
    self.accumulateProperty (self.mAutorouterInterfaceMode_property)
    self.accumulateProperty (self.mExportExistingTracksAndVias_property)
    self.accumulateProperty (self.mAllowViaAtSMD_property)
    self.accumulateProperty (self.mTrackLengthUnit_property)
    self.accumulateProperty (self.mLayoutClearance_property)
    self.accumulateProperty (self.mLayoutClearanceUnit_property)
    self.accumulateProperty (self.mBoardSelectedInspector_property)
    self.accumulateProperty (self.mBoardHorizontalFlip_property)
    self.accumulateProperty (self.mBoardVerticalFlip_property)
    self.accumulateProperty (self.mBoardGridStyle_property)
    self.accumulateProperty (self.mBoardGridDisplayFactor_property)
    self.accumulateProperty (self.mBoardZoom_property)
    self.accumulateProperty (self.mBoardGridStep_property)
    self.accumulateProperty (self.mBoardGridStepUnit_property)
    ...
    self.accumulateProperty (self.mBoardLimitsHorizontalFlip_property)
    self.accumulateProperty (self.mBoardLimitsVerticalFlip_property)
    self.accumulateProperty (self.mBoardLimitsGridStyle_property)
    self.accumulateProperty (self.mBoardLimitsGridDisplayFactor_property)
    self.accumulateProperty (self.mBoardLimitsZoom_property)
    self.accumulateProperty (self.mBoardLimitsGridStep_property)
    self.accumulateProperty (self.mBoardLimitsGridStepUnit_property)
    self.accumulateProperty (self.mBoardLimitsBoundingBoxUnit_property)
    self.accumulateProperty (self.mBoardPointsBoundingBoxUnit_property)
    self.accumulateProperty (self.mBoardSelectedCurveDisplayUnit_property)
    self.accumulateProperty (self.mBoardLimitControlPointsDisplayUnit_property)
    self.accumulateProperty (self.mBoardShape_property)
    self.accumulateProperty (self.mContentOpacityInBoardOutline_property)
    self.accumulateProperty (self.mRectangularBoardWidth_property)
    self.accumulateProperty (self.mRectangularBoardWidthUnit_property)
    self.accumulateProperty (self.mRectangularBoardHeight_property)
    self.accumulateProperty (self.mRectangularBoardHeightUnit_property)
  //--- To many property: mSheets (has opposite relationship)
    ...
    self.accumulateProperty (self.mSheets_property)
    self.accumulateProperty (self.mDefaultNetClassName_property)
    self.accumulateProperty (self.mSchematicHilitedColumnIndex_property)
    self.accumulateProperty (self.mSchematicHilitedRowIndex_property)
    self.accumulateProperty (self.mSchematicEnableHiliteColumnAndRow_property)
    self.accumulateProperty (self.mSelectedPageIndex_property)
    self.accumulateProperty (self.mSelectedSchematicInspector_property)
    self.accumulateProperty (self.mSchematicTitle_property)
    self.accumulateProperty (self.mSchematicVersion_property)
    self.accumulateProperty (self.mSchematicDate_property)
    self.accumulateProperty (self.mSchematicHorizontalFlip_property)
    self.accumulateProperty (self.mSchematicVerticalFlip_property)
    self.accumulateProperty (self.mSchematicZoom_property)
    self.accumulateProperty (self.mSchematicGridStyle_property)
    self.accumulateProperty (self.mSchematicGridDisplayFactor_property)
    self.accumulateProperty (self.mSchematicCustomWidth_property)
    self.accumulateProperty (self.mSchematicCustomWidthUnit_property)
    self.accumulateProperty (self.mSchematicCustomHeight_property)
    self.accumulateProperty (self.mSchematicCustomHeightUnit_property)
    self.accumulateProperty (self.mWorkingAreaRectString_property)
    self.accumulateProperty (self.drawErrorBackgroundForBoard_property)
    self.accumulateProperty (self.displayFrontRestrictRectangles_property)
    self.accumulateProperty (self.displayBackRestrictRectangles_property)
    self.accumulateProperty (self.displayInner1RestrictRectangles_property)
    self.accumulateProperty (self.displayInner2RestrictRectangles_property)
    self.accumulateProperty (self.displayInner3RestrictRectangles_property)
    self.accumulateProperty (self.displayInner4RestrictRectangles_property)
    self.accumulateProperty (self.displayFrontLegendForBoard_property)
    self.accumulateProperty (self.displayFrontLayoutForBoard_property)
    self.accumulateProperty (self.displayBackLayoutForBoard_property)
    self.accumulateProperty (self.displayInner1LayoutForBoard_property)
    self.accumulateProperty (self.displayInner2LayoutForBoard_property)
    self.accumulateProperty (self.displayInner3LayoutForBoard_property)
    self.accumulateProperty (self.displayInner4LayoutForBoard_property)
    self.accumulateProperty (self.displayBackLegendForBoard_property)
    self.accumulateProperty (self.displayFrontPadsForBoard_property)
    self.accumulateProperty (self.displayBackPadsForBoard_property)
    self.accumulateProperty (self.displayPadNumbersForBoard_property)
    self.accumulateProperty (self.packageDrawingWidthMultpliedByTenForBoard_property)
  //--- To many property: mFonts (no option)
    self.mFonts_property.undoManager = inUndoManager
    self.accumulateProperty (self.mFonts_property)
  //--- To many property: mDevices (no option)
    self.mDevices_property.undoManager = inUndoManager
    self.accumulateProperty (self.mDevices_property)
  //--- To many property: mNetClasses (no option)
    self.mNetClasses_property.undoManager = inUndoManager
    self.accumulateProperty (self.mNetClasses_property)
    self.accumulateProperty (self.mSchematicSheetOrientation_property)
  //--- To many property: mBorderCurves (has opposite relationship)
    ...
    self.accumulateProperty (self.mBorderCurves_property)
  //--- To many property: mBoardObjects (has opposite relationship)
    ...
    self.accumulateProperty (self.mBoardObjects_property)
    self.accumulateProperty (self.mRastnetDisplay_property)
    self.accumulateProperty (self.mRastnetDisplayedNetName_property)
    self.accumulateProperty (self.mRastnetDisplayedComponentName_property)
  ...
  //--- To one property: mSelectedSheet
    ...
    self.accumulateProperty (self.mSelectedSheet_property)
