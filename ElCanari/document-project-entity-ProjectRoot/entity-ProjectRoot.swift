...
final class ProjectRoot : EBManagedObject {
  ...
  override func accumulateProperties (into ioArray : inout [AnyObject]) {
    ...
    ioArray.append (self.mGenerateBOM_property)
    ...
    ioArray.append (self.mExpandInner1BoardSettings_property)
    ioArray.append (self.mExpandInner2BoardSettings_property)
    ioArray.append (self.mExpandInner3BoardSettings_property)
    ioArray.append (self.mExpandInner4BoardSettings_property)
    ioArray.append (self.mExpandOtherBoardSettings_property)
    ioArray.append (self.mExpandFrontSideBoardSettings_property)
    ioArray.append (self.mExpandBackSideBoardSettings_property)
    ioArray.append (self.mCheckClearanceBetweenPadsOfSameNet_property)
    ioArray.append (self.mLastERCCheckingIsSuccess_property)
    ioArray.append (self.mLastERCCheckingSignature_property)
    ioArray.append (self.mLayerConfiguration_property)
    ioArray.append (self.mBoardSideForNewTrack_property)
    ioArray.append (self.mDirectionForNewTrack_property)
    ioArray.append (self.mBoardLayerForNewText_property)
    ioArray.append (self.mBoardLayerForNewQRCode_property)
    ioArray.append (self.mBoardLayerForNewImage_property)
    ioArray.append (self.mBoardLayerForNewLine_property)
    ioArray.append (self.mBoardSideForNewRestrictRectangle_property)
    ioArray.append (self.mNewRestrictRectangleLayers_property)
    ioArray.append (self.mAutoRouterPreferredDirections_property)
    ioArray.append (self.mAutorouterSnapAngle_property)
    ioArray.append (self.mRouteDirection_property)
    ioArray.append (self.mRouteOrigin_property)
    ioArray.append (self.mAutorouterInterfaceMode_property)
    ioArray.append (self.mExportExistingTracksAndVias_property)
    ioArray.append (self.mAllowViaAtSMD_property)
    ioArray.append (self.mTrackLengthUnit_property)
    ioArray.append (self.mLayoutClearance_property)
    ioArray.append (self.mLayoutClearanceUnit_property)
    ioArray.append (self.mBoardSelectedInspector_property)
    ioArray.append (self.mBoardHorizontalFlip_property)
    ioArray.append (self.mBoardVerticalFlip_property)
    ioArray.append (self.mBoardGridStyle_property)
    ioArray.append (self.mBoardGridDisplayFactor_property)
    ioArray.append (self.mBoardZoom_property)
    ioArray.append (self.mBoardGridStep_property)
    ioArray.append (self.mBoardGridStepUnit_property)
    ioArray.append (self.mErrorOrWarningIssueSize_property)
    ioArray.append (self.mControlKeyHiliteDiameter_property)
    ioArray.append (self.mDSNFileProposedName_property)
    ioArray.append (self.mBoardLimitsWidth_property)
    ioArray.append (self.mBoardLimitsWidthUnit_property)
    ioArray.append (self.mBoardClearance_property)
    ioArray.append (self.mBoardClearanceUnit_property)
    ioArray.append (self.mBoardLimitsSelectedInspector_property)
    ioArray.append (self.mBoardLimitsHorizontalFlip_property)
    ioArray.append (self.mBoardLimitsVerticalFlip_property)
    ioArray.append (self.mBoardLimitsGridStyle_property)
    ioArray.append (self.mBoardLimitsGridDisplayFactor_property)
    ioArray.append (self.mBoardLimitsZoom_property)
    ioArray.append (self.mBoardLimitsGridStep_property)
    ioArray.append (self.mBoardLimitsGridStepUnit_property)
    ioArray.append (self.mBoardLimitsBoundingBoxUnit_property)
    ioArray.append (self.mBoardPointsBoundingBoxUnit_property)
    ioArray.append (self.mBoardSelectedCurveDisplayUnit_property)
    ioArray.append (self.mBoardLimitControlPointsDisplayUnit_property)
    ioArray.append (self.mBoardShape_property)
    ioArray.append (self.mContentOpacityInBoardOutline_property)
    ioArray.append (self.mRectangularBoardWidth_property)
    ioArray.append (self.mRectangularBoardWidthUnit_property)
    ioArray.append (self.mRectangularBoardHeight_property)
    ioArray.append (self.mRectangularBoardHeightUnit_property)
    ioArray.append (self.mSheets_property)
    ioArray.append (self.mDefaultNetClassName_property)
    ioArray.append (self.mSchematicHilitedColumnIndex_property)
    ioArray.append (self.mSchematicHilitedRowIndex_property)
    ioArray.append (self.mSchematicEnableHiliteColumnAndRow_property)
    ioArray.append (self.mSelectedPageIndex_property)
    ioArray.append (self.mSelectedSchematicInspector_property)
    ioArray.append (self.mSchematicTitle_property)
    ioArray.append (self.mSchematicVersion_property)
    ioArray.append (self.mSchematicDate_property)
    ioArray.append (self.mSchematicHorizontalFlip_property)
    ioArray.append (self.mSchematicVerticalFlip_property)
    ioArray.append (self.mSchematicZoom_property)
    ioArray.append (self.mSchematicGridStyle_property)
    ioArray.append (self.mSchematicGridDisplayFactor_property)
    ioArray.append (self.mSchematicCustomWidth_property)
    ioArray.append (self.mSchematicCustomWidthUnit_property)
    ioArray.append (self.mSchematicCustomHeight_property)
    ioArray.append (self.mSchematicCustomHeightUnit_property)
    ioArray.append (self.mWorkingAreaRectString_property)
    ioArray.append (self.drawErrorBackgroundForBoard_property)
    ioArray.append (self.displayFrontRestrictRectangles_property)
    ioArray.append (self.displayBackRestrictRectangles_property)
    ioArray.append (self.displayInner1RestrictRectangles_property)
    ioArray.append (self.displayInner2RestrictRectangles_property)
    ioArray.append (self.displayInner3RestrictRectangles_property)
    ioArray.append (self.displayInner4RestrictRectangles_property)
    ioArray.append (self.displayFrontLegendForBoard_property)
    ioArray.append (self.displayFrontLayoutForBoard_property)
    ioArray.append (self.displayBackLayoutForBoard_property)
    ioArray.append (self.displayInner1LayoutForBoard_property)
    ioArray.append (self.displayInner2LayoutForBoard_property)
    ioArray.append (self.displayInner3LayoutForBoard_property)
    ioArray.append (self.displayInner4LayoutForBoard_property)
    ioArray.append (self.displayBackLegendForBoard_property)
    ioArray.append (self.displayFrontPadsForBoard_property)
    ioArray.append (self.displayBackPadsForBoard_property)
    ioArray.append (self.displayPadNumbersForBoard_property)
    ioArray.append (self.packageDrawingWidthMultpliedByTenForBoard_property)
    ioArray.append (self.mFonts_property)
    ioArray.append (self.mDevices_property)
    ioArray.append (self.mNetClasses_property)
    ioArray.append (self.mSchematicSheetOrientation_property)
    ioArray.append (self.mBorderCurves_property)
    ioArray.append (self.mBoardObjects_property)
    ioArray.append (self.mRastnetDisplay_property)
    ioArray.append (self.mRastnetDisplayedNetName_property)
    ioArray.append (self.mRastnetDisplayedComponentName_property)
    ioArray.append (self.mComponents_property)
    ioArray.append (self.mArtwork_property)
    ioArray.append (self.mSelectedSheet_property)
  }
