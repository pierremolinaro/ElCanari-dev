...
class ReadOnlyArrayOf_SchematicObject : EBReadOnlyAbstractArrayProperty <SchematicObject> {
  ...
  final func toMany_isPlacedInSchematic_StartsBeingObserved (by inObserver : any EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_isPlacedInSchematic_StopsBeingObserved (by inObserver : any EBObserverProtocol) {
...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: SchematicObject
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_SchematicObject : ReadWriteArrayOf_SchematicObject { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
...
/*  private final class MyPrivateUndoer : NSObject { // For Swift 6
    let mOldValue : EBReferenceArray <SchematicObject>

    init (_ inOldValue : EBReferenceArray <SchematicObject>) {
...
//  }
  ...
  override final var selection : EBSelection < [SchematicObject] > {
    return .single (self.mInternalArrayValue.values)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  override func setProp (_ inValue : EBReferenceArray <SchematicObject>) {
    self.mInternalArrayValue = inValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override var propval : EBReferenceArray <SchematicObject> {
    return self.mInternalArrayValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final func remove (_ inObject : SchematicObject) {
  ...
  final func add (_ inObject : SchematicObject) {
...
class StoredArrayOf_SchematicObject : StandAloneArrayOf_SchematicObject, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
