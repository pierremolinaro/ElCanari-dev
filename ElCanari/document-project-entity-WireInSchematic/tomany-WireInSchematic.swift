...
//--------------------------------------------------------------------------------------------------
//    StandAlone Array: WireInSchematic
//--------------------------------------------------------------------------------------------------

class StandAloneArrayOf_WireInSchematic : ReadWriteArrayOf_WireInSchematic { // , EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
...
/*  private final class MyPrivateUndoer : NSObject { // For Swift 6
    let mOldValue : EBReferenceArray <WireInSchematic>

    init (_ inOldValue : EBReferenceArray <WireInSchematic>) {
...
//  }
  ...
  override final var selection : EBSelection < [WireInSchematic] > {
    return .single (self.mInternalArrayValue.values)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  override func setProp (_ inValue : EBReferenceArray <WireInSchematic>) {
    self.mInternalArrayValue = inValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override var propval : EBReferenceArray <WireInSchematic> {
    return self.mInternalArrayValue
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final func remove (_ inObject : WireInSchematic) {
  ...
  final func add (_ inObject : WireInSchematic) {
...
class StoredArrayOf_WireInSchematic : StandAloneArrayOf_WireInSchematic, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
