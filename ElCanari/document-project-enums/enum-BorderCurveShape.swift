...
enum BorderCurveShape : Int, EBEnumPropertyProtocol, Hashable {
  case line = 0
  case bezier = 1
...
typealias EBReadWriteProperty_BorderCurveShape = EBEnumReadWriteProperty <BorderCurveShape> // EBObservableMutableProperty <BorderCurveShape>
