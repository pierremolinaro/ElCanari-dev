...
enum ConnectorSide : Int, EBEnumPropertyProtocol, Hashable {
  case front = 0
  case back = 1
  case inner1 = 2
  case inner2 = 3
...
typealias EBReadWriteProperty_ConnectorSide = EBEnumReadWriteProperty <ConnectorSide> // EBObservableMutableProperty <ConnectorSide>
