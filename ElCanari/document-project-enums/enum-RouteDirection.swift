...
enum RouteDirection : Int, EBEnumPropertyProtocol, Hashable {
  case from = 0
  case to = 1
...
typealias EBReadWriteProperty_RouteDirection = EBEnumReadWriteProperty <RouteDirection> // EBObservableMutableProperty <RouteDirection>
