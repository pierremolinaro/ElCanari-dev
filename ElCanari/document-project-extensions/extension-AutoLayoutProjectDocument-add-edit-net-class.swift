...
extension AutoLayoutProjectDocument {
  ...
  fileprivate func netClassEditionPanel (with inNetClass : NetClassInProject,
    ...
    //---  Allow front track
      ...
      _ = gridView.append (left: AutoLayoutHorizontalStackView (), right: allowFrontTrackCheckBox)
    //---  Allow Inner 1 Layer
      ...
      _ = gridView.append (left: AutoLayoutHorizontalStackView (), right: allowInner1TrackCheckBox)
    //---  Allow Inner 2 Layer
      ...
      _ = gridView.append (left: AutoLayoutHorizontalStackView (), right: allowInner2TrackCheckBox)
    //---  Allow Inner 3 Layer
      ...
      _ = gridView.append (left: AutoLayoutHorizontalStackView (), right: allowInner3TrackCheckBox)
    //---  Allow Inner 4 Layer
      ...
      _ = gridView.append (left: AutoLayoutHorizontalStackView (), right: allowInner4TrackCheckBox)
    //---  Allow Back track
      ...
      _ = gridView.append (left: AutoLayoutHorizontalStackView (), right: allowBackTrackCheckBox)
    //--- Hole Diameter
