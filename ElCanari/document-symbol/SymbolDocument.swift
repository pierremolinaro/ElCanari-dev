...
@objc(SymbolDocument) class SymbolDocument : EBManagedXibDocument {
  ...
  //--------------------------- Install regular bindings
    ...
    self.mGridDisplayFactorPopUpButton?.bind_selectedTag (self.rootObject.gridDisplay_property)
    ...
    self.mCrossColorOfSymbolGridColorWell?.bind_color (preferences_crossColorOfSymbolGrid_property, sendContinously:false)
    self.mLineColorOfSymbolGridColorWell?.bind_color (preferences_lineColorOfSymbolGrid_property, sendContinously:false)
    self.mSymbolColorColorWell?.bind_color (preferences_symbolColor_property, sendContinously:false)
    self.mSymbolBackgroundColorColorWell?.bind_color (preferences_symbolBackgroundColor_property, sendContinously:false)
    self.mSymbolDrawingWidthMultipliedByTenPopupButton?.bind_selectedTag (preferences_symbolDrawingWidthMultipliedByTen_property)
    self.mPinNameFontButton?.bind_fontValue (preferences_pinNameFont_property)
    self.mComposedSymbolView?.bind_horizontalFlip (self.rootObject.horizontalFlip_property)
    self.mComposedSymbolView?.bind_verticalFlip (self.rootObject.verticalFlip_property)
    self.mComposedSymbolView?.bind_gridStyle (self.rootObject.gridStyle_property)
    self.mComposedSymbolView?.bind_gridDisplayFactor (self.rootObject.gridDisplay_property)
    self.mComposedSymbolView?.bind_gridLineColor (preferences_lineColorOfSymbolGrid_property)
    self.mComposedSymbolView?.bind_gridCrossColor (preferences_crossColorOfSymbolGrid_property)
    self.mComposedSymbolView?.bind_zoom (self.rootObject.zoom_property)
    self.mComposedSymbolView?.bind_backColor (preferences_symbolBackgroundColor_property)
    self.mComposedSymbolView?.bind_xPlacardUnit (self.rootObject.xPlacardUnit_property)
    self.mComposedSymbolView?.bind_yPlacardUnit (self.rootObject.yPlacardUnit_property)
    self.mSymbolTextValueTextField?.bind_value (self.mSymbolTextSelectionController.text_property, sendContinously:true)
    self.mSymbolTextHorizontalAlignmentSegmentedControl?.bind_selectedSegment (self.mSymbolTextSelectionController.horizontalAlignment_property)
    self.mSymbolPinLabelHorizontalAlignmentSegmentedControl?.bind_selectedSegment (self.mSymbolPinSelectionController.nameHorizontalAlignment_property)
    self.mSymbolPinNumberHorizontalAlignmentSegmentedControl?.bind_selectedSegment (self.mSymbolPinSelectionController.numberHorizontalAlignment_property)
    self.mSymbolPinNumberIsVisibleInSchematicsSwitch?.bind_value (self.mSymbolPinSelectionController.pinNameIsDisplayedInSchematics_property)
    self.mSymbolPinLabelNameTextField?.bind_value (self.mSymbolPinSelectionController.name_property, sendContinously:true)
