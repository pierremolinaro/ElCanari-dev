...
@objc(SymbolDocument) class SymbolDocument : EBManagedDocument {
  ...
  //--------------------------- Install regular bindings
    ...
    self.mSymbolPinNumberIsVisibleInSchematicsSwitch?.bind_value (self.mSymbolPinSelectionController.pinNumberIsVisibleInSchematics_property, file: #file, line: #line)
