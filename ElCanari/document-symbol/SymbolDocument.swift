...
@objc(SymbolDocument) class SymbolDocument : EBManagedXibDocument {
  ...
  //--------------------------- Install regular bindings
    ...
    self.mCrossColorOfSymbolGridColorWell?.bind_color (prefs_crossColorOfSymbolGrid_property, sendContinously:false)
    self.mLineColorOfSymbolGridColorWell?.bind_color (prefs_lineColorOfSymbolGrid_property, sendContinously:false)
    self.mSymbolColorColorWell?.bind_color (prefs_symbolColor_property, sendContinously:false)
    self.mSymbolBackgroundColorColorWell?.bind_color (prefs_symbolBackgroundColor_property, sendContinously:false)
    self.mSymbolDrawingWidthMultipliedByTenPopupButton?.bind_selectedTag (prefs_symbolDrawingWidthMultipliedByTen_property)
    self.mPinNameFontButton?.bind_fontValue (prefs_pinNameFont_property)
    ...
    self.mComposedSymbolView?.bind_gridLineColor (prefs_lineColorOfSymbolGrid_property)
    self.mComposedSymbolView?.bind_gridCrossColor (prefs_crossColorOfSymbolGrid_property)
    self.mComposedSymbolView?.bind_zoom (self.rootObject.zoom_property)
    self.mComposedSymbolView?.bind_backColor (prefs_symbolBackgroundColor_property)
