...
@objc(SymbolDocument) class SymbolDocument : EBManagedDocument {
  ...
  //--------------------------- Install regular bindings
    ...
    mSymbolPinLabelHorizontalAlignmentPopUpButton?.bind_selectedIndex (self.mSymbolPinSelectionController.nameHorizontalAlignment_property, file: #file, line: #line)
    ...
    mSymbolPinLabelNameTextField?.bind_value (self.mSymbolPinSelectionController.name_property, file: #file, line: #line, sendContinously:true)
