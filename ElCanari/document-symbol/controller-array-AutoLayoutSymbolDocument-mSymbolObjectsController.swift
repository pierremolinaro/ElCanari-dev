...
final class Controller_AutoLayoutSymbolDocument_mSymbolObjectsController : ReadOnlyAbstractGenericRelationshipProperty, EBGraphicViewControllerProtocol, HiddenEBProtocol {
  ...
  private var mPrivateSelectedSet = EBReferenceSet <SymbolObject> () {
    didSet {
  ...
  var selectedArray : EBReferenceArray <SymbolObject> { return self.selectedArray_property.propval }
  ...
  final func bind_model (_ inModel : ReadWriteArrayOf_SymbolObject, _ inUndoManager : UndoManager?) {
    self.mModel = inModel
   ...
   @objc func add (_ sender : Any) {
    if let model = self.mModel {
      ...
      case .empty, .multiple :
        break
      case .single (let v) :
        let newObject = SymbolObject (self.undoManager)
  ...
  @objc func remove (_ sender : Any) {
    if let model = self.mModel {
      ...
      //----------------------------------------- Set new selection
        var newSelectionSet = EBReferenceSet <SymbolObject> ()
 ...
 //····················································································································
  ...
  func sendToBack () {
    var objects = self.objectArray
    let sortedIndexArray = self.sortedIndexArrayOfSelectedObjects ()
    var newObjectArray = EBReferenceArray <SymbolObject> ()
    for idx in sortedIndexArray.reversed () {
      let object = objects [idx]
      objects.remove (at: idx)
