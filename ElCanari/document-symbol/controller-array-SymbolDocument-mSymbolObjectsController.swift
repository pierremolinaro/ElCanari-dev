...
final class Controller_SymbolDocument_mSymbolObjectsController : ReadOnlyAbstractGenericRelationshipProperty, EBGraphicViewControllerProtocol {
  ...
  private let mInternalSelectedArrayProperty = StoredArrayOf_SymbolObject ()
