...
class TransientArrayOf_SymbolPin : ReadOnlyAbstractArrayProperty <SymbolPin> {
  ...
  private var mCachedValue : EBSelection < [SymbolPin] >? = nil
...
class ReadWriteArrayOf_SymbolPin : TransientArrayOf_SymbolPin {
