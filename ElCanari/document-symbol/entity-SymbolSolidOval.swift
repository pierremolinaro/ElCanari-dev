...
final class SymbolSolidOval : SymbolObject {
  ...
  //--- Atomic property: filledBezierPath
    ...
    self.x_property.startsBeingObserved (by: self.filledBezierPath_property)
    self.y_property.startsBeingObserved (by: self.filledBezierPath_property)
    self.width_property.startsBeingObserved (by: self.filledBezierPath_property)
    self.height_property.startsBeingObserved (by: self.filledBezierPath_property)
