...
class ReadOnlyArrayOf_SymbolText : ReadOnlyAbstractArrayProperty <SymbolText> {
  ...
  var propval : [SymbolText] { return [] } // Abstract method
...
class TransientArrayOf_SymbolText : ReadOnlyArrayOf_SymbolText {
  ...
  //····················································································································
   ...
   private var prop_cache : EBSelection < [SymbolText] >? 
...
final class StoredArrayOf_SymbolText : ReadWriteArrayOf_SymbolText, EBSignatureObserverProtocol {
  ...
  convenience init (prefKey : String) {
    ...
    if let array = UserDefaults.standard.array (forKey: prefKey) as? [NSDictionary] {
      ...
      for dictionary in array {
        do{
          if let object = try newInstanceOfEntityNamed (self.undoManager, "SymbolText") as? SymbolText {
 ...
 //····················································································································
  ...
  override var prop : EBSelection < [SymbolText] > { return .single (mValue) }

  override func setProp (_ inValue : [SymbolText]) { mValue = inValue }

  override var propval : [SymbolText] { return mValue }
