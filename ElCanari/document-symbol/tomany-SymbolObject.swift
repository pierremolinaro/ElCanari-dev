...
/*  private final class MyPrivateUndoer : NSObject { // For Swift 6
    let mOldValue : EBReferenceArray <SymbolObject>

    init (_ inOldValue : EBReferenceArray <SymbolObject>) {
...
class StoredArrayOf_SymbolObject : StandAloneArrayOf_SymbolObject, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
