...
class StoredArrayOf_SymbolObject : ReadWriteArrayOf_SymbolObject, EBSignatureObserverProtocol, EBDocumentStorablePropertyAndRelationshipProtocol, Sendable {
...
//    self.undoManager?.registerUndo < EBReferenceArray <SymbolObject> > (withTarget: self) {
