...
class ReadOnlyArrayOf_SymbolText : EBReadOnlyAbstractArrayProperty <SymbolText> {
  ...
  final func toMany_text_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_text_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
  ...
  final func toMany_horizontalAlignment_StartsBeingObserved (by inObserver : some EBObserverProtocol) {
    let relay : EBObservedObserver
  ...
  final func toMany_horizontalAlignment_StopsBeingObserved (by inObserver : some EBObserverProtocol) {
