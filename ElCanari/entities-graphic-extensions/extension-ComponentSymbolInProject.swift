...
extension ComponentSymbolInProject {
  ...
  func translate_ComponentSymbolInProject (xBy inDx: Int, yBy inDy: Int, userSet ioSet : ObjcObjectSet) {
    self.mCenterX += inDx
    self.mCenterY += inDy
  }
  ...
  func rotate90Clockwise_ComponentSymbolInProject (from inRotationCenter : CanariPoint, userSet ioSet : ObjcObjectSet) {
  ...
  func rotate90CounterClockwise_ComponentSymbolInProject (from inRotationCenter : CanariPoint, userSet ioSet : ObjcObjectSet) {
