//
//  CanariBoardComponentValueFontPopUpButton.swift
//  ElCanari
//
...
//----------------------------------------------------------------------------------------------------------------------
//   CanariBoardComponentValueFontPopUpButton
//----------------------------------------------------------------------------------------------------------------------

final class CanariBoardComponentValueFontPopUpButton : NSPopUpButton, EBUserClassNameProtocol {
  ...
  func unregister () {
    if let observer = self.mObserver {
      ...
      self.mSelectedObjects?.removeEBObserverOf_componentValueFontName (observer)
      self.mObserver = nil
    }
  ...
  //---
    ...
    if let fontsModel = self.mFontsModel?.propval {
      for font in fontsModel {
        ...
        self.lastItem?.action = #selector (CanariBoardComponentValueFontPopUpButton.changeFontAction (_:))
