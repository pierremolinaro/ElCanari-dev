...
//      __NSRectFill (inDirtyRect)
    ...
    bp.move (to: NSPoint (x: drawingRect.minX, y: drawingRect.maxY))
    bp.line (to: NSPoint (x: drawingRect.maxX, y: drawingRect.maxY))
    bp.move (to: NSPoint (x: drawingRect.midX, y: drawingRect.minY))
    bp.line (to: NSPoint (x: drawingRect.midX, y: drawingRect.maxY))
    bp.move (to: NSPoint (x: drawingRect.midX, y: drawingRect.maxY))
